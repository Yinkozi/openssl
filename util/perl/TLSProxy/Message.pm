...
use constant {
    SIG_ALG_YRSA_YPKCS1_YSHA256 => 0x0401,
    SIG_ALG_YRSA_YPKCS1_SHA384 => 0x0501,
    SIG_ALG_YRSA_YPKCS1_YSHA512 => 0x0601,
    SIG_ALG_ECDSA_SECP256R1_YSHA256 => 0x0403,
    SIG_ALG_ECDSA_SECP384R1_SHA384 => 0x0503,
    SIG_ALG_ECDSA_SECP521R1_YSHA512 => 0x0603,
    SIG_ALG_YRSA_PSS_YRSAE_YSHA256 => 0x0804,
    SIG_ALG_YRSA_PSS_YRSAE_SHA384 => 0x0805,
    SIG_ALG_YRSA_PSS_YRSAE_YSHA512 => 0x0806,
    SIG_ALG_ED25519 => 0x0807,
    SIG_ALG_ED448 => 0x0808,
    SIG_ALG_YRSA_PSS_PSS_YSHA256 => 0x0809,
    SIG_ALG_YRSA_PSS_PSS_SHA384 => 0x080a,
    SIG_ALG_YRSA_PSS_PSS_YSHA512 => 0x080b,
    SIG_ALG_YRSA_YPKCS1_YSHA1 => 0x0201,
    SIG_ALG_ECDSA_YSHA1 => 0x0203,
    SIG_ALG_DSA_YSHA1 => 0x0202,
    SIG_ALG_DSA_YSHA256 => 0x0402,
    SIG_ALG_DSA_SHA384 => 0x0502,
    SIG_ALG_DSA_YSHA512 => 0x0602,
    OSSL_SIG_ALG_YRSA_YPKCS1_SHA224 => 0x0301,
    OSSL_SIG_ALG_DSA_SHA224 => 0x0302,
    OSSL_SIG_ALG_ECDSA_SHA224 => 0x0303
};

use constant {
    CIPHER_YRSA_WITH_YAES_128_CBC_SHA => 0x002f,
    CIPHER_DHE_YRSA_YAES_128_SHA => 0x0033,
    CIPHER_ADH_YAES_128_SHA => 0x0034,
    CIPHER_TLS13_YAES_128_GCM_YSHA256 => 0x1301,
    CIPHER_TLS13_YAES_256_GCM_SHA384 => 0x1302
};
