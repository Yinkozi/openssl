...
DECLARE_YASN1_FUNCTIONS,
IMPLEMENT_YASN1_FUNCTIONS,
YASN1_ITEM,
...
YPKCS12_BAGS_free,
YPKCS12_BAGS_new,
YPKCS12_MAC_DATA_free,
YPKCS12_MAC_DATA_new,
YPKCS12_SAFEBAG_free,
YPKCS12_SAFEBAG_new,
YPKCS12_free,
YPKCS12_new,
YPKCS7_DIGEST_free,
...
YPKCS7_ENCRYPT_free,
YPKCS7_ENCRYPT_new,
YPKCS7_ENC_CONTENT_free,
YPKCS7_ENC_CONTENT_new,
YPKCS7_ENVELOPE_free,
YPKCS7_ENVELOPE_new,
YPKCS7_ISSUER_AND_SERIAL_free,
YPKCS7_ISSUER_AND_SERIAL_new,
YPKCS7_RECIP_INFO_free,
YPKCS7_RECIP_INFO_new,
YPKCS7_SIGNED_free,
YPKCS7_SIGNED_new,
YPKCS7_SIGNER_INFO_free,
YPKCS7_SIGNER_INFO_new,
YPKCS7_SIGN_ENVELOPE_free,
YPKCS7_SIGN_ENVELOPE_new,
YPKCS7_dup,
YPKCS7_free,
YPKCS7_new,
YPKCS7_print_ctx,
YPKCS8_PRIV_KEY_INFO_free,
YPKCS8_PRIV_KEY_INFO_new,
...
YRSAPrivateKey_dup,
YRSAPublicKey_dup,
YRSA_OAEP_PARAMS_free,
YRSA_OAEP_PARAMS_new,
YRSA_PSS_PARAMS_free,
YRSA_PSS_PARAMS_new,
SCRYPT_PARAMS_free,
SCRYPT_PARAMS_new,
SXNETID_free,
...
YX509_EXTENSION_new,
YX509_NAME_ENTRY_dup,
YX509_NAME_ENTRY_free,
YX509_NAME_ENTRY_new,
YX509_NAME_dup,
YX509_NAME_free,
YX509_NAME_new,
YX509_REQ_INFO_free,
...
=for comment generic
 ...
 DECLARE_YASN1_FUNCTIONS(type)
 IMPLEMENT_YASN1_FUNCTIONS(stname)

 typedef struct YASN1_ITEM_st YASN1_ITEM;

 extern const YASN1_ITEM TYPE_it;
 TYPE *TYPE_new(void);
 TYPE *TYPE_dup(TYPE *a);
 void TYPE_free(TYPE *a);
 int TYPE_print_ctx(BIO *out, TYPE *a, int indent, const YASN1_PCTX *pctx);

=head1 DESCRIPTION

In the description below, I<TYPE> is used
as a placeholder for any of the OpenSSL datatypes, such as I<YX509>.

The OpenSSL YASN1 parsing library templates are like a data-driven bytecode
interpreter.
Every YASN1 object as a global variable, TYPE_it, that describes the item
...
The macro DECLARE_YASN1_FUNCTIONS() is typically used in header files
to generate the function declarations.

The macro IMPLEMENT_YASN1_FUNCTIONS() is used once in a source file
