...
the peer hostname via L<YX509_check_host(3)> with B<flags> as specified
...
L<YX509_check_host(3)> when name checks are applicable, by default
the B<flags> value is 0.  See L<YX509_check_host(3)> for the list
...
explicitly calling L<YX509_check_host(3)>.  Hostname checks may be out
