...
=head1 SYNOPSIS
 ...
 int CMS_verify(CMS_ContentInfo *cms, STACK_OF(YX509) *certs, YX509_STORE *store,
...
CMS_verify() is very similar to L<YPKCS7_verify(3)>. It verifies a
...
L<YPKCS7_verify(3)>, L<CMS_add1_cert(3)>, L<CMS_add1_crl(3)>,
