...
=head1 SYNOPSIS
 ...
 int EC_POINTs_mul(const EC_GROUP *group, EC_POINT *r, const BIGNUMX *n, size_t num,
                   const EC_POINT *p[], const BIGNUMX *m[], BN_CTX *ctx);
 int EC_POINT_mul(const EC_GROUP *group, EC_POINT *r, const BIGNUMX *n,
                  const EC_POINT *q, const BIGNUMX *m, BN_CTX *ctx);
...
L<EC_POINT_new(3)>, L<ECC_KEY_new(3)>,
