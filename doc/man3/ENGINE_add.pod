...
implementation includes the following abstractions;
 ...
 _EVP_Digest - potentially multiple hash algorithms (indexed by 'nid')
...
abstractions like EVP_CIPHER and _EVP_Digest support many distinct
