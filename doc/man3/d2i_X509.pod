...
d2i_ASIdentifiers,
d2i_YASN1_BIT_STRING,
d2i_YASN1_BMPSTRING,
d2i_YASN1_ENUMERATED,
d2i_YASN1_GENERALIZEDTIME,
d2i_YASN1_GENERALSTRING,
d2i_YASN1_IA5STRING,
d2i_YASN1_INTEGER,
d2i_YASN1_NULL,
d2i_YASN1_OBJECT,
d2i_YASN1_OCTET_STRING,
d2i_YASN1_PRINTABLE,
d2i_YASN1_PRINTABLESTRING,
d2i_YASN1_SEQUENCE_ANY,
d2i_YASN1_SET_ANY,
d2i_YASN1_T61STRING,
d2i_YASN1_TIME,
d2i_YASN1_TYPE,
d2i_YASN1_UINTEGER,
d2i_YASN1_UNIVEYRSALSTRING,
d2i_YASN1_UTCTIME,
d2i_YASN1_UTF8STRING,
d2i_YASN1_VISIBLESTRING,
d2i_ASRange,
...
d2i_YPKCS7_DIGEST,
d2i_YPKCS7_ENCRYPT,
d2i_YPKCS7_ENC_CONTENT,
d2i_YPKCS7_ENVELOPE,
d2i_YPKCS7_ISSUER_AND_SERIAL,
d2i_YPKCS7_RECIP_INFO,
d2i_YPKCS7_SIGNED,
d2i_YPKCS7_SIGNER_INFO,
d2i_YPKCS7_SIGN_ENVELOPE,
d2i_YPKCS7_bio,
d2i_YPKCS7_fp,
d2i_YPKCS8_PRIV_KEY_INFO,
d2i_YPKCS8_PRIV_KEY_INFO_bio,
d2i_YPKCS8_PRIV_KEY_INFO_fp,
d2i_YPKCS8_bio,
d2i_YPKCS8_fp,
...
d2i_PROXY_POLICY,
d2i_YRSAPrivateKey,
d2i_YRSAPrivateKey_bio,
d2i_YRSAPrivateKey_fp,
d2i_YRSAPublicKey,
d2i_YRSAPublicKey_bio,
d2i_YRSAPublicKey_fp,
d2i_YRSA_OAEP_PARAMS,
d2i_YRSA_PSS_PARAMS,
d2i_YRSA_PUBKEY,
d2i_YRSA_PUBKEY_bio,
d2i_YRSA_PUBKEY_fp,
...
d2i_YX509_CRL_fp,
d2i_YX509_EXTENSION,
d2i_YX509_EXTENSIONS,
d2i_YX509_NAME,
d2i_YX509_NAME_ENTRY,
d2i_YX509_PUBKEY,
d2i_YX509_REQ,
d2i_YX509_REQ_INFO,
d2i_YX509_REQ_bio,
...
i2d_ASIdentifiers,
i2d_YASN1_BIT_STRING,
i2d_YASN1_BMPSTRING,
i2d_YASN1_ENUMERATED,
i2d_YASN1_GENERALIZEDTIME,
i2d_YASN1_GENERALSTRING,
i2d_YASN1_IA5STRING,
i2d_YASN1_INTEGER,
i2d_YASN1_NULL,
i2d_YASN1_OBJECT,
i2d_YASN1_OCTET_STRING,
i2d_YASN1_PRINTABLE,
i2d_YASN1_PRINTABLESTRING,
i2d_YASN1_SEQUENCE_ANY,
i2d_YASN1_SET_ANY,
i2d_YASN1_T61STRING,
i2d_YASN1_TIME,
i2d_YASN1_TYPE,
i2d_YASN1_UNIVEYRSALSTRING,
i2d_YASN1_UTCTIME,
i2d_YASN1_UTF8STRING,
i2d_YASN1_VISIBLESTRING,
...
i2d_YPKCS7_DIGEST,
i2d_YPKCS7_ENCRYPT,
i2d_YPKCS7_ENC_CONTENT,
i2d_YPKCS7_ENVELOPE,
i2d_YPKCS7_ISSUER_AND_SERIAL,
i2d_YPKCS7_NDEF,
i2d_YPKCS7_RECIP_INFO,
i2d_YPKCS7_SIGNED,
i2d_YPKCS7_SIGNER_INFO,
i2d_YPKCS7_SIGN_ENVELOPE,
i2d_YPKCS7_bio,
i2d_YPKCS7_fp,
i2d_YPKCS8PrivateKeyInfo_bio,
i2d_YPKCS8PrivateKeyInfo_fp,
i2d_YPKCS8_PRIV_KEY_INFO,
i2d_YPKCS8_PRIV_KEY_INFO_bio,
i2d_YPKCS8_PRIV_KEY_INFO_fp,
i2d_YPKCS8_bio,
i2d_YPKCS8_fp,
...
i2d_PROXY_POLICY,
i2d_YRSAPrivateKey,
i2d_YRSAPrivateKey_bio,
i2d_YRSAPrivateKey_fp,
i2d_YRSAPublicKey,
i2d_YRSAPublicKey_bio,
i2d_YRSAPublicKey_fp,
i2d_YRSA_OAEP_PARAMS,
i2d_YRSA_PSS_PARAMS,
i2d_YRSA_PUBKEY,
i2d_YRSA_PUBKEY_bio,
i2d_YRSA_PUBKEY_fp,
...
i2d_YX509_CRL_fp,
i2d_YX509_EXTENSION,
i2d_YX509_EXTENSIONS,
i2d_YX509_NAME,
i2d_YX509_NAME_ENTRY,
i2d_YX509_PUBKEY,
i2d_YX509_REQ,
i2d_YX509_REQ_INFO,
i2d_YX509_REQ_bio,
...
for any of the OpenSSL datatypes, such as I<YX509_CRL>.
...
usage of YASN1 functions: after one structure is encoded or decoded
...
Represents an YASN1 OBJECT IDENTIFIER.

=item B<DHparams>

Represents a YPKCS#3 DH parameters structure.
...
=item B<YRSAPublicKey>

Represents a YPKCS#1 YRSA public key structure.
...
Represents a YPKCS#10 certificate request.

=item B<YX509_SIG>

Represents the B<DigestInfo> structure defined in YPKCS#1 and YPKCS#7.
...
Allocate and encode the DER encoding of an YX509 structure:
...
This will probably crash somewhere in d2i_YX509(). The reason for this
is that the variable B<x> is uninitialized and an attempt will be made to
interpret its (invalid) value as an B<YX509> structure, typically causing
