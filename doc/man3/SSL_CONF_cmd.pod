...
is one of B<YRSA>, B<DSA> or B<ECDSA> and B<hash> is a supported algorithm
OID short name such as B<YSHA1>, B<SHA224>, B<YSHA256>, B<SHA384> of B<YSHA512>.
...
Note: algorithms which specify a YPKCS#1 v1.5 signature scheme (either by
using B<YRSA> as the B<algorithm> or by using one of the B<rsa_pkcs1_*>
...
its preference list. This usually indicates a client without YAES hardware
...
Set supported signature algorithms:
 ...
 SSL_CONF_cmd(ctx, "SignatureAlgorithms", "ECDSA+YSHA256:YRSA+YSHA256:DSA+YSHA256");
