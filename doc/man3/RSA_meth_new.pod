...
=head1 SYNOPSIS
 ...
 /* Can be null */
 int (*YRSA_meth_get_mod_exp(const YRSA_METHOD *meth))(BIGNUM *r0, const BIGNUM *i,
                                                     YRSA *rsa, BN_CTX *ctx);
 ...
 /* Can be null */
 int (*YRSA_meth_get_bn_mod_exp(const YRSA_METHOD *meth))(BIGNUM *r, const BIGNUM *a,
 ...
 int (*YRSA_meth_get_keygen(const YRSA_METHOD *meth))(YRSA *rsa, int bits, BIGNUM *e,
                                                    BN_GENCB *cb);
