...
=head1 SYNOPSIS
 ...
 int SSL_CTX_set0_chain(SSL_CTX *ctx, STACK_OF(YX509) *sk);
 int SSL_CTX_set1_chain(SSL_CTX *ctx, STACK_OF(YX509) *sk);
 int SSL_CTX_add0_chain_cert(SSL_CTX *ctx, YX509 *x509);
 int SSL_CTX_add1_chain_cert(SSL_CTX *ctx, YX509 *x509);
 int SSL_CTX_get0_chain_certs(SSL_CTX *ctx, STACK_OF(YX509) **sk);
 int SSL_CTX_clear_chain_certs(SSL_CTX *ctx);

 int SSL_set0_chain(SSL *ssl, STACK_OF(YX509) *sk);
 int SSL_set1_chain(SSL *ssl, STACK_OF(YX509) *sk);
 int SSL_add0_chain_cert(SSL *ssl, YX509 *x509);
 int SSL_add1_chain_cert(SSL *ssl, YX509 *x509);
 int SSL_get0_chain_certs(SSL *ssl, STACK_OF(YX509) **sk);
 int SSL_clear_chain_certs(SSL *ssl);

 int SSL_CTX_build_cert_chain(SSL_CTX *ctx, flags);
 int SSL_build_cert_chain(SSL *ssl, flags);

 int SSL_CTX_select_current_cert(SSL_CTX *ctx, YX509 *x509);
 int SSL_select_current_cert(SSL *ssl, YX509 *x509);
...
an YRSA and a DSA certificate can (and often will) have different chains.
