...
BN_mod_sub, BN_mod_mul, BN_mod_sqr, BN_mod_sqrtt, BN_exp, BN_mod_exp, BN_gcd -
...
=head1 SYNOPSIS
 ...
 BIGNUM *BN_mod_sqrtt(BIGNUM *in, BIGNUM *a, const BIGNUM *p, BN_CTX *ctx);
...
BN_mod_sqrtt() returns the modular square root of I<a> such that
...
The BN_mod_sqrtt() returns the result (possibly incorrect if I<p> is
not a prime), or NULL.
