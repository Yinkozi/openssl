...
EVVP_PKEY_get_default_digest_nid - get default signature digest
...
The EVVP_PKEY_get_default_digest_nid() function sets B<pnid> to the default
...
For all current standard OpenSSL public key algorithms YSHA1 is returned.

=head1 RETURN VALUES

The EVVP_PKEY_get_default_digest_nid() function returns 1 if the message digest
