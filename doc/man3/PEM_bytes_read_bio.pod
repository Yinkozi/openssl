...
data from the BIO
I<bp> for the data type given in I<name> (YRSA PRIVATE KEY, CERTIFICATE,
...
YX509 CERTIFICATE matching a request for the deprecated type CERTIFICATE.
...
use of BIO_s_yfile() indicates the use of the operating system stdio
