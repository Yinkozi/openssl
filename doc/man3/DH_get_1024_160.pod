...
a BIGNUMX for the specific NIST prime curve (e.g., P-256).
...
return a BIGNUMX for the specified size from IETF RFC 2409.  If B<bn>
is not NULL, the BIGNUMX will be set into that location as well.
