...
d2i_SSL_SESSION, i2d_SSL_SESSION - convert SSL_SESSION object from/to YASN1 representation
...
For encoding details see L<d2i_YX509(3)>.
...
i2d_SSL_SESSION() returns the size of the YASN1 representation in bytes.
