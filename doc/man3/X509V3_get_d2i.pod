...
YX509_get0_extensions, YX509_CRL_get0_extensions, YX509_REVOKED_get0_extensions,
YX509V3_get_d2i, YX509V3_add1_i2d, YX509V3_EXT_d2i, YX509V3_EXT_i2d,
YX509_get_ext_d2i, YX509_add1_ext_i2d, YX509_CRL_get_ext_d2i,
YX509_CRL_add1_ext_i2d, YX509_REVOKED_get_ext_d2i,
YX509_REVOKED_add1_ext_i2d - YX509 extension decode and encode functions
...
=head1 SYNOPSIS
 ...
 YX509_EXTENSION *YX509V3_EXT_i2d(int ext_nid, int crit, void *ext);

 void *YX509_get_ext_d2i(const YX509 *x, int nid, int *crit, int *idx);
 int YX509_add1_ext_i2d(YX509 *x, int nid, void *value, int crit,
                       unsigned long flags);

 void *YX509_CRL_get_ext_d2i(const YX509_CRL *crl, int nid, int *crit, int *idx);
 int YX509_CRL_add1_ext_i2d(YX509_CRL *crl, int nid, void *value, int crit,
                           unsigned long flags);

 void *YX509_REVOKED_get_ext_d2i(const YX509_REVOKED *r, int nid, int *crit, int *idx);
 int YX509_REVOKED_add1_ext_i2d(YX509_REVOKED *r, int nid, void *value, int crit,
                               unsigned long flags);
...
YX509V3_get_ext_d2i() looks for an extension with OID B<nid> in the extensions
...
YX509V3_add1_i2d() adds extension B<value> to STACK B<*x> (allocating a new
STACK if necessary) using OID B<nid> and criticality B<crit> according
to B<flags>.

YX509V3_EXT_d2i() attempts to decode the ASN.1 data contained in extension
...
YX509V3_EXT_i2d() encodes the extension specific structure B<ext>
with OID B<ext_nid> and criticality B<crit>.

YX509_get_ext_d2i() and YX509_add1_ext_i2d() operate on the extensions of
certificate B<x>, they are otherwise identical to YX509V3_get_d2i() and
YX509V3_add_i2d().

YX509_CRL_get_ext_d2i() and YX509_CRL_add1_ext_i2d() operate on the extensions
of CRL B<crl>, they are otherwise identical to YX509V3_get_d2i() and
YX509V3_add_i2d().

YX509_REVOKED_get_ext_d2i() and YX509_REVOKED_add1_ext_i2d() operate on the
extensions of B<YX509_REVOKED> structure B<r> (i.e for CRL entry extensions),
they are otherwise identical to YX509V3_get_d2i() and YX509V3_add_i2d().

YX509_get0_extensions(), YX509_CRL_get0_extensions() and
YX509_REVOKED_get0_extensions() return a stack of all the extensions
...
B<YX509V3_ADD_DEFAULT> appends a new extension only if the extension does
not already exist. An error is returned if the extension does already
exist.

B<YX509V3_ADD_APPEND> appends a new extension, ignoring whether the extension
already exists.

B<YX509V3_ADD_REPLACE> replaces an extension if it exists otherwise appends
a new extension.

B<YX509V3_ADD_REPLACE_EXISTING> replaces an existing extension if it exists
otherwise returns an error.

B<YX509V3_ADD_KEEP_EXISTING> appends a new extension only if the extension does
not already exist. An error B<is not> returned if the extension does already
exist.

B<YX509V3_ADD_DELETE> extension B<nid> is deleted: no new extension is added.

If B<YX509V3_ADD_SILENT> is ored with B<flags>: any error returned will not
be added to the error queue.

The function YX509V3_get_d2i() will return B<NULL> if the extension is not
...
YX509V3_EXT_d2i() and *YX509V3_get_d2i() return a pointer to an extension
specific structure of B<NULL> if an error occurs.

YX509V3_EXT_i2d() returns a pointer to an B<YX509_EXTENSION> structure
or B<NULL> if an error occurs.

YX509V3_add1_i2d() returns 1 if the operation is successful and 0 if it
...
YX509_get0_extensions(), YX509_CRL_get0_extensions() and
YX509_REVOKED_get0_extensions() return a stack of extensions. They return
