...
OPENSSL_load_builtin_modules, YASN1_add_oid_module, ENGINE_add_conf_module - add standard configuration modules
...
YASN1_add_oid_module() adds just the YASN1 OBJECT module.
