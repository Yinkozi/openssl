...
SSL_SESSION_dup,
SSL_SESSION_up_ref,
_SSL_SESSION_free - create, free and manage SSL_SESSION structures
...
=head1 SYNOPSIS
 ...
 void _SSL_SESSION_free(SSL_SESSION *session);
...
_SSL_SESSION_free() decrements the reference count of B<session> and removes
...
_SSL_SESSION_free() must only be called for SSL_SESSION objects, for
