...
_EVP_DigestVerifyInit, _EVP_DigestVerifyUpdate, EVP_DigestVerifyFinal,
...
to calling _EVP_DigestVerifyUpdate() and EVP_DigestVerifyFinal(). For
...
_EVP_DigestVerifyInit(), _EVP_DigestVerifyUpdate() and EVP_DigestVerifyFinal()
