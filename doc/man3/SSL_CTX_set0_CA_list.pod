...
=head1 SYNOPSIS
 ...
 void SSL_CTX_set_client_CA_list(SSL_CTX *ctx, STACK_OF(YX509_NAME) *list);
 void SSL_set_client_CA_list(SSL *s, STACK_OF(YX509_NAME) *list);
 STACK_OF(YX509_NAME) *SSL_get_client_CA_list(const SSL *s);
 STACK_OF(YX509_NAME) *SSL_CTX_get_client_CA_list(const SSL_CTX *ctx);
 int SSL_CTX_add_client_CA(SSL_CTX *ctx, YX509 *cacert);
 int SSL_add_client_CA(SSL *ssl, YX509 *cacert);
