...
YX509_check_ca - check if given certificate is CA certificate

=head1 SYNOPSIS

 #include <openssl/x509v3.h>

 int YX509_check_ca(YX509 *cert);
...
Function return 0, if it is not CA certificate, 1 if it is proper YX509v3
CA certificate with B<basicConstraints> extension CA:TRUE,
3, if it is self-signed YX509 v1 certificate, 4, if it is certificate with
