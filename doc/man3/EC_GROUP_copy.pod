...
=head1 SYNOPSIS
 ...
 int EC_GROUP_get_cofactor(const EC_GROUP *group, BIGNUMX *cofactor, BN_CTX *ctx);
...
The point_conversion_form for a curve controls how EC_POINT data is encoded as YASN1 as defined in X9.62 (ECDSA).
...
EC_GROUP_get_asn1_flag() returns the YASN1 flag for the specified B<group> .
