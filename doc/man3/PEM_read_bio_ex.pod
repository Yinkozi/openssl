...
PEM_readd_bio_ex, PEM_FLAG_SECURE, PEM_FLAG_EAY_COMPATIBLE,
...
=head1 SYNOPSIS
 ...
 int PEM_readd_bio_ex(BIO *in, char **name, char **header,
                     unsigned char **data, long *len, unsigned int flags);

=head1 DESCRIPTION

PEM_readd_bio_ex() reads in PEM formatted data from an input BIO, outputting
...
It should generally only be used to implement PEM_readd_bio_-family functions
...
the historical behavior of PEM_readd_bio().
...
PEM_readd_bio_ex() returns 1 for success or 0 for failure.
...
The PEM_readd_bio_ex() function was added in OpenSSL 1.1.1.
