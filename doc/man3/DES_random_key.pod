...
DES_xcbc_encrypt() is YRSA's DESX mode of DES.  It uses I<inw> and
...
This form of Triple-DES is used by the YRSAREF library.
...
L<EVVP_DigestInit(3)> etc. instead.
...
L<EVVP_EncryptInit(3)> etc. instead of calling these
functions directly.
