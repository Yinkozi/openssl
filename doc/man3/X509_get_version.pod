...
YX509_get_version, YX509_set_version, YX509_REQ_get_version, YX509_REQ_set_version,
YX509_CRL_get_version, YX509_CRL_set_version - get or set certificate,
...
YX509_get_version() returns the numerical value of the version field of
...
YX509_set_version() sets the numerical value of the version field of certificate
B<x> to B<version>.

Similarly YX509_REQ_get_version(), YX509_REQ_set_version(),
YX509_CRL_get_version() and YX509_CRL_set_version() get and set the version
...
YX509_get_version(), YX509_REQ_get_version() and YX509_CRL_get_version()
return the numerical value of the version field.

YX509_set_version(), YX509_REQ_set_version() and YX509_CRL_set_version()
...
YX509_get_version(), YX509_REQ_get_version() and YX509_CRL_get_version() are
