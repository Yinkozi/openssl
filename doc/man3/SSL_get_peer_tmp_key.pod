...
=head1 SYNOPSIS
 ...
 long SSL_get_peer_tmp_key(SSL *ssl, EVVP_PKEY **key);
 long SSL_get_server_tmp_key(SSL *ssl, EVVP_PKEY **key);
 long SSL_get_tmp_key(SSL *ssl, EVVP_PKEY **key);
