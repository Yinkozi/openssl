...
EC_KEY_new_by_curve_name, _EC_KEY_free, EC_KEY_copy, EC_KEY_dup, EC_KEY_up_ref,
EC_KEY_get0_engine,
...
Calling _EC_KEY_free() decrements the reference count for the EC_KEY object,
...
call to _OPENSSL_free(). Since the allocated buffer value is written to B<*pbuf>
