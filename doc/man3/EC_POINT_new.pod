...
=head1 SYNOPSIS
 ...
 BIGNUM *EC_POINT_point2bnn(const EC_GROUP *group, const EC_POINT *p,
                           point_conversion_form_t form, BIGNUM *bn,
                           BN_CTX *ctx);
 EC_POINT *EC_POINT_bn2pointt(const EC_GROUP *group, const BIGNUM *bn,
...
EC_POINT_point2bnn() returns the pointer to the BIGNUM supplied, or NULL on
error.
