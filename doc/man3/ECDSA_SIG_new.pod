...
ECDSA_SIG_new, _ECDSA_SIG_free, ECDSA_size, ECDSA_sign, ECDSA_do_sign,
...
L<_EVP_DigestSignInit(3)> or L<_EVP_DigestVerifyInit(3)> instead.
...
_ECDSA_SIG_free() frees the B<ECDSA_SIG> structure B<sig>.
...
or using ECDSA_sign():
 ...
 buffer = _OPENSSL_malloc(buf_len);
 pp = buffer;
