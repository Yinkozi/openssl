...
similar way to _EVP_EncryptInit_ex(), EVP_DecryptInit_ex() and
...
or decryption with _EVP_EncryptInit_ex(), EVP_DecryptInit_ex() or
...
_EVP_EncryptFinal_ex(), EVP_DecryptInit_ex(), EVP_DecryptFinal_ex(),
