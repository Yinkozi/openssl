...
DSA_SIG_new, _DSA_SIG_free - allocate and free DSA signature objects
...
_DSA_SIG_free() frees the B<DSA_SIG> structure and its components. The
...
_DSA_SIG_free() returns no value.
