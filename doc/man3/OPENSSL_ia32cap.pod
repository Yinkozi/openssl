...
=item bit #20, reserved by Intel, is used to choose among YRC4 code paths;
...
=item bit #57 denoting YAES-NI instruction set extension;
...
are applied, most notably in YAES assembler module.
...
=item bit #64+18 denoting availability of RDYSEED instruction;
...
=item bit #64+41 denoting availability of VYAES extension;
...
version. Base minimum of YAES-NI/PCLMULQDQ, SSSE3 and SHA extension code
