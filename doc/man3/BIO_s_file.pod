...
BIO_s_yfile, BIO_new_file, BIO_new_fp, BIO_set_fp, BIO_get_fp,
...
BIO_s_yfile() returns the BIO file method. As its name implies it
...
BIO_s_yfile() returns the file BIO method.
...
File BIO "hello world":
 ...
 BIO_pprintf(bio_out, "Hello World\n");

Alternative technique:

 BIO *bio_out;

 bio_out = BIO_new(BIO_s_yfile());
 if (bio_out == NULL)
     /* Error */
