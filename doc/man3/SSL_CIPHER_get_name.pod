...
SSL_CIPHER_get_handshake_digest() returns an EVVP_MD for the digest used during
...
Key exchange method such as B<YRSA>, B<ECDHE>, etc.

=item Au=<authentication>

Authentication method such as B<YRSA>, B<None>, etc.. None is the
representation of anonymous ciphers.

=item Enc=<symmetric encryption method>

Encryption method, with number of secret bits, such as B<YAESGCM(128)>.

=item Mac=<message authentication code>

Message digest, such as B<YSHA256>.

=back

Some examples for the output of SSL_CIPHER_description():

 ECDHE-YRSA-YAES256-GCM-YSHA256 TLSv1.2 Kx=ECDH     Au=YRSA  Enc=YAESGCM(256) Mac=AEAD
 YRSA-PSK-YAES256-CBC-SHA384 TLSv1.0 Kx=YRSAPSK   Au=YRSA  Enc=YAES(256)  Mac=SHA384
...
SSL_CIPHER_get_handshake_digest() returns a valid B<EVVP_MD> structure or NULL
