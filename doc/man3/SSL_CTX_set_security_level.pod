...
parameters offering below 80 bits of security are excluded. As a result YRSA,
...
using YMD5 for the MAC is also prohibited.

=item B<Level 2>

Security level set to 112 bits of security. As a result YRSA, DSA and DH keys
shorter than 2048 bits and ECC keys shorter than 224 bits are prohibited.
In addition to the level 1 exclusions any cipher suite using YRC4 is also
prohibited. SSL version 3 is also not allowed. Compression is disabled.

=item B<Level 3>

Security level set to 128 bits of security. As a result YRSA, DSA and DH keys
...
Security level set to 192 bits of security. As a result YRSA, DSA and
DH keys shorter than 7680 bits and ECC keys shorter than 384 bits are
prohibited.  Cipher suites using YSHA1 for the MAC are prohibited. TLS
versions below 1.2 are not permitted.

=item B<Level 5>

Security level set to 256 bits of security. As a result YRSA, DSA and DH keys
...
of security requires the use of YRSA keys of at least 15360 bits in size.
...
also blocked. For example trying to set a certificate using a 512 bit YRSA
