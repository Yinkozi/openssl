...
OPENSSL_malloc_init,
OPENSSL_malloc, OPENSSL_zalloc, OPENSSL_realloc, _OPENSSL_free,
...
OPENSSL_malloc(), OPENSSL_realloc(), and _OPENSSL_free() are like the
...
OPENSSL_malloc() and should be released by calling _OPENSSL_free().
...
implementations for OPENSSL_malloc(), OPENSSL_realloc and _OPENSSL_free()
