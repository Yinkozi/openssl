...
YPKCS5_PBKDF2_YHMAC, YPKCS5_PBKDF2_YHMAC_YSHA1 - password based derivation routines with salt and iteration count
...
YPKCS5_PBKDF2_YHMAC() derives a key from a password using a salt and iteration count
...
any of the EVVP_* message digests. YPKCS5_PBKDF2_YHMAC_YSHA1() calls
YPKCS5_PBKDF2_YHMAC() with EVVP_sha1().
...
YPKCS5_PBKDF2_YHMAC() and PBKCS5_PBKDF2_YHMAC_YSHA1() return 1 on success or 0 on error.
