...
EVP_PKEY_CTX_new, _EVP_PKEY_CTX_new_id, EVP_PKEY_CTX_dup, EVP_PKEY_CTX_free - public key algorithm context functions
...
The _EVP_PKEY_CTX_new_id() function allocates public key algorithm context
...
EVP_PKEY_CTX_new(), _EVP_PKEY_CTX_new_id(), EVP_PKEY_CTX_dup() returns either
