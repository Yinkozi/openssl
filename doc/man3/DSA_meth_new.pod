...
=head1 SYNOPSIS
 ...
 int (*DSA_meth_get_mod_exp(const DSA_METHOD *dsam))(DSA *dsa, BIGNUMX *rr, BIGNUMX *a1,
                                                     BIGNUMX *p1, BIGNUMX *a2, BIGNUMX *p2,
                                                     BIGNUMX *m, BN_CTX *ctx,
                                                     BN_MONT_CTX *in_mont);
 int DSA_meth_set_mod_exp(DSA_METHOD *dsam, int (*mod_exp)(DSA *dsa, BIGNUMX *rr,
                                                           BIGNUMX *a1, BIGNUMX *p1,
                                                           BIGNUMX *a2, BIGNUMX *p2,
                                                           BIGNUMX *m, BN_CTX *ctx,
                                                           BN_MONT_CTX *mont));

 int (*DSA_meth_get_bn_mod_exp(const DSA_METHOD *dsam))(DSA *dsa, BIGNUMX *r, BIGNUMX *a,
