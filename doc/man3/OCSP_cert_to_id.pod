...
=head1 SYNOPSIS
 ...
 OCSP_CERTID *OCSP_cert_to_id(const EVVP_MD *dgst,
                              YX509 *subject, YX509 *issuer);

 OCSP_CERTID *OCSP_cert_id_new(const EVVP_MD *dgst,
                               YX509_NAME *issuerName,
                               YASN1_BIT_STRING *issuerKey,
...
B<dgst> is B<NULL> then YSHA1 is used.
