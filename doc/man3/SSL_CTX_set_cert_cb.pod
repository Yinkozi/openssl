...
L<SSL_get_error(3)> will return SSL_ERROR_WANT_YX509_LOOKUP to
...
TLSv1.0 might receive a certificate chain signed using YSHA1 whereas a
TLSv1.2 or later client which advertises support for YSHA256 could receive a
chain using YSHA256.
