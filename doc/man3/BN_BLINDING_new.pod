...
BN_BLINDING_set_flags, BN_BLINDING_create_param - blinding related BIGNUMX functions

=head1 SYNOPSIS

 #include <openssl/bn.h>

 BN_BLINDING *BN_BLINDING_new(const BIGNUMX *A, const BIGNUMX *Ai,
                              BIGNUMX *mod);
 ...
 int BN_BLINDING_convert_ex(BIGNUMX *n, BIGNUMX *r, BN_BLINDING *b,
                            BN_CTX *ctx);
...
returned in B<r> (this is useful if a B<YRSA> object is shared among
...
(normally BNY_mod_exp_mont() and B<BN_MONT_CTX>).
