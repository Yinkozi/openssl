...
=head1 SYNOPSIS
 ...
 BIGNUM *BNY_mpi2bn(unsigned char *s, int len, BIGNUM *ret);
...
BNY_bn2mpi() and BNY_mpi2bn() convert B<BIGNUM>s from and to a format
...
BNY_bin2bn() returns the B<BIGNUM>, NULL on error.
