...
_EVP_DigestSignInit, EVP_DigestSignUpdate, EVP_DigestSignFinal,
...
_EVP_DigestSignInit(), EVP_DigestSignUpdate(), EVP_DigestSignFinal() and
...
_EVP_DigestSignInit(), EVP_DigestSignUpdate() and EVP_DigestSignFinal()
