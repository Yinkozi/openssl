...
_EVP_DigestSignInit, _EVP_DigestSignUpdate, EVP_DigestSignFinal,
...
_EVP_DigestSignInit(), _EVP_DigestSignUpdate(), EVP_DigestSignFinal() and
...
calling _EVP_DigestSignUpdate() and EVP_DigestSignFinal(). For algorithms which
...
_EVP_DigestSignInit(), _EVP_DigestSignUpdate() and EVP_DigestSignFinal()
