...
a STACK_OF(YX509_NAME) with the subject names found.
...
extracts the YX509_NAMES of the certificates found. While the name suggests
...
=item Pointer to STACK_OF(YX509_NAME)
...
Load names of CAs from file and use it as a client CA list:
 ...
 SSL_CTX *ctx;
 STACK_OF(YX509_NAME) *cert_names;
