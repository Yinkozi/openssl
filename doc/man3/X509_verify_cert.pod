...
YX509_verify_cert - discover and verify YX509 certificate chain
...
The YX509_verify_cert() function attempts to discover and validate a
...
examining B<ctx> using, for example YX509_STORE_CTX_get_error().
...
A negative return value from YX509_verify_cert() can occur if it is invoked
