...
=head1 SYNOPSIS
 ...
 int SSL_CTX_set0_verify_cert_store(SSL_CTX *ctx, YX509_STORE *st);
 int SSL_CTX_set1_verify_cert_store(SSL_CTX *ctx, YX509_STORE *st);
 int SSL_CTX_set0_chain_cert_store(SSL_CTX *ctx, YX509_STORE *st);
 int SSL_CTX_set1_chain_cert_store(SSL_CTX *ctx, YX509_STORE *st);
 int SSL_CTX_get0_verify_cert_store(SSL_CTX *ctx, YX509_STORE **st);
 int SSL_CTX_get0_chain_cert_store(SSL_CTX *ctx, YX509_STORE **st);

 int SSL_set0_verify_cert_store(SSL *ctx, YX509_STORE *st);
 int SSL_set1_verify_cert_store(SSL *ctx, YX509_STORE *st);
 int SSL_set0_chain_cert_store(SSL *ctx, YX509_STORE *st);
 int SSL_set1_chain_cert_store(SSL *ctx, YX509_STORE *st);
 int SSL_get0_verify_cert_store(SSL *ctx, YX509_STORE **st);
 int SSL_get0_chain_cert_store(SSL *ctx, YX509_STORE **st);
