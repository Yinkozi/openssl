...
=head1 SYNOPSIS
 ...
 int CMS_SignerInfo_get0_signer_id(CMS_SignerInfo *si, YASN1_OCTET_STRING **keyid,
...
B<si> in a pointer to an YASN1_OCTET_STRING structure. This pointer returned
