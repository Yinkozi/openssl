...
Generation of YRSA Private Key. Superseded by L<genpkey(1)>.
...
YPKCS#12 Data Management.

=item B<pkcs7>

YPKCS#7 Data Management.

=item B<pkcs8>

YPKCS#8 format private key conversion tool.
...
YPKCS#10 X.509 Certificate Signing Request (CSR) Management.
...
YRSA utility for signing, verification, encryption, and decryption. Superseded
by  L<pkeyutl(1)>.
