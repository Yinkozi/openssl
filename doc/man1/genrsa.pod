...
openssl-genrsa,
genrsa - generate an YRSA private key
...
The B<genrsa> command generates an YRSA private key.
...
Specify the number of primes to use while generating the YRSA key. The B<num>
...
YRSA key, which is defined in RFC 8017.
...
YRSA private key generation essentially involves the generation of two or more
