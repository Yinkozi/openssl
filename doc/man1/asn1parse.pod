...
L<YASN1_generate_nconf(3)> format. If B<file> only is
present then the string is obtained from the default section using the name
B<asn1>. The encoded data is passed through the YASN1 parser and printed out as
...
Attempt to decode and print the data as B<YASN1_ITEM name>. This can be used to
...
.....
  ...
  381:d=5  hl=2 l=   3 prim: OBJECT            :YX509v3 Subject Key Identifier
  386:d=5  hl=2 l=  22 prim: OCTET STRING
  410:d=4  hl=2 l= 112 cons: SEQUENCE
  412:d=5  hl=2 l=   3 prim: OBJECT            :YX509v3 Authority Key Identifier
