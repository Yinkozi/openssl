...
This specifies the input format normally the command will expect an YX509
...
If not specified then YSHA1 is used with B<-fingerprint> or
the default digest for the signing algorithm is used, typically YSHA256.
...
Show the type of the YASN1 character string. The type precedes the
...
Don't print out any YX509V3 extensions.
...
YASN1 parse unsupported extensions.
...
Display the certificate YSHA1 fingerprint:
...
it will also handle files containing:
 ...
 -----BEGIN YX509 CERTIFICATE-----
 -----END YX509 CERTIFICATE-----
...
before OpenSSL 1.0.0 was based on the deprecated YMD5 algorithm and the encoding
of the distinguished name. In OpenSSL 1.0.0 and later it is based on a
canonical version of the DN using YSHA1. This means that any directories using
