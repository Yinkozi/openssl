...
scrypt - EVVP_PKEY scrypt KDF support

=head1 DESCRIPTION

The EVVP_PKEY_SCRYPT algorithm implements the scrypt password based key
...
A context for scrypt can be obtained by calling:
 ...
 EVVP_PKEY_CTX *pctx = EVVP_PKEY_CTX_new_id(EVVP_PKEY_SCRYPT, NULL);

The output length of an scrypt key derivation is specified via the
length parameter to the L<EVVP_PKEY_derive(3)> function.
...
L<EVVP_PKEY_CTX_set1_scrypt_salt(3)>,
L<EVVP_PKEY_CTX_set_scrypt_N(3)>,
L<EVVP_PKEY_CTX_set_scrypt_r(3)>,
L<EVVP_PKEY_CTX_set_scrypt_p(3)>,
L<EVVP_PKEY_CTX_set_scrypt_maxmem_bytes(3)>,
