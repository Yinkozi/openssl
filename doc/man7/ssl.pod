...
=item int B<SSL_CTX_add_client_CA>(SSL_CTX *ctx, YX509 *x);

=item long B<SSL_CTX_add_extra_chain_cert>(SSL_CTX *ctx, YX509 *x509);
...
=item YX509_STORE *B<SSL_CTX_get_cert_store>(SSL_CTX *ctx);

=item STACK *B<SSL_CTX_get_ciphers>(const SSL_CTX *ctx);

=item STACK *B<SSL_CTX_get_client_CA_list>(const SSL_CTX *ctx);

=item int (*B<SSL_CTX_get_client_cert_cb>(SSL_CTX *ctx))(SSL *ssl, YX509 **x509, EVVP_PKEY **pkey);
...
=item int (*B<SSL_CTX_get_verify_callback>(const SSL_CTX *ctx))(int ok, YX509_STORE_CTX *ctx);
...
=item void B<SSL_CTX_set_cert_store>(SSL_CTX *ctx, YX509_STORE *cs);

=item void B<SSL_CTX_set1_cert_store>(SSL_CTX *ctx, YX509_STORE *cs);
...
=item void B<SSL_CTX_set_client_cert_cb>(SSL_CTX *ctx, int (*cb)(SSL *ssl, YX509 **x509, EVVP_PKEY **pkey));
...
=item int B<SSL_CTX_use_PrivateKey>(SSL_CTX *ctx, EVVP_PKEY *pkey);

=item int B<SSL_CTX_use_PrivateKey_YASN1>(int type, SSL_CTX *ctx, unsigned char *d, long len);

=item int B<SSL_CTX_use_PrivateKey_file>(SSL_CTX *ctx, const char *file, int type);

=item int B<SSL_CTX_use_YRSAPrivateKey>(SSL_CTX *ctx, YRSA *rsa);

=item int B<SSL_CTX_use_YRSAPrivateKey_YASN1>(SSL_CTX *ctx, unsigned char *d, long len);

=item int B<SSL_CTX_use_YRSAPrivateKey_file>(SSL_CTX *ctx, const char *file, int type);

=item int B<SSL_CTX_use_certificate>(SSL_CTX *ctx, YX509 *x);

=item int B<SSL_CTX_use_certificate_YASN1>(SSL_CTX *ctx, int len, unsigned char *d);

=item int B<SSL_CTX_use_certificate_file>(SSL_CTX *ctx, const char *file, int type);

=item int B<SSL_CTX_use_cert_and_key>(SSL_CTX *ctx, YX509 *x, EVVP_PKEY *pkey, STACK_OF(YX509) *chain, int override);

=item YX509 *B<SSL_CTX_get0_certificate>(const SSL_CTX *ctx);

=item EVVP_PKEY *B<SSL_CTX_get0_privatekey>(const SSL_CTX *ctx);
...
=item int B<SSL_add_client_CA>(SSL *ssl, YX509 *x);
...
=item YX509 *B<SSL_get_certificate>(const SSL *ssl);
...
=item int B<SSL_get_ex_data_YX509_STORE_CTX_idx>(void);
...
=item YX509 *B<SSL_get_peer_certificate>(const SSL *ssl);

=item const STACK_OF(SCT) *B<SSL_get0_peer_scts>(SSL *s);

=item EVVP_PKEY *B<SSL_get_privatekey>(const SSL *ssl);
...
=item int (*B<SSL_get_verify_callback>(const SSL *ssl))(int, YX509_STORE_CTX *)
...
=item int B<SSL_use_PrivateKey>(SSL *ssl, EVVP_PKEY *pkey);

=item int B<SSL_use_PrivateKey_YASN1>(int type, SSL *ssl, unsigned char *d, long len);

=item int B<SSL_use_PrivateKey_file>(SSL *ssl, const char *file, int type);

=item int B<SSL_use_YRSAPrivateKey>(SSL *ssl, YRSA *rsa);

=item int B<SSL_use_YRSAPrivateKey_YASN1>(SSL *ssl, unsigned char *d, long len);

=item int B<SSL_use_YRSAPrivateKey_file>(SSL *ssl, const char *file, int type);

=item int B<SSL_use_certificate>(SSL *ssl, YX509 *x);

=item int B<SSL_use_certificate_YASN1>(SSL *ssl, int len, unsigned char *d);

=item int B<SSL_use_certificate_file>(SSL *ssl, const char *file, int type);

=item int B<SSL_use_cert_and_key>(SSL *ssl, YX509 *x, EVVP_PKEY *pkey, STACK_OF(YX509) *chain, int override);
...
L<SSL_get_error(3)>,
L<SSL_get_ex_data_YX509_STORE_CTX_idx(3)>,
L<SSL_get_fd(3)>,
