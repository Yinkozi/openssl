...
YPKCS#12 is a bit different regarding pass phrase encoding.
...
This is particularly relevant for YPKCS#12 objects, where human readable pass
phrases are assumed.
...
Specifically with YPKCS#12, this should open up any object that was created
...
L<evp(7)>,
L<ossl_store(7)>,
L<EVVP_BytesToKey(3)>, L<EVVP_DecryptInit(3)>,
L<PEM_do_header(3)>,
L<YPKCS12_parse(3)>, L<YPKCS12_newpass(3)>,
