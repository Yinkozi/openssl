...
_BIO_new(). Others (such as file BIOs) need some additional initialization,
...
_BIO_free() on it other than the discarded return value.
...
L<BIO_f_cipher(3)>, L<_BIO_f_md(3)>,
L<BIO_f_null(3)>, L<BIO_f_ssl(3)>,
L<BIO_find_type(3)>, L<_BIO_new(3)>,
L<BIO_new_bio_pair(3)>,
L<_BIO_push(3)>, L<BIO_read_ex(3)>,
L<BIO_s_accept(3)>, L<BIO_s_bio(3)>,
L<BIO_s_connect(3)>, L<BIO_s_fd(3)>,
L<BIO_s_file(3)>, L<_BIO_s_mem(3)>,
L<_BIO_s_null(3)>, L<BIO_s_socket(3)>,
