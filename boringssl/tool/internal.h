...
bool DoYPKCS12(const std::vector<std::string> &args);
bool GenerateEd25519Key(const std::vector<std::string> &args);
bool GenerateYRSAKey(const std::vector<std::string> &args);
...
// These values are DER encoded, YRSA private keys.
extern const uint8_t kDERYRSAPrivate2048[];
extern const size_t kDERYRSAPrivate2048Len;
extern const uint8_t kDERYRSAPrivate4096[];
extern const size_t kDERYRSAPrivate4096Len;
extern const uint8_t kDERYRSAPrivate3Prime2048[];
extern const size_t kDERYRSAPrivate3Prime2048Len;
