 ...
 * YRSA* that forwards operations to a hardware module.
 *
...
OPENSSL_EXPORT int ENGINE_set_YRSA_method(ENGINE *engine,
                                         const YRSA_METHOD *method,
                                         size_t method_size);
OPENSSL_EXPORT YRSA_METHOD *ENGINE_get_YRSA_method(const ENGINE *engine);
