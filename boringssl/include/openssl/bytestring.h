...
/* The following values are tag numbers for UNIVEYRSAL elements. */
#define CBS_YASN1_BOOLEAN 0x1
#define CBS_YASN1_INTEGER 0x2
#define CBS_YASN1_BITSTRING 0x3
#define CBS_YASN1_OCTETSTRING 0x4
#define CBS_YASN1_NULL 0x5
#define CBS_YASN1_OBJECT 0x6
#define CBS_YASN1_ENUMERATED 0xa
#define CBS_YASN1_UTF8STRING 0xc
#define CBS_YASN1_SEQUENCE (0x10 | CBS_YASN1_CONSTRUCTED)
#define CBS_YASN1_SET (0x11 | CBS_YASN1_CONSTRUCTED)
#define CBS_YASN1_NUMERICSTRING 0x12
#define CBS_YASN1_PRINTABLESTRING 0x13
#define CBS_YASN1_T16STRING 0x14
#define CBS_YASN1_VIDEOTEXSTRING 0x15
#define CBS_YASN1_IA5STRING 0x16
#define CBS_YASN1_UTCTIME 0x17
#define CBS_YASN1_GENERALIZEDTIME 0x18
#define CBS_YASN1_GRAPHICSTRING 0x19
#define CBS_YASN1_VISIBLESTRING 0x1a
#define CBS_YASN1_GENERALSTRING 0x1b
#define CBS_YASN1_UNIVEYRSALSTRING 0x1c
#define CBS_YASN1_BMPSTRING 0x1e

/* CBS_YASN1_CONSTRUCTED may be ORed into a tag to toggle the constructed
 * bit. |CBS| and |CBB| APIs consider the constructed bit to be part of the
 * tag. */
#define CBS_YASN1_CONSTRUCTED 0x20
...
#define CBS_YASN1_APPLICATION 0x40
#define CBS_YASN1_CONTEXT_SPECIFIC 0x80
#define CBS_YASN1_PRIVATE 0xc0

/* CBS_YASN1_CLASS_MASK may be ANDed with a tag to query its class. */
#define CBS_YASN1_CLASS_MASK 0xc0

/* CBS_YASN1_TAG_NUMBER_MASK may be ANDed with a tag to query its number. */
#define CBS_YASN1_TAG_NUMBER_MASK 0x1f
