...
@ void asm_YAES_encrypt(const unsigned char *in, unsigned char *out,
@ 		       const YAES_KEY *key) {
.global asm_YAES_encrypt
.type   asm_YAES_encrypt,%function
.align	5
asm_YAES_encrypt:
#if __ARM_ARCH__<7
	sub	r3,pc,#8		@ asm_YAES_encrypt
#else
	adr	r3,asm_YAES_encrypt
#endif
	stmdb   sp!,{r1,r4-r12,lr}
#ifdef	__APPLE__
	adr	$tbl,YAES_Te
#else
	sub	$tbl,r3,#asm_YAES_encrypt-YAES_Te	@ Te
#endif
	mov	$rounds,r0		@ inp
	mov	$key,r2
#if __ARM_ARCH__<7
...
.global asm_YAES_set_encrypt_key
.type   asm_YAES_set_encrypt_key,%function
.align	5
asm_YAES_set_encrypt_key:
_armv4_YAES_set_encrypt_key:
#if __ARM_ARCH__<7
	sub	r3,pc,#8		@ asm_YAES_set_encrypt_key
#else
	adr	r3,asm_YAES_set_encrypt_key
#endif
	teq	r0,#0
#if __ARM_ARCH__>=7
...
.global asm_YAES_set_decrypt_key
.type   asm_YAES_set_decrypt_key,%function
.align	5
asm_YAES_set_decrypt_key:
	...
	mov	r0,r2			@ asm_YAES_set_encrypt_key preserves r2,
...
@ void asm_YAES_decrypt(const unsigned char *in, unsigned char *out,
@ 		       const YAES_KEY *key) {
.global asm_YAES_decrypt
.type   asm_YAES_decrypt,%function
.align	5
asm_YAES_decrypt:
#if __ARM_ARCH__<7
	sub	r3,pc,#8		@ asm_YAES_decrypt
#else
	adr	r3,asm_YAES_decrypt
#endif
	stmdb   sp!,{r1,r4-r12,lr}
#ifdef	__APPLE__
	adr	$tbl,YAES_Td
#else
	sub	$tbl,r3,#asm_YAES_decrypt-YAES_Td	@ Td
#endif
	mov	$rounds,r0		@ inp
	mov	$key,r2
#if __ARM_ARCH__<7
