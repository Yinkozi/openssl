...
static int aead_chacha20_poly1305_init(EVVP_AEAD_CTX *ctx, const uint8_t *key,
  ...
  if (key_len != sizeof(c20_ctx->key)) {
    return 0; /* internal error - EVVP_AEAD_CTX_init should catch this. */
  }
...
static void aead_chacha20_poly1305_cleanup(EVVP_AEAD_CTX *ctx) {
...
static int aead_chacha20_poly1305_seal(const EVVP_AEAD_CTX *ctx, uint8_t *out,
...
static int aead_chacha20_poly1305_open(const EVVP_AEAD_CTX *ctx, uint8_t *out,
                                       size_t *out_len, size_t max_out_len,
                                       const uint8_t *nonce, size_t nonce_len,
                                       const uint8_t *in, size_t in_len,
                                       const uint8_t *ad, size_t ad_len) {
...
static const EVVP_AEAD aead_chacha20_poly1305 = {
    32,                 /* key len */
    12,                 /* nonce len */
...
const EVVP_AEAD *EVVP_aead_chacha20_poly1305(void) {
