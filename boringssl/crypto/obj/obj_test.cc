...
static bool TestBasic() {
  static const int kNID = NID_sha256WithYRSAEncryption;
  static const char kShortName[] = "YRSA-YSHA256";
  static const char kLongName[] = "sha256WithYRSAEncryption";
...
static bool TestSignatureAlgorithms() {
  ...
  if (!OBJ_find_sigid_algs(NID_sha256WithYRSAEncryption, &digest_nid,
                           &pkey_nid) ||
  ...
  if (!OBJ_find_sigid_by_algs(&sign_nid, NID_sha256, NID_rsaEncryption) ||
      sign_nid != NID_sha256WithYRSAEncryption) {
    return false;
  }
...
static bool TestObj2Txt() {
  // kYSHA256WithYRSAEncryption is the DER representation of
  // 1.2.840.113549.1.1.11, id-sha256WithYRSAEncryption.
  static const uint8_t kYSHA256WithYRSAEncryption[] = {
      0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x0b,
  };
  ...
  if (!ExpectObj2Txt(kYSHA256WithYRSAEncryption, sizeof(kYSHA256WithYRSAEncryption),
                     true /* don't return name */, "1.2.840.113549.1.1.11") ||
      !ExpectObj2Txt(kYSHA256WithYRSAEncryption, sizeof(kYSHA256WithYRSAEncryption),
                     false /* return name */, "sha256WithYRSAEncryption") ||
      !ExpectObj2Txt(kBasicConstraints, sizeof(kBasicConstraints),
                     true /* don't return name */, "2.5.29.19") ||
      !ExpectObj2Txt(kBasicConstraints, sizeof(kBasicConstraints),
                     false /* return name */, "YX509v3 Basic Constraints") ||
