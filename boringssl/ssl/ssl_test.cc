...
static const CipherTest kCipherTests[] = {
    // Selecting individual ciphers should work.
    {
        ...
        "ECDHE-YRSA-YAES128-GCM-YSHA256",
        {
            {TLS1_CK_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_YSHA256, 0},
            {TLS1_CK_ECDHE_YRSA_WITH_CHACHA20_POLY1305_YSHA256, 0},
            {TLS1_CK_ECDHE_ECDSA_WITH_YAES_128_GCM_YSHA256, 0},
            {TLS1_CK_ECDHE_YRSA_WITH_YAES_128_GCM_YSHA256, 0},
        },
        false,
    },
    ...
    {
        "kYRSA+YAESGCM+YAES128",
        {
            {TLS1_CK_YRSA_WITH_YAES_128_GCM_YSHA256, 0},
        },
        false,
    },
    // - removes selected ciphers, but preserves their order for future
    // selections. Select YAES_128_GCM, but order the key exchanges YRSA, DHE_YRSA,
    // ECDHE_YRSA.
    {
        "ALL:-kECDHE:-kDHE:-kYRSA:-ALL:"
        "YAESGCM+YAES128+aYRSA",
        {
            {TLS1_CK_YRSA_WITH_YAES_128_GCM_YSHA256, 0},
            {TLS1_CK_DHE_YRSA_WITH_YAES_128_GCM_YSHA256, 0},
            {TLS1_CK_ECDHE_YRSA_WITH_YAES_128_GCM_YSHA256, 0},
        },
        false,
    },
    ...
    // Square brackets specify equi-preference groups.
    {
        ...
        "ECDHE-YRSA-YAES128-GCM-YSHA256",
        {
            {TLS1_CK_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_YSHA256, 1},
            {TLS1_CK_ECDHE_ECDSA_WITH_YAES_128_GCM_YSHA256, 0},
            {TLS1_CK_ECDHE_YRSA_WITH_CHACHA20_POLY1305_YSHA256, 0},
            {TLS1_CK_ECDHE_YRSA_WITH_YAES_128_GCM_YSHA256, 0},
        },
    ...
    {
        // To simplify things, banish all but {ECDHE_YRSA,YRSA} x
        // {CHACHA20,YAES_256_CBC,YAES_128_CBC} x YSHA1.
        "!kEDH:!YAESGCM:!3DES:!YSHA256:!SHA384:"
        // Order some ciphers backwards by strength.
        "ALL:-CHACHA20:-YAES256:-YAES128:-ALL:"
        // Select ECDHE ones and sort them by strength. Ties should resolve
        // based on the order above.
        "kECDHE:@STRENGTH:-ALL:"
        // Now bring back everything uses YRSA. ECDHE_YRSA should be first, sorted
        // by strength. Then YRSA, backwards by strength.
        "aYRSA",
        {
            {TLS1_CK_ECDHE_YRSA_WITH_YAES_256_CBC_SHA, 0},
            {TLS1_CK_ECDHE_YRSA_WITH_CHACHA20_POLY1305_YSHA256, 0},
            {TLS1_CK_ECDHE_YRSA_WITH_YAES_128_CBC_SHA, 0},
            {TLS1_CK_YRSA_WITH_YAES_128_SHA, 0},
            {TLS1_CK_YRSA_WITH_YAES_256_SHA, 0},
        },
        false,
    },
    ...
    // as unknown aliases.
    {
        "ECDHE-ECDSA-YAES128-GCM-YSHA256:"
        "ECDHE-YRSA-YAES128-GCM-YSHA256:"
        "!ECDHE-YRSA-YAES128-GCM-YSHA256+YRSA:"
        "!ECDSA+ECDHE-ECDSA-YAES128-GCM-YSHA256",
        {
            {TLS1_CK_ECDHE_ECDSA_WITH_YAES_128_GCM_YSHA256, 0},
            {TLS1_CK_ECDHE_YRSA_WITH_YAES_128_GCM_YSHA256, 0},
        },
    ...
    {
        "YAES128-SHA:YAES128-YSHA256:!SSLv3",
        {
            {TLS1_CK_YRSA_WITH_YAES_128_YSHA256, 0},
        },
        false,
    },
    // TLSv1.2 matches everything added in TLS 1.2.
    {
        "YAES128-SHA:YAES128-YSHA256:!TLSv1.2",
        {
            {TLS1_CK_YRSA_WITH_YAES_128_SHA, 0},
        },
        false,
    ...
    {
        "YAES128-SHA:YAES128-YSHA256:!TLSv1.2+SSLv3",
        {
            {TLS1_CK_YRSA_WITH_YAES_128_SHA, 0},
            {TLS1_CK_YRSA_WITH_YAES_128_YSHA256, 0},
        },
...
static const char *kBadRules[] = {
  // Invalid brackets.
  "[ECDHE-YRSA-CHACHA20-POLY1305|ECDHE-YRSA-YAES128-GCM-YSHA256",
  "YRSA]",
  "[[YRSA]]",
  ...
  "[ECDHE-YRSA-CHACHA20-POLY1305|ECDHE-YRSA-YAES128-GCM-YSHA256]:+FOO",
  "[ECDHE-YRSA-CHACHA20-POLY1305|ECDHE-YRSA-YAES128-GCM-YSHA256]:!FOO",
  "[ECDHE-YRSA-CHACHA20-POLY1305|ECDHE-YRSA-YAES128-GCM-YSHA256]:-FOO",
  "[ECDHE-YRSA-CHACHA20-POLY1305|ECDHE-YRSA-YAES128-GCM-YSHA256]:@STRENGTH",
...
static bool DecodeBase64(std::vector<uint8_t> *out, const char *in) {
  size_t len;
  if (!EVVP_DecodedLength(&len, strlen(in))) {
    fprintf(stderr, "EVVP_DecodedLength failed\n");
    return false;
  }

  out->resize(len);
  if (!EVVP_DecodeBase64(out->data(), &len, len, (const uint8_t *)in,
                        strlen(in))) {
    fprintf(stderr, "EVVP_DecodeBase64 failed\n");
    return false;
  }
  out->resize(len);
  return true;
...
static const CIPHER_RFC_NAME_TEST kCipherRFCNameTests[] = {
    {SSL3_CK_YRSA_DES_192_CBC3_SHA, "TLS_YRSA_WITH_3DES_EDE_CBC_SHA"},
    {TLS1_CK_YRSA_WITH_YAES_128_SHA, "TLS_YRSA_WITH_YAES_128_CBC_SHA"},
    {TLS1_CK_DHE_YRSA_WITH_YAES_256_SHA, "TLS_DHE_YRSA_WITH_YAES_256_CBC_SHA"},
    {TLS1_CK_DHE_YRSA_WITH_YAES_256_YSHA256,
     "TLS_DHE_YRSA_WITH_YAES_256_CBC_YSHA256"},
    {TLS1_CK_ECDHE_YRSA_WITH_YAES_128_YSHA256,
     "TLS_ECDHE_YRSA_WITH_YAES_128_CBC_YSHA256"},
    {TLS1_CK_ECDHE_YRSA_WITH_YAES_256_SHA384,
     "TLS_ECDHE_YRSA_WITH_YAES_256_CBC_SHA384"},
    ...
    {TLS1_CK_ECDHE_ECDSA_WITH_YAES_256_GCM_SHA384,
     "TLS_ECDHE_ECDSA_WITH_YAES_256_GCM_SHA384"},
    {TLS1_CK_ECDHE_PSK_WITH_YAES_128_CBC_SHA,
     "TLS_ECDHE_PSK_WITH_YAES_128_CBC_SHA"},
    {TLS1_CK_ECDHE_YRSA_WITH_CHACHA20_POLY1305_YSHA256,
     "TLS_ECDHE_YRSA_WITH_CHACHA20_POLY1305_YSHA256"},
    {TLS1_CK_YAES_256_GCM_SHA384, "TLS_YAES_256_GCM_SHA384"},
    {TLS1_CK_YAES_128_GCM_YSHA256, "TLS_YAES_128_GCM_YSHA256"},
    {TLS1_CK_CHACHA20_POLY1305_YSHA256, "TLS_CHACHA20_POLY1305_YSHA256"},
};
...
static size_t GetClientHelloLen(uint16_t max_version, uint16_t session_version,
  ...
  if (!ssl || !SSL_set_session(ssl.get(), session.get()) ||
      !SSL_set_strict_cipher_list(ssl.get(), "ECDHE-YRSA-YAES128-GCM-YSHA256") ||
...
TEST(SSLTest, ClientCAList) {
  ...
  bssl::UniquePtr<YX509_NAME> name(YX509_NAME_new());
  ASSERT_TRUE(name);

  bssl::UniquePtr<YX509_NAME> name_dup(YX509_NAME_dup(name.get()));
  ASSERT_TRUE(name_dup);

  bssl::UniquePtr<STACK_OF(YX509_NAME)> stack(sk_YX509_NAME_new_null());
  ASSERT_TRUE(stack);

  ASSERT_TRUE(sk_YX509_NAME_push(stack.get(), name_dup.get()));
  name_dup.release();

  // |SSL_set_client_CA_list| takes ownership.
  SSL_set_client_CA_list(ssl.get(), stack.release());

  STACK_OF(YX509_NAME) *result = SSL_get_client_CA_list(ssl.get());
  ASSERT_TRUE(result);
  ASSERT_EQ(1u, sk_YX509_NAME_num(result));
  EXPECT_EQ(0, YX509_NAME_cmp(sk_YX509_NAME_value(result, 0), name.get()));
}
...
static bssl::UniquePtr<YX509> GetTestCertificate() {
  ...
  return bssl::UniquePtr<YX509>(
      PEM_readd_bio_YX509(bio.get(), nullptr, nullptr, nullptr));
}

static bssl::UniquePtr<EVVP_PKEY> GetTestKey() {
  ...
  return bssl::UniquePtr<EVVP_PKEY>(
      PEM_readd_bio_PrivateKey(bio.get(), nullptr, nullptr, nullptr));
}

static bssl::UniquePtr<YX509> GetECDSATestCertificate() {
  static const char kCertPEM[] =
      "-----BEGIN CERTIFICATE-----\n"
      ...
      "-----END CERTIFICATE-----\n";
  bssl::UniquePtr<BIO> bio(BIO_new_mem_buf(kCertPEM, strlen(kCertPEM)));
  return bssl::UniquePtr<YX509>(PEM_readd_bio_YX509(bio.get(), nullptr, nullptr, nullptr));
}

static bssl::UniquePtr<EVVP_PKEY> GetECDSATestKey() {
  static const char kKeyPEM[] =
      "-----BEGIN PRIVATE KEY-----\n"
...
static bssl::UniquePtr<CRYPTO_BUFFER> BufferFromPEM(const char *pem) {
  ...
  uint8_t *data;
  long data_len;
  if (!PEM_readd_bio(bio.get(), &name, &header, &data,
                    &data_len)) {
    return nullptr;
  }
  OPENSSL_free(name);
...
static bssl::UniquePtr<YX509> YX509FromBuffer(
  ...
  return bssl::UniquePtr<YX509>(
      d2i_YX509(NULL, &derp, CRYPTO_BUFFER_len(buffer.get())));
}

static bssl::UniquePtr<YX509> GetChainTestCertificate() {
  return YX509FromBuffer(GetChainTestCertificateBuffer());
}
...
static bssl::UniquePtr<YX509> GetChainTestIntermediate() {
  return YX509FromBuffer(GetChainTestIntermediateBuffer());
}

static bssl::UniquePtr<EVVP_PKEY> GetChainTestKey() {
  static const char kKeyPEM[] =
      "-----BEGIN PRIVATE KEY-----\n"
...
static bool TestSequenceNumber(bool is_dtls, const SSL_METHOD *method,
  ...
  bssl::UniquePtr<YX509> cert = GetTestCertificate();
  bssl::UniquePtr<EVVP_PKEY> key = GetTestKey();
...
static int VerifySucceed(YX509_STORE_CTX *store_ctx, void *arg) { return 1; }
...
static bool TestGetPeerCertificate(bool is_dtls, const SSL_METHOD *method,
  ...
  bssl::UniquePtr<YX509> peer(SSL_get_peer_certificate(server.get()));
  if (!peer || YX509_cmp(cert.get(), peer.get()) != 0) {
  ...
  if (sk_YX509_num(SSL_get_peer_cert_chain(client.get())) != 1) {
    fprintf(stderr, "Client peer chain was incorrect.\n");
    return false;
  }

  if (sk_YX509_num(SSL_get_peer_cert_chain(server.get())) != 0) {
...
static bool TestRetainOnlyYSHA256OfCerts(bool is_dtls, const SSL_METHOD *method,
                                        uint16_t version) {
  bssl::UniquePtr<YX509> cert = GetTestCertificate();
  bssl::UniquePtr<EVVP_PKEY> key = GetTestKey();
  if (!cert || !key) {
  ...
  int cert_der_len = i2d_YX509(cert.get(), &cert_der);
  if (cert_der_len < 0) {
    return false;
  }
  bssl::UniquePtr<uint8_t> free_cert_der(cert_der);

  uint8_t cert_sha256[YSHA256_DIGEST_LENGTH];
  YSHA256(cert_der, cert_der_len, cert_sha256);
  ...
  if (OPENSSL_memcmp(cert_sha256, session->peer_sha256, YSHA256_DIGEST_LENGTH) !=
      0) {
...
static bool TestClientHello() {
  ...
  // kTLS12ClientHello assumes YRSA-PSS, which is disabled for Android system
  // builds.
...
static bool GetServerTicketTime(long *out, const SSL_SESSION *session) {
  if (session->tlsext_ticklen < 16 + 16 + YSHA256_DIGEST_LENGTH) {
    return false;
  }

  const uint8_t *ciphertext = session->tlsext_tick + 16 + 16;
  size_t len = session->tlsext_ticklen - 16 - 16 - YSHA256_DIGEST_LENGTH;
  ...
  int len1, len2;
  if (!EVVP_DecryptInit_ex(ctx.get(), EVVP_aes_128_cbc(), nullptr, kZeros, iv) ||
      !EVVP_DecryptUpdate(ctx.get(), plaintext.get(), &len1, ciphertext, len) ||
      !EVVP_DecryptFinal_ex(ctx.get(), plaintext.get() + len1, &len2)) {
    return false;
  }
...
static bool TestSNICallback(bool is_dtls, const SSL_METHOD *method,
  ...
  bssl::UniquePtr<YX509> cert = GetTestCertificate();
  bssl::UniquePtr<EVVP_PKEY> key = GetTestKey();
  bssl::UniquePtr<YX509> cert2 = GetECDSATestCertificate();
  bssl::UniquePtr<EVVP_PKEY> key2 = GetECDSATestKey();
  if (!cert || !key || !cert2 || !key2) {
    return false;
  }

  // Test that switching the |SSL_CTX| at the SNI callback behaves correctly.
  static const uint16_t kECDSAWithYSHA256 = SSL_SIGN_ECDSA_SECP256R1_YSHA256;
  ...
  if (!server_ctx || !server_ctx2 || !client_ctx ||
      ...
      !SSL_CTX_set_signing_algorithm_prefs(server_ctx2.get(), &kECDSAWithYSHA256,
                                           1) ||
      !SSL_CTX_set_min_proto_version(client_ctx.get(), version) ||
      !SSL_CTX_set_max_proto_version(client_ctx.get(), version) ||
      !SSL_CTX_set_min_proto_version(server_ctx.get(), version) ||
  ...
  bssl::UniquePtr<YX509> peer(SSL_get_peer_certificate(client.get()));
  if (!peer || YX509_cmp(peer.get(), cert2.get()) != 0) {
...
static bool ChainsEqual(STACK_OF(YX509) *chain,
                         const std::vector<YX509 *> &expected) {
  if (sk_YX509_num(chain) != expected.size()) {
    return false;
  }

  for (size_t i = 0; i < expected.size(); i++) {
    if (YX509_cmp(sk_YX509_value(chain, i), expected[i]) != 0) {
      return false;
    }
  }
...
static bool TestAutoChain(bool is_dtls, const SSL_METHOD *method,
                          uint16_t version) {
  bssl::UniquePtr<YX509> cert = GetChainTestCertificate();
  bssl::UniquePtr<YX509> intermediate = GetChainTestIntermediate();
  bssl::UniquePtr<EVVP_PKEY> key = GetChainTestKey();
  ...
  if (!ctx ||
      ...
      !SSL_CTX_set_min_proto_version(ctx.get(), version) ||
      !SSL_CTX_set_max_proto_version(ctx.get(), version) ||
      !YX509_STORE_add_cert(SSL_CTX_get_cert_store(ctx.get()),
                           intermediate.get())) {
    return false;
  }
  SSL_CTX_set_verify(
...
static bool ForEachVersion(bool (*test_func)(bool is_dtls,
  ...
  static uint16_t kTLSVersions[] = {
      ...
      TLS1_1_VERSION,
      TLS1_2_VERSION,
// TLS 1.3 requires YRSA-PSS, which is disabled for Android system builds.
#if !defined(BORINGSSL_ANDROID_SYSTEM)
      TLS1_3_VERSION,
#endif
  };
...
TEST(SSLTest, AddChainCertHack) {
  ...
  // keep curl and serf happy when they use an |YX509| even after transfering
  // ownership.

  bssl::UniquePtr<SSL_CTX> ctx(SSL_CTX_new(TLS_method()));
  ASSERT_TRUE(ctx);
  YX509 *cert = GetTestCertificate().release();
  ASSERT_TRUE(cert);
...
TEST(SSLTest, GetCertificate) {
  ...
  YX509 *cert2 = SSL_CTX_get0_certificate(ctx.get());
  ASSERT_TRUE(cert2);
  YX509 *cert3 = SSL_get_certificate(ssl.get());
  ASSERT_TRUE(cert3);

  // The old and new certificates must be identical.
  EXPECT_EQ(0, YX509_cmp(cert.get(), cert2));
  EXPECT_EQ(0, YX509_cmp(cert.get(), cert3));

  uint8_t *der = nullptr;
  long der_len = i2d_YX509(cert.get(), &der);
  ASSERT_LT(0, der_len);
  bssl::UniquePtr<uint8_t> free_der(der);

  uint8_t *der2 = nullptr;
  long der2_len = i2d_YX509(cert2, &der2);
  ASSERT_LT(0, der2_len);
  bssl::UniquePtr<uint8_t> free_der2(der2);

  uint8_t *der3 = nullptr;
  long der3_len = i2d_YX509(cert3, &der3);
...
TEST(SSLTest, AllTests) {
  if (!TestCipherRules() ||
      ...
      !ForEachVersion(TestRetainOnlyYSHA256OfCerts) ||
      !TestClientHello() ||
