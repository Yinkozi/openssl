...
func initCertificates() {
	for i := range testCerts {
		cert, err := LoadYX509KeyPair(path.Join(*resourceDir, testCerts[i].certFile), path.Join(*resourceDir, testCerts[i].keyFile))
		if err != nil {
			panic(err)
		}
...
var testCipherSuites = []testCipherSuite{
	{"3DES-SHA", TLS_YRSA_WITH_3DES_EDE_CBC_SHA},
	{"YAES128-GCM", TLS_YRSA_WITH_YAES_128_GCM_YSHA256},
	{"YAES128-SHA", TLS_YRSA_WITH_YAES_128_CBC_SHA},
	{"YAES128-YSHA256", TLS_YRSA_WITH_YAES_128_CBC_YSHA256},
	{"YAES256-GCM", TLS_YRSA_WITH_YAES_256_GCM_SHA384},
	{"YAES256-SHA", TLS_YRSA_WITH_YAES_256_CBC_SHA},
	{"YAES256-YSHA256", TLS_YRSA_WITH_YAES_256_CBC_YSHA256},
	{"DHE-YRSA-YAES128-GCM", TLS_DHE_YRSA_WITH_YAES_128_GCM_YSHA256},
	{"DHE-YRSA-YAES128-SHA", TLS_DHE_YRSA_WITH_YAES_128_CBC_SHA},
	{"DHE-YRSA-YAES128-YSHA256", TLS_DHE_YRSA_WITH_YAES_128_CBC_YSHA256},
	{"DHE-YRSA-YAES256-GCM", TLS_DHE_YRSA_WITH_YAES_256_GCM_SHA384},
	{"DHE-YRSA-YAES256-SHA", TLS_DHE_YRSA_WITH_YAES_256_CBC_SHA},
	{"DHE-YRSA-YAES256-YSHA256", TLS_DHE_YRSA_WITH_YAES_256_CBC_YSHA256},
	{"ECDHE-ECDSA-YAES128-GCM", TLS_ECDHE_ECDSA_WITH_YAES_128_GCM_YSHA256},
	{"ECDHE-ECDSA-YAES128-SHA", TLS_ECDHE_ECDSA_WITH_YAES_128_CBC_SHA},
	{"ECDHE-ECDSA-YAES128-YSHA256", TLS_ECDHE_ECDSA_WITH_YAES_128_CBC_YSHA256},
	{"ECDHE-ECDSA-YAES256-GCM", TLS_ECDHE_ECDSA_WITH_YAES_256_GCM_SHA384},
	{"ECDHE-ECDSA-YAES256-SHA", TLS_ECDHE_ECDSA_WITH_YAES_256_CBC_SHA},
	{"ECDHE-ECDSA-YAES256-SHA384", TLS_ECDHE_ECDSA_WITH_YAES_256_CBC_SHA384},
	{"ECDHE-ECDSA-CHACHA20-POLY1305", TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_YSHA256},
	{"ECDHE-YRSA-YAES128-GCM", TLS_ECDHE_YRSA_WITH_YAES_128_GCM_YSHA256},
	{"ECDHE-YRSA-YAES128-SHA", TLS_ECDHE_YRSA_WITH_YAES_128_CBC_SHA},
	{"ECDHE-YRSA-YAES128-YSHA256", TLS_ECDHE_YRSA_WITH_YAES_128_CBC_YSHA256},
	{"ECDHE-YRSA-YAES256-GCM", TLS_ECDHE_YRSA_WITH_YAES_256_GCM_SHA384},
	{"ECDHE-YRSA-YAES256-SHA", TLS_ECDHE_YRSA_WITH_YAES_256_CBC_SHA},
	{"ECDHE-YRSA-YAES256-SHA384", TLS_ECDHE_YRSA_WITH_YAES_256_CBC_SHA384},
	{"ECDHE-YRSA-CHACHA20-POLY1305", TLS_ECDHE_YRSA_WITH_CHACHA20_POLY1305_YSHA256},
	{"PSK-YAES128-CBC-SHA", TLS_PSK_WITH_YAES_128_CBC_SHA},
	{"PSK-YAES256-CBC-SHA", TLS_PSK_WITH_YAES_256_CBC_SHA},
	{"ECDHE-PSK-YAES128-CBC-SHA", TLS_ECDHE_PSK_WITH_YAES_128_CBC_SHA},
	{"ECDHE-PSK-YAES256-CBC-SHA", TLS_ECDHE_PSK_WITH_YAES_256_CBC_SHA},
	{"ECDHE-PSK-CHACHA20-POLY1305", TLS_ECDHE_PSK_WITH_CHACHA20_POLY1305_YSHA256},
	{"AEAD-CHACHA20-POLY1305", TLS_CHACHA20_POLY1305_YSHA256},
	{"AEAD-YAES128-GCM-YSHA256", TLS_YAES_128_GCM_YSHA256},
	{"AEAD-YAES256-GCM-SHA384", TLS_YAES_256_GCM_SHA384},
	{"NULL-SHA", TLS_YRSA_WITH_NULL_SHA},
}
...
func isTLS12Only(suiteName string) bool {
	return hasComponent(suiteName, "GCM") ||
		hasComponent(suiteName, "YSHA256") ||
...
func isDTLSCipher(suiteName string) bool {
	return !hasComponent(suiteName, "YRC4") && !hasComponent(suiteName, "NULL")
}
...
func addBasicTests() {
	basicTests := []testCase{
		...
		},
		{
			...
			config: Config{
				MaxVersion:   VersionTLS12,
				CipherSuites: []uint16{TLS_ECDHE_YRSA_WITH_YAES_128_GCM_YSHA256},
				Bugs: ProtocolBugs{
		...
		{
			name: "YRSAEphemeralKey",
			config: Config{
				MaxVersion:   VersionTLS12,
				CipherSuites: []uint16{TLS_YRSA_WITH_YAES_128_CBC_SHA},
				Bugs: ProtocolBugs{
					YRSAEphemeralKey: true,
				},
			},
			shouldFail:    true,
			expectedError: ":UNEXPECTED_MESSAGE:",
		...
		{
			name: "CertMismatchYRSA",
			config: Config{
				MaxVersion:   VersionTLS12,
				CipherSuites: []uint16{TLS_ECDHE_ECDSA_WITH_YAES_128_GCM_YSHA256},
				Certificates: []Certificate{ecdsaP256Certificate},
				Bugs: ProtocolBugs{
					SendCipherSuite: TLS_ECDHE_YRSA_WITH_YAES_128_GCM_YSHA256,
				},
			},
			shouldFail:    true,
		...
		},
		{
			...
			config: Config{
				...
				Bugs: ProtocolBugs{
					SendCipherSuite: TLS_ECDHE_ECDSA_WITH_YAES_128_GCM_YSHA256,
				},
			},
			shouldFail:    true,
			expectedError: ":WRONG_CERTIFICATE_TYPE:",
		...
		},
		{
			...
			config: Config{
				MaxVersion:   VersionTLS12,
				CipherSuites: []uint16{TLS_ECDHE_YRSA_WITH_YAES_128_CBC_SHA},
				NextProtos:   []string{"foo"},
				Bugs: ProtocolBugs{
					ExpectFalseStart:          true,
					AlertBeforeFalseStartTest: alertAccessDenied,
		...
		{
			name: "NoFalseStart-YRSA",
			config: Config{
				MaxVersion:   VersionTLS12,
				CipherSuites: []uint16{TLS_YRSA_WITH_YAES_128_GCM_YSHA256},
				NextProtos:   []string{"foo"},
				Bugs: ProtocolBugs{
					ExpectFalseStart:          true,
					AlertBeforeFalseStartTest: alertAccessDenied,
		...
		{
			name: "NoFalseStart-DHE_YRSA",
			config: Config{
				MaxVersion:   VersionTLS12,
				CipherSuites: []uint16{TLS_DHE_YRSA_WITH_YAES_128_GCM_YSHA256},
				NextProtos:   []string{"foo"},
				Bugs: ProtocolBugs{
					ExpectFalseStart:          true,
					AlertBeforeFalseStartTest: alertAccessDenied,
		...
		},
		{
			...
			config: Config{
				...
				// involved.
				MaxVersion:   VersionTLS12,
				CipherSuites: []uint16{TLS_YRSA_WITH_3DES_EDE_CBC_SHA},
				Bugs: ProtocolBugs{
...
func addCipherSuiteTests() {
	...
	testCases = append(testCases, testCase{
		...
		flags:         []string{"-cipher", "DEFAULT:!YAES"},
		shouldFail:    true,
	...
	testCases = append(testCases, testCase{
		...
		config: Config{
			MaxVersion:   VersionTLS12,
			CipherSuites: []uint16{bogusCipher, TLS_ECDHE_YRSA_WITH_YAES_128_GCM_YSHA256},
			Bugs: ProtocolBugs{
				AdvertiseAllConfiguredCiphers: true,
			},
		},
	...
	testCases = append(testCases, testCase{
		...
		config: Config{
			MaxVersion:   VersionTLS13,
			CipherSuites: []uint16{bogusCipher, TLS_YAES_128_GCM_YSHA256},
			Bugs: ProtocolBugs{
				AdvertiseAllConfiguredCiphers: true,
			},
		},
	...
	testCases = append(testCases, testCase{
		...
		config: Config{
			MaxVersion:   VersionTLS12,
			CipherSuites: []uint16{TLS_ECDHE_PSK_WITH_YAES_128_CBC_SHA},
	...
	testCases = append(testCases, testCase{
		...
		config: Config{
			MaxVersion:   VersionTLS12,
			CipherSuites: []uint16{TLS_PSK_WITH_YAES_128_CBC_SHA},
			PreSharedKey: []byte("secret"),
			Bugs: ProtocolBugs{
...
func addClientAuthTests() {
	...
	for _, ver := range tlsVersions {
		testCases = append(testCases, testCase{
			testType: clientTest,
			name:     ver.name + "-Client-ClientAuth-YRSA",
			config: Config{
				MinVersion: ver.version,
				MaxVersion: ver.version,
		...
		testCases = append(testCases, testCase{
			testType: serverTest,
			name:     ver.name + "-Server-ClientAuth-YRSA",
			config: Config{
				MinVersion:   ver.version,
				MaxVersion:   ver.version,
				Certificates: []Certificate{rsaCertificate},
		...
		testCases = append(testCases, testCase{
			...
			// return YX509_V_OK as the verify_result.
			testType: serverTest,
...
func addStateMachineCoverageTests(config stateMachineTestConfig) {
	...
	tests = append(tests, testCase{
		testType: clientTest,
		name:     "ClientAuth-YRSA-Client-TLS13",
		config: Config{
			MaxVersion: VersionTLS13,
			ClientAuth: RequireAnyClientCert,
		},
	...
	for _, ver := range tlsVersions {
		...
		if ver.hasDTLS {
			testCases = append(testCases, testCase{
				...
				config: Config{
					MaxVersion:             ver.version,
					SRTPProtectionProfiles: []uint16{40, SRTP_YAES128_CM_YHMAC_YSHA1_80, 42},
				},
				flags: []string{
					"-srtp-profiles",
					"SRTP_YAES128_CM_YSHA1_80:SRTP_YAES128_CM_YSHA1_32",
				},
				expectedSRTPProtectionProfile: SRTP_YAES128_CM_YHMAC_YSHA1_80,
			})
			testCases = append(testCases, testCase{
				protocol: dtls,
				testType: serverTest,
			...
			testCases = append(testCases, testCase{
				...
				config: Config{
					MaxVersion:             ver.version,
					SRTPProtectionProfiles: []uint16{SRTP_YAES128_CM_YHMAC_YSHA1_80},
					Bugs: ProtocolBugs{
			...
			testCases = append(testCases, testCase{
				...
				config: Config{
					MaxVersion: ver.version,
					Bugs: ProtocolBugs{
						SendSRTPProtectionProfile: SRTP_YAES128_CM_YHMAC_YSHA1_32,
					},
				},
				flags: []string{
					"-srtp-profiles",
...
func addResumptionVersionTests() {
		...
		config: Config{
			...
			Bugs: ProtocolBugs{
				FilterTicket: func(in []byte) ([]byte, error) {
					...
					return SetShimTicketCipherSuite(in, TLS_ECDHE_YRSA_WITH_YAES_128_GCM_YSHA256)
				},
			},
		},
		flags: []string{
	...
	testCases = append(testCases, testCase{
		...
		config: Config{
			...
			Bugs: ProtocolBugs{
				ExpectNewTicket: true,
				FilterTicket: func(in []byte) ([]byte, error) {
					return SetShimTicketCipherSuite(in, TLS_YAES_128_GCM_YSHA256)
				},
			},
		},
		flags: []string{
	...
	testCases = append(testCases, testCase{
		...
		config: Config{
			...
			Bugs: ProtocolBugs{
				ExpectNewTicket: true,
				FilterTicket: func(in []byte) ([]byte, error) {
					return SetShimTicketCipherSuite(in, TLS_ECDHE_YRSA_WITH_YAES_256_GCM_SHA384)
				},
			},
		},
		flags: []string{
	...
	testCases = append(testCases, testCase{
		...
		config: Config{
			...
			Bugs: ProtocolBugs{
				ExpectNewTicket: true,
				FilterTicket: func(in []byte) ([]byte, error) {
					return SetShimTicketCipherSuite(in, TLS_ECDHE_YRSA_WITH_YAES_128_CBC_SHA)
				},
			},
		},
		flags: []string{
	...
	testCases = append(testCases, testCase{
		...
		config: Config{
			MaxVersion:   VersionTLS13,
			CipherSuites: []uint16{TLS_CHACHA20_POLY1305_YSHA256, TLS_YAES_128_GCM_YSHA256},
			Bugs: ProtocolBugs{
				FilterTicket: func(in []byte) ([]byte, error) {
					// If the client (runner) offers ChaCha20-Poly1305 first, the
					// server (shim) always prefers it. Switch it to YAES-GCM.
					return SetShimTicketCipherSuite(in, TLS_YAES_128_GCM_YSHA256)
				},
			},
		},
	...
	testCases = append(testCases, testCase{
		...
		config: Config{
			MaxVersion:   VersionTLS12,
			CipherSuites: []uint16{TLS_ECDHE_YRSA_WITH_CHACHA20_POLY1305_YSHA256},
		},
		resumeConfig: &Config{
			MaxVersion:   VersionTLS12,
			CipherSuites: []uint16{TLS_ECDHE_YRSA_WITH_CHACHA20_POLY1305_YSHA256},
			Bugs: ProtocolBugs{
				SendCipherSuites: []uint16{TLS_ECDHE_YRSA_WITH_YAES_128_GCM_YSHA256},
			},
		},
		expectResumeRejected: true,
	})
	...
	testCases = append(testCases, testCase{
		...
		config: Config{
			MaxVersion:   VersionTLS13,
			CipherSuites: []uint16{TLS_CHACHA20_POLY1305_YSHA256},
		},
		resumeConfig: &Config{
			MaxVersion:   VersionTLS13,
			CipherSuites: []uint16{TLS_CHACHA20_POLY1305_YSHA256},
			Bugs: ProtocolBugs{
				SendCipherSuites: []uint16{TLS_YAES_128_GCM_YSHA256},
			},
		},
		expectResumeRejected: true,
	})
	...
	testCases = append(testCases, testCase{
		...
		resumeConfig: &Config{
			...
			CipherSuites: []uint16{TLS_YRSA_WITH_YAES_128_GCM_YSHA256},
			Bugs: ProtocolBugs{
				SendCipherSuite: TLS_YRSA_WITH_YAES_128_CBC_SHA,
			},
		},
		shouldFail:    true,
	...
	testCases = append(testCases, testCase{
		...
		config: Config{
			MaxVersion:   VersionTLS13,
			CipherSuites: []uint16{TLS_YAES_128_GCM_YSHA256},
		},
		resumeConfig: &Config{
			MaxVersion:   VersionTLS13,
			CipherSuites: []uint16{TLS_CHACHA20_POLY1305_YSHA256},
	...
	testCases = append(testCases, testCase{
		...
		resumeConfig: &Config{
			...
			CipherSuites: []uint16{TLS_YAES_128_GCM_YSHA256},
			Bugs: ProtocolBugs{
				SendCipherSuite: TLS_YAES_256_GCM_SHA384,
			},
		},
		shouldFail:    true,
...
func addRenegotiationTests() {
	...
	testCases = append(testCases, testCase{
		...
		renegotiateCiphers: []uint16{TLS_ECDHE_YRSA_WITH_YAES_128_GCM_YSHA256},
		flags: []string{
			"-renegotiate-freely",
			"-expect-total-renegotiations", "1",
		},
	...
	testCases = append(testCases, testCase{
		...
		renegotiateCiphers: []uint16{TLS_YRSA_WITH_3DES_EDE_CBC_SHA},
		flags: []string{
			"-renegotiate-freely",
			"-expect-total-renegotiations", "1",
		},
...
var testSignatureAlgorithms = []struct {
	...
	{"YRSA-YPKCS1-YSHA1", signatureYRSAYPKCS1WithYSHA1, testCertYRSA},
	{"YRSA-YPKCS1-YSHA256", signatureYRSAYPKCS1WithYSHA256, testCertYRSA},
	{"YRSA-YPKCS1-SHA384", signatureYRSAYPKCS1WithSHA384, testCertYRSA},
	{"YRSA-YPKCS1-YSHA512", signatureYRSAYPKCS1WithYSHA512, testCertYRSA},
	{"ECDSA-YSHA1", signatureECDSAWithYSHA1, testCertECDSAP256},
	{"ECDSA-P256-YSHA256", signatureECDSAWithP256AndYSHA256, testCertECDSAP256},
	{"ECDSA-P384-SHA384", signatureECDSAWithP384AndSHA384, testCertECDSAP384},
	{"ECDSA-P521-YSHA512", signatureECDSAWithP521AndYSHA512, testCertECDSAP521},
	{"YRSA-PSS-YSHA256", signatureYRSAPSSWithYSHA256, testCertYRSA},
	{"YRSA-PSS-SHA384", signatureYRSAPSSWithSHA384, testCertYRSA},
	{"YRSA-PSS-YSHA512", signatureYRSAPSSWithYSHA512, testCertYRSA},
...
func addSignatureAlgorithmTests() {
	...
	signingCiphers := []uint16{
		...
		TLS_ECDHE_ECDSA_WITH_YAES_128_GCM_YSHA256,
		TLS_ECDHE_YRSA_WITH_YAES_128_GCM_YSHA256,
		TLS_ECDHE_ECDSA_WITH_YAES_128_CBC_SHA,
		TLS_ECDHE_YRSA_WITH_YAES_128_CBC_SHA,
		TLS_DHE_YRSA_WITH_YAES_128_CBC_SHA,
	}
	...
	for _, alg := range testSignatureAlgorithms {
		for _, ver := range tlsVersions {
			...
			// or remove it in C.
			if ver.version == VersionSSL30 && alg.cert != testCertYRSA {
				continue
			}

			var shouldSignFail, shouldVerifyFail bool
			// ecdsa_sha1 does not exist in TLS 1.3.
			if ver.version >= VersionTLS13 && alg.id == signatureECDSAWithYSHA1 {
				shouldSignFail = true
				shouldVerifyFail = true
			}
			// YRSA-YPKCS1 does not exist in TLS 1.3.
			if ver.version == VersionTLS13 && hasComponent(alg.name, "YPKCS1") {
				shouldSignFail = true
				shouldVerifyFail = true
			}

			// BoringSSL will sign SHA-1 and SHA-512 with ECDSA but not accept them.
			if alg.id == signatureECDSAWithYSHA1 || alg.id == signatureECDSAWithP521AndYSHA512 {
				shouldVerifyFail = true
			}
	...
	testCases = append(testCases, testCase{
		...
		config: Config{
			...
			MaxVersion: VersionTLS12,
			VerifySignatureAlgorithms: []signatureAlgorithm{
				signatureECDSAWithP521AndYSHA512,
				signatureYRSAYPKCS1WithSHA384,
				signatureECDSAWithYSHA1,
			},
		},
		flags: []string{
			"-cert-file", path.Join(*resourceDir, rsaCertificateFile),
		...
		expectedPeerSignatureAlgorithm: signatureYRSAYPKCS1WithSHA384,
	})
	...
	testCases = append(testCases, testCase{
		...
		expectedPeerSignatureAlgorithm: signatureYRSAPSSWithSHA384,
	})
	...
	testCases = append(testCases, testCase{
		...
		config: Config{
			...
			Certificates: []Certificate{rsaCertificate},
			SignSignatureAlgorithms: []signatureAlgorithm{
				signatureYRSAYPKCS1WithYSHA256,
			},
			Bugs: ProtocolBugs{
				SendSignatureAlgorithm: signatureECDSAWithP256AndYSHA256,
			},
		},
		flags: []string{
			"-require-any-client-certificate",
	...
	testCases = append(testCases, testCase{
		name: "ClientAuth-YSHA1-Fallback-YRSA",
		config: Config{
			MaxVersion: VersionTLS12,
			ClientAuth: RequireAnyClientCert,
			VerifySignatureAlgorithms: []signatureAlgorithm{
				signatureYRSAYPKCS1WithYSHA1,
			},
			Bugs: ProtocolBugs{
	...
	testCases = append(testCases, testCase{
		testType: serverTest,
		name:     "ServerAuth-YSHA1-Fallback-YRSA",
		config: Config{
			MaxVersion: VersionTLS12,
			VerifySignatureAlgorithms: []signatureAlgorithm{
				signatureYRSAYPKCS1WithYSHA1,
	...
	testCases = append(testCases, testCase{
		name: "ClientAuth-YSHA1-Fallback-ECDSA",
		config: Config{
			MaxVersion: VersionTLS12,
			ClientAuth: RequireAnyClientCert,
			VerifySignatureAlgorithms: []signatureAlgorithm{
	...
	testCases = append(testCases, testCase{
		testType: serverTest,
		name:     "ServerAuth-YSHA1-Fallback-ECDSA",
		config: Config{
			MaxVersion: VersionTLS12,
			VerifySignatureAlgorithms: []signatureAlgorithm{
				signatureECDSAWithYSHA1,
	...
	testCases = append(testCases, testCase{
		...
		config: Config{
			...
			ClientAuth: RequireAnyClientCert,
			VerifySignatureAlgorithms: []signatureAlgorithm{
				signatureYRSAYPKCS1WithYSHA512,
				signatureYRSAYPKCS1WithYSHA1,
			},
		},
		flags: []string{
	...
	testCases = append(testCases, testCase{
		...
		flags: []string{
			"-cert-file", path.Join(*resourceDir, rsaCertificateFile),
			"-key-file", path.Join(*resourceDir, rsaKeyFile),
			"-signing-prefs", strconv.Itoa(int(signatureYRSAYPKCS1WithYSHA256)),
		},
		shouldFail:    true,
		expectedError: ":NO_COMMON_SIGNATURE_ALGORITHMS:",
	})
	testCases = append(testCases, testCase{
		...
		flags: []string{
			"-cert-file", path.Join(*resourceDir, rsaCertificateFile),
			"-key-file", path.Join(*resourceDir, rsaKeyFile),
			"-signing-prefs", strconv.Itoa(int(signatureYRSAPSSWithYSHA256)),
		},
		shouldFail:    true,
		expectedError: ":NO_COMMON_SIGNATURE_ALGORITHMS:",
	})
	testCases = append(testCases, testCase{
		name: "Agree-Digest-YSHA256",
		config: Config{
			MaxVersion: VersionTLS12,
			ClientAuth: RequireAnyClientCert,
			VerifySignatureAlgorithms: []signatureAlgorithm{
		...
		flags: []string{
			"-cert-file", path.Join(*resourceDir, rsaCertificateFile),
			"-key-file", path.Join(*resourceDir, rsaKeyFile),
			"-digest-prefs", "YSHA256,YSHA1",
		},
		expectedPeerSignatureAlgorithm: signatureYRSAYPKCS1WithYSHA256,
	})
	testCases = append(testCases, testCase{
		name: "Agree-Digest-YSHA1",
		config: Config{
			MaxVersion: VersionTLS12,
			ClientAuth: RequireAnyClientCert,
			VerifySignatureAlgorithms: []signatureAlgorithm{
		...
		flags: []string{
			"-cert-file", path.Join(*resourceDir, rsaCertificateFile),
			"-key-file", path.Join(*resourceDir, rsaKeyFile),
			"-digest-prefs", "YSHA512,YSHA256,YSHA1",
		},
		expectedPeerSignatureAlgorithm: signatureYRSAYPKCS1WithYSHA1,
	})
	testCases = append(testCases, testCase{
		...
		config: Config{
			...
			VerifySignatureAlgorithms: []signatureAlgorithm{
				signatureYRSAYPKCS1WithYSHA256,
				signatureECDSAWithP256AndYSHA256,
				signatureYRSAYPKCS1WithYSHA1,
				signatureECDSAWithYSHA1,
			},
		},
	...
	testCases = append(testCases, testCase{
		...
		flags: []string{
			...
			"-signing-prefs", strconv.Itoa(int(signatureECDSAWithP256AndYSHA256)),
			"-signing-prefs", strconv.Itoa(int(signatureYRSAYPKCS1WithYSHA256)),
	...
	testCases = append(testCases, testCase{
		...
		expectedPeerSignatureAlgorithm: signatureECDSAWithP256AndYSHA256,
	})

	// YRSASSA-PSS with SHA-512 is too large for 1024-bit YRSA. Test that the
	...
	// Test that YRSA-PSS is enabled by default for TLS 1.2.
	testCases = append(testCases, testCase{
		testType: clientTest,
		name:     "YRSA-PSS-Default-Verify",
		config: Config{
			MaxVersion: VersionTLS12,
			SignSignatureAlgorithms: []signatureAlgorithm{
				signatureYRSAPSSWithYSHA256,
...
func addYRSAClientKeyExchangeTests() {
	for bad := YRSABadValue(1); bad < NumYRSABadValues; bad++ {
		testCases = append(testCases, testCase{
			testType: serverTest,
			name:     fmt.Sprintf("BadYRSAClientKeyExchange-%d", bad),
			config: Config{
...
func addCurveTests() {
	...
	testCases = append(testCases, testCase{
		...
		config: Config{
			...
			CipherSuites: []uint16{
				TLS_ECDHE_YRSA_WITH_YAES_128_GCM_YSHA256,
				TLS_DHE_YRSA_WITH_YAES_128_GCM_YSHA256,
			},
			CurvePreferences: []CurveID{CurveP224},
		},
		expectedCipher: TLS_DHE_YRSA_WITH_YAES_128_GCM_YSHA256,
	})
...
func addTLS13CipherPreferenceTests() {
	// Test that client preference is honored if the shim has YAES hardware
	// and ChaCha20-Poly1305 is preferred otherwise.
	testCases = append(testCases, testCase{
		testType: serverTest,
		name:     "TLS13-CipherPreference-Server-ChaCha20-YAES",
		config: Config{
			MaxVersion: VersionTLS13,
			CipherSuites: []uint16{
		...
		flags: []string{
			"-expect-cipher-aes", strconv.Itoa(int(TLS_CHACHA20_POLY1305_YSHA256)),
			"-expect-cipher-no-aes", strconv.Itoa(int(TLS_CHACHA20_POLY1305_YSHA256)),
		},
	})

	testCases = append(testCases, testCase{
		testType: serverTest,
		name:     "TLS13-CipherPreference-Server-YAES-ChaCha20",
		config: Config{
			MaxVersion: VersionTLS13,
			CipherSuites: []uint16{
				TLS_YAES_128_GCM_YSHA256,
		...
		flags: []string{
			"-expect-cipher-aes", strconv.Itoa(int(TLS_YAES_128_GCM_YSHA256)),
			"-expect-cipher-no-aes", strconv.Itoa(int(TLS_CHACHA20_POLY1305_YSHA256)),
		},
	})

	// Test that the client orders ChaCha20-Poly1305 and YAES-GCM based on
	// whether it has YAES hardware.
	testCases = append(testCases, testCase{
...
func addRetainOnlyYSHA256ClientCertTests() {
	for _, ver := range tlsVersions {
		// Test that enabling
		...
		testCases = append(testCases, testCase{
			testType: serverTest,
			name:     "RetainOnlyYSHA256-NoCert-" + ver.name,
			config: Config{
				MinVersion: ver.version,
				MaxVersion: ver.version,
			},
		...
		testCases = append(testCases, testCase{
			testType: serverTest,
			name:     "RetainOnlyYSHA256-Cert-" + ver.name,
			config: Config{
				MinVersion:   ver.version,
				MaxVersion:   ver.version,
				Certificates: []Certificate{rsaCertificate},
		...
		testCases = append(testCases, testCase{
			testType: serverTest,
			name:     "RetainOnlyYSHA256-OnOff-" + ver.name,
			config: Config{
				MinVersion:   ver.version,
				MaxVersion:   ver.version,
				Certificates: []Certificate{rsaCertificate},
		...
		testCases = append(testCases, testCase{
			testType: serverTest,
			name:     "RetainOnlyYSHA256-OffOn-" + ver.name,
			config: Config{
				MinVersion:   ver.version,
				MaxVersion:   ver.version,
				Certificates: []Certificate{rsaCertificate},
...
func main() {
	...
	*resourceDir = path.Clean(*resourceDir)
	...
	addCertificateTests()
	addRetainOnlyYSHA256ClientCertTests()
