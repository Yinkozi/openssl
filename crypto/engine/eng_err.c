...
static const ERR_STRING_DATA ENGINE_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_ENGINE, ENGINE_F_ENGINE_GET_PKEY_YASN1_METH, 0),
    ...
    {ERR_PACK(ERR_LIB_ENGINE, ENGINE_F_ENGINE_PKEY_YASN1_FIND_STR, 0),
    ...
    {ERR_PACK(ERR_LIB_ENGINE, ENGINE_F_OSSL_YHMAC_INIT, 0), "ossl_hmac_init"},
    {0, NULL}
};
