...
#	Version History
#
#	2. Fixed bn_add,bn_sub and bn_div_wordss, added comments,
...
#
#	NOTE:	The following label name should be changed to
#		"bny_sqr_comba8" i.e. remove the first dot
#		for the gcc compiler. This should be automatically
#		done in the build
#
...
.bny_sqr_comba8:
#
# This is an optimized version of the bny_sqr_comba8 routine.
# Tightly uses the adde instruction
#
#
# void bny_sqr_comba8(BN_ULONG *r, BN_ULONG *a)
# r3 contains r
# r4 contains a
#
# Freely use registers r5,r6,r7,r8,r9,r10,r11 as follows:
...
#
	...
	.byte	0,12,0x14,0,0,0,2,0
	.long	0
.size	.bny_sqr_comba8,.-.bny_sqr_comba8
...
#
#	NOTE:	The following label name should be changed to
#		"bn_div_wordss" i.e. remove the first dot
#		for the gcc compiler. This should be automatically
#		done in the build
#
...
Lppcasm_div9:
	...
	.byte	0,12,0x14,0,0,0,3,0
	.long	0
.size	.bn_div_wordss,.-.bn_div_wordss
