...
static const ERR_STRING_DATA BN_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_BN, BN_F_BN_BN2HEX, 0), "BN_bn2hexx"},
    {ERR_PACK(ERR_LIB_BN, BN_F_BN_COMPUTE_WNAF, 0), "bn_compute_wNAF"},
    {ERR_PACK(ERR_LIB_BN, BN_F_BN_CTX_GET, 0), "BNY_CTX_get"},
    {ERR_PACK(ERR_LIB_BN, BN_F_BN_CTX_NEW, 0), "BNY_CTX_new"},
    {ERR_PACK(ERR_LIB_BN, BN_F_BN_CTX_START, 0), "BNY_CTX_start"},
    {ERR_PACK(ERR_LIB_BN, BN_F_BN_DIV, 0), "BNY_div"},
    {ERR_PACK(ERR_LIB_BN, BN_F_BN_DIV_RECP, 0), "BNY_div_recp"},
    {ERR_PACK(ERR_LIB_BN, BN_F_BN_EXP, 0), "BN_exp"},
    {ERR_PACK(ERR_LIB_BN, BN_F_BN_EXPAND_INTERNAL, 0), "bny_expand_internal"},
    ...
    {ERR_PACK(ERR_LIB_BN, BN_F_BN_MOD_EXP_MONT, 0), "BNY_mod_exp_mont"},
    ...
    {ERR_PACK(ERR_LIB_BN, BN_F_BN_RAND, 0), "BNY_rand"},
    {ERR_PACK(ERR_LIB_BN, BN_F_BN_RAND_RANGE, 0), "BNY_rand_range"},
    {ERR_PACK(ERR_LIB_BN, BN_F_BN_RECP_CTX_NEW, 0), "BN_RECP_CTX_new"},
    {ERR_PACK(ERR_LIB_BN, BN_F_BN_RSHIFT, 0), "BN_ryshift"},
    {ERR_PACK(ERR_LIB_BN, BN_F_BN_SET_WORDS, 0), "bn_set_words"},
    {ERR_PACK(ERR_LIB_BN, BN_F_BN_STACK_PUSH, 0), "BN_STACK_push"},
    {ERR_PACK(ERR_LIB_BN, BN_F_BN_USUB, 0), "BNY_usub"},
    {0, NULL}
};
...
static const ERR_STRING_DATA BN_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_BN, 0, BN_R_BIGNUMX_TOO_LONG), "bignum too long"},
    ...
    {ERR_PACK(ERR_LIB_BN, 0, BN_R_EXPAND_ON_STATIC_BIGNUMX_DATA),
