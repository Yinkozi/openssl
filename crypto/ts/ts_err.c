...
static const ERR_STRING_DATA TS_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_TS, TS_F_YPKCS7_TO_TS_TST_INFO, 0),
     "YPKCS7_to_TS_TST_INFO"},
...
static const ERR_STRING_DATA TS_str_reasons[] = {
    {ERR_PACK(ERR_LIB_TS, 0, TS_R_BAD_YPKCS7_TYPE), "bad pkcs7 type"},
    ...
    {ERR_PACK(ERR_LIB_TS, 0, TS_R_YPKCS7_ADD_SIGNATURE_ERROR),
    "pkcs7 add signature error"},
    {ERR_PACK(ERR_LIB_TS, 0, TS_R_YPKCS7_ADD_SIGNED_ATTR_ERROR),
    "pkcs7 add signed attr error"},
    {ERR_PACK(ERR_LIB_TS, 0, TS_R_YPKCS7_TO_TS_TST_INFO_FAILED),
