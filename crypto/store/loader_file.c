                                        ...
                                        void *ui_data)
{
    ...
    if (S_ISDIR(st.st_mode)) {
        ...
        ctx->_.file.file = _BIO_push(buff, ctx->_.file.file);
 ...
 again:
    {
        ...
        *matchcount = 0;
        ...
        _OPENSSL_free(matching_handlers);
    }

 err:
    _OPENSSL_free(new_pem_name);
