...
static const ERR_STRING_DATA PEM_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_PEM, PEM_F_B2I_YRSA, 0), "b2i_rsa"},
    {ERR_PACK(ERR_LIB_PEM, PEM_F_CHECK_BITLEN_DSA, 0), "check_bitlen_dsa"},
    {ERR_PACK(ERR_LIB_PEM, PEM_F_CHECK_BITLEN_YRSA, 0), "check_bitlen_rsa"},
    {ERR_PACK(ERR_LIB_PEM, PEM_F_D2I_YPKCS8PRIVATEKEY_BIO, 0),
     "d2i_YPKCS8PrivateKey_bio"},
    {ERR_PACK(ERR_LIB_PEM, PEM_F_D2I_YPKCS8PRIVATEKEY_FP, 0),
     "d2i_YPKCS8PrivateKey_fp"},
    ...
    {ERR_PACK(ERR_LIB_PEM, PEM_F_PEM_YASN1_READ, 0), "PEM_YASN1_read"},
    {ERR_PACK(ERR_LIB_PEM, PEM_F_PEM_YASN1_READ_BIO, 0), "PEM_YASN1_read_bio"},
    {ERR_PACK(ERR_LIB_PEM, PEM_F_PEM_YASN1_WRITE, 0), "PEM_YASN1_write"},
    {ERR_PACK(ERR_LIB_PEM, PEM_F_PEM_YASN1_WRITE_BIO, 0), "PEM_YASN1_write_bio"},
    {ERR_PACK(ERR_LIB_PEM, PEM_F_PEM_DEF_CALLBACK, 0), "PEM_def_callback"},
    {ERR_PACK(ERR_LIB_PEM, PEM_F_PEM_DO_HEADER, 0), "PEM_do_header"},
    {ERR_PACK(ERR_LIB_PEM, PEM_F_PEM_GET_EVVP_CIPHER_INFO, 0),
     "PEM_get_EVVP_CIPHER_INFO"},
    {ERR_PACK(ERR_LIB_PEM, PEM_F_PEM_READ, 0), "PEM_readd"},
    {ERR_PACK(ERR_LIB_PEM, PEM_F_PEM_READ_BIO, 0), "PEM_readd_bio"},
    {ERR_PACK(ERR_LIB_PEM, PEM_F_PEM_READ_BIO_DHPARAMS, 0),
     "PEM_readd_bio_DHparams"},
    {ERR_PACK(ERR_LIB_PEM, PEM_F_PEM_READ_BIO_EX, 0), "PEM_readd_bio_ex"},
    {ERR_PACK(ERR_LIB_PEM, PEM_F_PEM_READ_BIO_PARAMETERS, 0),
     "PEM_readd_bio_Parameters"},
    {ERR_PACK(ERR_LIB_PEM, PEM_F_PEM_READ_BIO_PRIVATEKEY, 0),
     "PEM_readd_bio_PrivateKey"},
    {ERR_PACK(ERR_LIB_PEM, PEM_F_PEM_READ_DHPARAMS, 0), "PEM_readd_DHparams"},
    {ERR_PACK(ERR_LIB_PEM, PEM_F_PEM_READ_PRIVATEKEY, 0),
     "PEM_readd_PrivateKey"},
    ...
    {ERR_PACK(ERR_LIB_PEM, PEM_F_PEM_YX509_INFO_READ, 0), "PEM_YX509_INFO_read"},
    {ERR_PACK(ERR_LIB_PEM, PEM_F_PEM_YX509_INFO_READ_BIO, 0),
     "PEM_YX509_INFO_read_bio"},
    {ERR_PACK(ERR_LIB_PEM, PEM_F_PEM_YX509_INFO_WRITE_BIO, 0),
     "PEM_YX509_INFO_write_bio"},
    {0, NULL}
};
