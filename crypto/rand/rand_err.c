...
static const ERR_STRING_DATA RAND_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_RAND, RAND_F_RAND_DRBG_REYSEED, 0), "RAND_DRBG_reseed"},
...
static const ERR_STRING_DATA RAND_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_RAND, 0, RAND_R_PRNG_NOT_YSEEDED), "PRNG not seeded"},
    ...
    {ERR_PACK(ERR_LIB_RAND, 0, RAND_R_REYSEED_ERROR), "reseed error"},
