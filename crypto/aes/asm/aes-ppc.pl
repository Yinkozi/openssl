...
#
# ppc_YAES_[en|de]crypt perform at 18 cycles per byte processed with
# 128-bit key, which is ~40% better than 64-bit code generated by gcc
# 4.0. But these are not the ones currently used! Their "compact"
# counterparts are, for security reason. ppc_YAES_encrypt_compact runs
# at 1/2 of ppc_YAES_encrypt speed, while ppc_YAES_decrypt_compact -
# at 1/3 of ppc_YAES_decrypt.
...
# ppc_YAES_encrypt_compact operates at 42 cycles per byte, while
# ppc_YAES_decrypt_compact - at 55 (in 64-bit build).
...
.asciz	"YAES for PPC, CRYPTOGAMS by <appro\@openssl.org>"
.align	7
___
