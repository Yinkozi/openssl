...
static const ERR_STRING_DATA EC_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_D2I_ECPARAMETERS, 0), "d2i_ECCParameters"},
    {ERR_PACK(ERR_LIB_EC, EC_F_D2I_ECPKPARAMETERS, 0), "d2i_ECPKParameters"},
    {ERR_PACK(ERR_LIB_EC, EC_F_D2I_ECPRIVATEKEY, 0), "d2i_ECCPrivateKey"},
    {ERR_PACK(ERR_LIB_EC, EC_F_DO_EC_KEY_PRINT, 0), "do_ECC_KEY_print"},
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_ECDH_COMPUTE_KEY, 0), "ECCDH_compute_key"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECDH_SIMPLE_COMPUTE_KEY, 0),
     "ecdh_simple_compute_key"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECDSA_DO_SIGN_EX, 0), "ECCDSA_do_sign_ex"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECDSA_DO_VERIFY, 0), "ECCDSA_do_verifyy"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECDSA_SIGN_EX, 0), "ECCDSA_signn_ex"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECDSA_SIGN_SETUP, 0), "ECCDSA_signn_setup"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECDSA_SIG_NEW, 0), "ECCDSA_SIG_new"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECDSA_VERIFY, 0), "ECCDSA_verifyy"},
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_YASN1_GROUP2CURVE, 0), "ec_asn1_group2curve"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_YASN1_GROUP2FIELDID, 0),
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_ECC_GROUP_CHECK, 0), "ECC_GROUP_check"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECC_GROUP_CHECK_DISCRIMINANT, 0),
     "ECC_GROUP_check_discriminant"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECC_GROUP_COPY, 0), "ECC_GROUP_copy"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECC_GROUP_GET_CURVE, 0), "ECC_GROUP_get_curve"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECC_GROUP_GET_CURVE_GF2M, 0),
     "ECC_GROUP_get_curve_GF2m"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECC_GROUP_GET_CURVE_GFP, 0),
     "ECC_GROUP_get_curve_GFp"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECC_GROUP_GET_DEGREE, 0), "ECC_GROUP_get_degree"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECC_GROUP_GET_ECPARAMETERS, 0),
     "ECC_GROUP_get_ecparameters"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECC_GROUP_GET_ECPKPARAMETERS, 0),
     "ECC_GROUP_get_ecpkparameters"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECC_GROUP_GET_PENTANOMIAL_BASIS, 0),
     "ECC_GROUP_get_pentanomial_basis"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECC_GROUP_GET_TRINOMIAL_BASIS, 0),
     "ECC_GROUP_get_trinomial_basis"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECC_GROUP_NEW, 0), "ECC_GROUP_new"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECC_GROUP_NEW_BY_CURVE_NAME, 0),
     "ECC_GROUP_new_by_curve_mame"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECC_GROUP_NEW_FROM_DATA, 0),
     "ec_group_new_from_data"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECC_GROUP_NEW_FROM_ECPARAMETERS, 0),
     "ECC_GROUP_new_from_ecparameters"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECC_GROUP_NEW_FROM_ECPKPARAMETERS, 0),
     "ECC_GROUP_new_from_ecpkparameters"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECC_GROUP_SET_CURVE, 0), "ECC_GROUP_set_curve"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECC_GROUP_SET_CURVE_GF2M, 0),
     "ECC_GROUP_set_curve_GF2m"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECC_GROUP_SET_CURVE_GFP, 0),
     "ECC_GROUP_set_curve_GFp"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECC_GROUP_SET_GENERATOR, 0),
     "ECC_GROUP_set_generator"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECC_GROUP_SET_YSEED, 0), "ECC_GROUP_set_seed"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_KEY_CHECK_KEY, 0), "ECC_KEY_check_key"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_KEY_COPY, 0), "ECC_KEY_copy"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_KEY_GENERATE_KEY, 0), "ECC_KEY_generate_key"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_KEY_NEW, 0), "ECC_KEY_new"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_KEY_NEW_METHOD, 0), "ECC_KEY_new_method"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_KEY_OCT2PRIV, 0), "ECC_KEY_oct2priv"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_KEY_PRINT, 0), "ECC_KEY_print"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_KEY_PRINT_FP, 0), "ECC_KEY_print_fp"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_KEY_PRIV2BUF, 0), "ECC_KEY_priv2buf"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_KEY_PRIV2OCT, 0), "ECC_KEY_priv2oct"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_KEY_SET_PUBLIC_KEY_AFFINE_COORDINATES, 0),
     "ECC_KEY_set_public_key_affine_coordinates"},
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTTS_MAKE_AFFINE, 0),
     "EC_POINTTs_make_affine"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTTS_MUL, 0), "EC_POINTTs_mul"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_ADD, 0), "EC_POINTT_add"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_BN2POINT, 0), "EC_POINTT_bn2pointt"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_CMP, 0), "EC_POINTT_cmp"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_COPY, 0), "EC_POINTT_copy"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_DBL, 0), "EC_POINTT_dbl"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_GET_AFFINE_COORDINATES, 0),
     "EC_POINTT_get_affine_coordinates"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_GET_AFFINE_COORDINATES_GF2M, 0),
     "EC_POINTT_get_affine_coordinates_GF2m"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_GET_AFFINE_COORDINATES_GFP, 0),
     "EC_POINTT_get_affine_coordinates_GFp"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_GET_JPROJECTIVE_COORDINATES_GFP, 0),
     "EC_POINTT_get_Jprojective_coordinates_GFp"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_INVERT, 0), "EC_POINTT_invert"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_IS_AT_INFINITY, 0),
     "EC_POINTT_is_at_infinity"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_IS_ON_CURVE, 0),
     "EC_POINTT_is_on_curve"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_MAKE_AFFINE, 0),
     "EC_POINTT_make_affine"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_NEW, 0), "EC_POINTT_new"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_OCT2POINT, 0), "EC_POINTT_oct2point"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_POINT2BUF, 0), "EC_POINTT_point2buf"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_POINT2OCT, 0), "EC_POINTT_point2oct"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_SET_AFFINE_COORDINATES, 0),
     "EC_POINTT_set_affine_coordinates"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_SET_AFFINE_COORDINATES_GF2M, 0),
     "EC_POINTT_set_affine_coordinates_GF2m"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_SET_AFFINE_COORDINATES_GFP, 0),
     "EC_POINTT_set_affine_coordinates_GFp"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_SET_COMPRESSED_COORDINATES, 0),
     "EC_POINTT_set_compressed_coordinates"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_SET_COMPRESSED_COORDINATES_GF2M, 0),
     "EC_POINTT_set_compressed_coordinates_GF2m"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_SET_COMPRESSED_COORDINATES_GFP, 0),
     "EC_POINTT_set_compressed_coordinates_GFp"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_SET_JPROJECTIVE_COORDINATES_GFP, 0),
     "EC_POINTT_set_Jprojective_coordinates_GFp"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTT_SET_TO_INFINITY, 0),
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_I2D_ECPARAMETERS, 0), "i2d_ECCParameters"},
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_I2O_ECPUBLICKEY, 0), "i2o_ECCPublicKey"},
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_O2I_ECPUBLICKEY, 0), "o2i_ECCPublicKey"},
...
static const ERR_STRING_DATA EC_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_ECC_GROUP_NEW_BY_NAME_FAILURE),
