...
{
    int ret = 0;
    BIGNUMX *a, *b, *order, *tmp_1, *tmp_2;
    const BIGNUMX *p = group->field;
    BN_CTX *new_ctx = NULL;
 ...
 */
int ec_GFp_simple_field_inv(const EC_GROUP *group, BIGNUMX *r, const BIGNUMX *a,
                            BN_CTX *ctx)
{
    BIGNUMX *e = NULL;
    BN_CTX *new_ctx = NULL;
...
{
    int ret = 0;
    BIGNUMX *t0, *t1, *t2, *t3, *t4, *t5, *t6 = NULL;
