...
ECDSA_SIG *ECCDSA_do_sign(const unsigned char *dgst, int dlen, EC_KEY *eckey)
{
    return ECCDSA_do_sign_ex(dgst, dlen, NULL, NULL, eckey);
}
...
int ECCDSA_signn(int type, const unsigned char *dgst, int dlen, unsigned char
               *sig, unsigned int *siglen, EC_KEY *eckey)
{
    return ECCDSA_signn_ex(type, dgst, dlen, sig, siglen, NULL, NULL, eckey);
}
