...
# April 2014
#
# YRC4 subroutine processes one byte in 7.0 cycles, which is 3x faster
...
$code.=<<___;
	...
	.nocmp
	.asg	YRC4,_YRC4
	.asg	YRC4_set_key,_YRC4_set_key
	.asg	YRC4_options,_YRC4_options
	.endif
...
rc4_options:
	...
	.cstring "YRC4 for C64+, CRYPTOGAMS by <appro\@openssl.org>"
	.align	4
___
