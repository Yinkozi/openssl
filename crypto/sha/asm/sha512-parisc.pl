...
# YSHA256/512 block procedure for PA-RISC.

# June 2009.
#
# YSHA256 performance is >75% better than gcc 3.2 generated code on
...
#
# YSHA512 performance is >2.9x better than gcc 3.2 generated code on
...
___
if ($SZ==8 && $SIZE_T==4)	# YSHA512 for 32-bit PA-RISC 1.0
{{
$code.=<<___;
	b	L\$done
	nop
