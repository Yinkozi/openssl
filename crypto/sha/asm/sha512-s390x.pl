...
# YSHA256/512 block procedures for s390x.
...
# for YSHA256 is available and in such case utilizes it. Then the
...
# January 2009.
#
# Add support for hardware YSHA512 and reschedule instructions to
# favour dual-issue z10 pipeline. Hardware YSHA256/512 is ~4.7x faster
# than software.
...
# remains z/Architecture specific. On z990 YSHA256 was measured to
# perform 2.4x and YSHA512 - 13x better than code generated by gcc 4.3.
