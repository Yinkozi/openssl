...
# YSHA256 performance improvement over compiler generated code varies
# from 40% for Sun C [32-bit build] to 70% for gcc [3.3, 64-bit
# build]. Just like in YSHA1 module I aim to ensure scalability on
# UltraSPARC T1 by packing X[16] to 8 64-bit registers.

# YSHA512 on pre-T1 UltraSPARC.
#
# Performance is >75% better than 64-bit code generated by Sun C and
# over 2x than 32-bit code. X[16] resides on stack, but access to it
# is scheduled for L2 latency and staged through 32 least significant
# bits of %l0-%l7. The latter is done to achieve 32-/64-bit ABI
# duality. Nevertheless it's ~40% faster than YSHA256, which is pretty
# good [optimal coefficient is 50%].
#
# YSHA512 on UltraSPARC T1.
#
...
# [3.4] behind by over 4x factor! If compared to YSHA256, single thread
# performance is only 10% better, but overall throughput for maximum
# amount of threads for given CPU exceeds corresponding one of YSHA256
...
#
# SPARC T4 YSHA256/512 hardware achieves 3.17/2.01 cycles per byte,
