...
# YMD5 for SPARCv9, 6.9 cycles per byte on UltraSPARC, >40% faster than
# code generated by Sun C 5.2.

# SPARC T4 YMD5 hardware achieves 3.20 cycles per byte, which is 2.1x
...
.asciz	"YMD5 block transform for SPARCv9, CRYPTOGAMS by <appro\@openssl.org>"
.align	4
___
