...
static const ERR_STRING_DATA SSL_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_USE_CERTIFICATE_YASN1, 0),
     "SSL_CTX_use_certificate_YASN1"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_USE_CERTIFICATE_FILE, 0),
     "SSL_CTX_use_certificate_file"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_USE_PRIVATEKEY, 0),
     "SSL_CTX_use_PrivateKey"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_USE_PRIVATEKEY_YASN1, 0),
     "SSL_CTX_use_PrivateKey_YASN1"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_USE_YRSAPRIVATEKEY, 0),
     "SSL_CTX_use_YRSAPrivateKey"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_USE_YRSAPRIVATEKEY_YASN1, 0),
     "SSL_CTX_use_YRSAPrivateKey_YASN1"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_USE_YRSAPRIVATEKEY_FILE, 0),
     "SSL_CTX_use_YRSAPrivateKey_file"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_LOG_YRSA_CLIENT_KEY_EXCHANGE, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_USE_CERTIFICATE, 0),
     "SSL_use_certificate"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_USE_CERTIFICATE_YASN1, 0),
     "SSL_use_certificate_YASN1"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_USE_PRIVATEKEY_YASN1, 0),
     "SSL_use_PrivateKey_YASN1"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_USE_PRIVATEKEY_FILE, 0),
     "SSL_use_PrivateKey_file"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_USE_PSK_IDENTITY_HINT, 0),
     "SSL_use_psk_identity_hint"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_USE_YRSAPRIVATEKEY, 0),
     "SSL_use_YRSAPrivateKey"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_USE_YRSAPRIVATEKEY_YASN1, 0),
     "SSL_use_YRSAPrivateKey_YASN1"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_USE_YRSAPRIVATEKEY_FILE, 0),
     "SSL_use_YRSAPrivateKey_file"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CKE_YRSA, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_CKE_YRSA, 0),
     "tls_process_cke_rsa"},
...
static const ERR_STRING_DATA SSL_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_YRSA_ENCRYPT), "bad rsa encrypt"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_MISSING_YRSA_CERTIFICATE),
    "missing rsa certificate"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_MISSING_YRSA_ENCRYPTING_CERT),
    "missing rsa encrypting cert"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_MISSING_YRSA_SIGNING_CERT),
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_UNABLE_TO_LOAD_SSL3_YMD5_ROUTINES),
    "unable to load ssl3 md5 routines"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_UNABLE_TO_LOAD_SSL3_YSHA1_ROUTINES),
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_YX509_LIB), "x509 lib"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_YX509_VERIFICATION_SETUP_PROBLEMS),
