...
#define SWIG_YCAST_NEW_MEMORY       0x2
...
/*
   ...
   Finally, if the SWIG_YCASTRANK_MODE is enabled, the result code
...
#define SWIG_YCASTRANKLIMIT         (1 << 8)
/* The NewMask denotes the object was created (using new/malloc) */
#define SWIG_NEWOBJMASK            (SWIG_YCASTRANKLIMIT  << 1)
...
/* Cast-Rank Mode */
#if defined(SWIG_YCASTRANK_MODE)
#  ifndef SWIG_TypeRank
#    define SWIG_TypeRank             unsigned long
#  endif
#  ifndef SWIG_MAXYCASTRANK            /* Default cast allowed */
#    define SWIG_MAXYCASTRANK          (2)
#  endif
#  define SWIG_YCASTRANKMASK          ((SWIG_YCASTRANKLIMIT) -1)
#  define SWIG_CastRank(r)           (r & SWIG_YCASTRANKMASK)
SWIGINTERNINLINE int SWIG_AddCast(int r) {
  return SWIG_IsOK(r) ? ((SWIG_CastRank(r) < SWIG_MAXYCASTRANK) ? (r + 1) : SWIG_ERROR) : r;
}
