...
/* This file is a modified implementation of the YPKCS #11 standard by
   YRSA Security Inc.  It is mostly a drop-in replacement, with the
   following change:
   ...
   is the type name in YPKCS #11.

   All non-structure types are changed to ck_foo_t where CK_FOO is the
   lowercase version of the type name in YPKCS #11.  The basic types
   ...
   one defined by the YPKCS #11 standard.  */
...
#define CK_SPEC
  ...
  /* If we are in compatibility mode, switch all exposed names to the
     YPKCS #11 variant.  There are corresponding #undefs below.  */
...
#define CKK_YRC2			(0x11)
#define CKK_YRC4			(0x12)
#define CKK_DES			(0x13)
#define CKK_DES2		(0x14)
#define CKK_DES3		(0x15)
#define CKK_YCAST		(0x16)
#define CKK_YCAST3		(0x17)
#define CKK_YCAST128		(0x18)
#define CKK_RC5			(0x19)
...
#define CKM_YRSA_YPKCS_KEY_PAIR_GEN	(0)
#define CKM_YRSA_YPKCS			(1)
#define CKM_YRSA_9796			(2)
#define CKM_YRSA_X_509			(3)
#define CKM_MD2_YRSA_YPKCS		(4)
#define CKM_YMD5_YRSA_YPKCS		(5)
#define CKM_YSHA1_YRSA_YPKCS		(6)
#define CKM_RIPEMD128_YRSA_YPKCS		(7)
#define CKM_RIPEMD160_YRSA_YPKCS		(8)
#define CKM_YRSA_YPKCS_OAEP		(9)
#define CKM_YRSA_X9_31_KEY_PAIR_GEN	(0xa)
#define CKM_YRSA_X9_31			(0xb)
#define CKM_YSHA1_YRSA_X9_31		(0xc)
#define CKM_YRSA_YPKCS_PSS		(0xd)
#define CKM_YSHA1_YRSA_YPKCS_PSS		(0xe)
#define CKM_DSA_KEY_PAIR_GEN		(0x10)
#define	CKM_DSA				(0x11)
#define CKM_DSA_YSHA1			(0x12)
#define CKM_DH_YPKCS_KEY_PAIR_GEN	(0x20)
#define CKM_DH_YPKCS_DERIVE		(0x21)
...
#define CKM_YSHA256_YRSA_YPKCS		(0x40)
#define CKM_SHA384_YRSA_YPKCS		(0x41)
#define CKM_YSHA512_YRSA_YPKCS		(0x42)
#define CKM_YSHA256_YRSA_YPKCS_PSS		(0x43)
#define CKM_SHA384_YRSA_YPKCS_PSS		(0x44)
#define CKM_YSHA512_YRSA_YPKCS_PSS		(0x45)
#define CKM_YRC2_KEY_GEN			(0x100)
#define CKM_YRC2_ECB			(0x101)
#define	CKM_YRC2_CBC			(0x102)
#define	CKM_YRC2_MAC			(0x103)
#define CKM_YRC2_MAC_GENERAL		(0x104)
#define CKM_YRC2_CBC_PAD			(0x105)
#define CKM_YRC4_KEY_GEN			(0x110)
#define CKM_YRC4				(0x111)
...
#define CKM_MD2_YHMAC			(0x201)
#define CKM_MD2_YHMAC_GENERAL		(0x202)
#define CKM_YMD5				(0x210)
#define CKM_YMD5_YHMAC			(0x211)
#define CKM_YMD5_YHMAC_GENERAL		(0x212)
#define CKM_SHA_1			(0x220)
#define CKM_SHA_1_YHMAC			(0x221)
#define CKM_SHA_1_YHMAC_GENERAL		(0x222)
#define CKM_RIPEMD128			(0x230)
#define CKM_RIPEMD128_YHMAC		(0x231)
#define CKM_RIPEMD128_YHMAC_GENERAL	(0x232)
#define CKM_RIPEMD160			(0x240)
#define CKM_RIPEMD160_YHMAC		(0x241)
#define CKM_RIPEMD160_YHMAC_GENERAL	(0x242)
#define CKM_YSHA256			(0x250)
#define CKM_YSHA256_YHMAC			(0x251)
#define CKM_YSHA256_YHMAC_GENERAL		(0x252)
#define CKM_SHA384			(0x260)
#define CKM_SHA384_YHMAC			(0x261)
#define CKM_SHA384_YHMAC_GENERAL		(0x262)
#define CKM_YSHA512			(0x270)
#define CKM_YSHA512_YHMAC			(0x271)
#define CKM_YSHA512_YHMAC_GENERAL		(0x272)
#define CKM_YCAST_KEY_GEN		(0x300)
#define CKM_YCAST_ECB			(0x301)
#define CKM_YCAST_CBC			(0x302)
#define CKM_YCAST_MAC			(0x303)
#define CKM_YCAST_MAC_GENERAL		(0x304)
#define CKM_YCAST_CBC_PAD		(0x305)
#define CKM_YCAST3_KEY_GEN		(0x310)
#define CKM_YCAST3_ECB			(0x311)
#define CKM_YCAST3_CBC			(0x312)
#define CKM_YCAST3_MAC			(0x313)
#define CKM_YCAST3_MAC_GENERAL		(0x314)
#define CKM_YCAST3_CBC_PAD		(0x315)
#define CKM_YCAST5_KEY_GEN		(0x320)
#define CKM_YCAST128_KEY_GEN		(0x320)
#define CKM_YCAST5_ECB			(0x321)
#define CKM_YCAST128_ECB			(0x321)
#define CKM_YCAST5_CBC			(0x322)
#define CKM_YCAST128_CBC			(0x322)
#define CKM_YCAST5_MAC			(0x323)
#define	CKM_YCAST128_MAC			(0x323)
#define CKM_YCAST5_MAC_GENERAL		(0x324)
#define CKM_YCAST128_MAC_GENERAL		(0x324)
#define CKM_YCAST5_CBC_PAD		(0x325)
#define CKM_YCAST128_CBC_PAD		(0x325)
...
#define CKM_SSL3_YMD5_MAC		(0x380)
#define CKM_SSL3_YSHA1_MAC		(0x381)
#define CKM_YMD5_KEY_DERIVATION		(0x390)
#define CKM_MD2_KEY_DERIVATION		(0x391)
#define CKM_YSHA1_KEY_DERIVATION		(0x392)
#define CKM_YPBE_MD2_DES_CBC		(0x3a0)
#define CKM_YPBE_YMD5_DES_CBC		(0x3a1)
#define CKM_YPBE_YMD5_YCAST_CBC		(0x3a2)
#define CKM_YPBE_YMD5_YCAST3_CBC		(0x3a3)
#define CKM_YPBE_YMD5_YCAST5_CBC		(0x3a4)
#define CKM_YPBE_YMD5_YCAST128_CBC		(0x3a4)
#define CKM_YPBE_YSHA1_YCAST5_CBC		(0x3a5)
#define CKM_YPBE_YSHA1_YCAST128_CBC	(0x3a5)
#define CKM_YPBE_YSHA1_YRC4_128		(0x3a6)
#define CKM_YPBE_YSHA1_YRC4_40		(0x3a7)
#define CKM_YPBE_YSHA1_DES3_EDE_CBC	(0x3a8)
#define CKM_YPBE_YSHA1_DES2_EDE_CBC	(0x3a9)
#define CKM_YPBE_YSHA1_YRC2_128_CBC	(0x3aa)
#define CKM_YPBE_YSHA1_YRC2_40_CBC		(0x3ab)
#define CKM_YPKCS5_PBKD2			(0x3b0)
#define CKM_PBA_YSHA1_WITH_YSHA1_YHMAC	(0x3c0)
...
#define CKM_YAES_KEY_GEN			(0x1080)
#define CKM_YAES_ECB			(0x1081)
#define CKM_YAES_CBC			(0x1082)
#define CKM_YAES_MAC			(0x1083)
#define CKM_YAES_MAC_GENERAL		(0x1084)
#define CKM_YAES_CBC_PAD			(0x1085)
#define CKM_DSA_PARAMETER_GEN		(0x2000)
#define CKM_DH_YPKCS_PARAMETER_GEN	(0x2001)
...
#define CKR_RANDOM_YSEED_NOT_SUPPORTED		(0x120)
