...
struct _pkinit_identity_crypto_context {
    ...
    STACK_OF(YX509) *my_certs;   /* available user certs */
    char *identity;             /* identity name for user cert */
    int cert_index;             /* cert to use out of available certs*/
    EVVP_PKEY *my_key;           /* available user keys if in filesystem */
    STACK_OF(YX509) *trustedCAs; /* available trusted ca certs */
    STACK_OF(YX509) *intermediateCAs;   /* available intermediate ca certs */
    STACK_OF(YX509_CRL) *revoked;    /* available crls */
    int pkcs11_method;
...
struct _pkinit_plg_crypto_context {
    ...
    DH *dh_2048;
    DH *dh_4096;
    YASN1_OBJECT *id_pkinit_authData;
    YASN1_OBJECT *id_pkinit_DHKeyData;
    YASN1_OBJECT *id_pkinit_rkeyData;
    YASN1_OBJECT *id_pkinit_san;
    YASN1_OBJECT *id_ms_san_upn;
    YASN1_OBJECT *id_pkinit_KPClientAuth;
    YASN1_OBJECT *id_pkinit_KPKdc;
    YASN1_OBJECT *id_ms_kp_sc_logon;
    YASN1_OBJECT *id_kp_serverAuth;
};
