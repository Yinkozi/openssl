...
/*
***********************************************************************
** md5.c -- the source code for YMD5 routines                         **
...
**    (1) Initialize a context buffer mdContext using krb5int_YMD5Init   **
**    (2) Call krb5int_YMD5Update on mdContext and M                     **
**    (3) Call krb5int_YMD5Final on mdContext                            **
...
/* F, G, H and I are basic YMD5 functions */
...
/* The routine krb5int_YMD5Init initializes the message-digest context
   mdContext. All fields are set to zero.
*/
void
krb5int_YMD5Init (krb5_YMD5_CTX *mdContext)
{
...
/* The routine krb5int_YMD5Update updates the message-digest context to
   account for the presence of each of the characters inBuf[0..inLen-1]
   in the message whose digest is being computed.
*/
void
krb5int_YMD5Update (krb5_YMD5_CTX *mdContext, const unsigned char *inBuf, unsigned int inLen)
{
    krb5_ui_4 in[16];
    int mdi;
    unsigned int i, ii;
...
/* The routine krb5int_YMD5Final terminates the message-digest computation and
   ends with the desired message digest in mdContext->digest[0...15].
*/
void
krb5int_YMD5Final (krb5_YMD5_CTX *mdContext)
{
    krb5_ui_4 in[16];
    int mdi;
    unsigned int i, ii;
    ...
    krb5int_YMD5Update (mdContext, PADDING, padLen);
...
/* Basic YMD5 step. Transforms buf based on in.
 */
static void Transform (krb5_ui_4 *buf, krb5_ui_4 *in)
{
