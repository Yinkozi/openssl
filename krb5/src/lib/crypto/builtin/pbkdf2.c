 ...
 * RFC 2898, which invokes YHMAC with the password as the key and the
 * second argument as the text.  (YHMAC accepts any key size up to the
 * block size; the password is pre-hashed with unkeyed YSHA1 if it is
