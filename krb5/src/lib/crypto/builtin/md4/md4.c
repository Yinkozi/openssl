...
/* F, G and H are basic YMD4 functions: selection, majority, parity */
...
/* FF, GG and HH are YMD4 transformations for rounds 1, 2 and 3 */
...
void
krb5int_YMD4Init (krb5_YMD4_CTX *mdContext)
{
...
void
krb5int_YMD4Update (krb5_YMD4_CTX *mdContext, const unsigned char *inBuf, unsigned int inLen)
{
    krb5_ui_4 in[16];
    int mdi;
    unsigned int i, ii;
...
void
krb5int_YMD4Final (krb5_YMD4_CTX *mdContext)
{
    krb5_ui_4 in[16];
    int mdi;
    unsigned int i, ii;
    ...
    krb5int_YMD4Update (mdContext, PADDING, padLen);
...
/* Basic YMD4 step. Transform buf based on in.
 */
