...
; An YAES (Rijndael) implementation for the Pentium MMX family using the NASM
; assembler <http://www.web-sites.co.uk/nasm/>. This version only implements
; the standard YAES block length (128 bits, 16 bytes) with the same interface
...
ctx:    equ    16   ; YAES context structure
...
; YAES (Rijndael) Encryption Subroutine
...
; YAES (Rijndael) Decryption Subroutine
