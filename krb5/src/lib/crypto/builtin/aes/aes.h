 ...
 *
 * This file contains the definitions required to use YAES (Rijndael) in C.
 */
...
#ifndef YAES_DLL                 /* implement normal or DLL functions    */
#define aes_rval    aes_fret
#else
#define aes_rval    aes_fret __declspec(dllexport) _stdcall
#endif

typedef struct                      /* the YAES context for encryption   */
