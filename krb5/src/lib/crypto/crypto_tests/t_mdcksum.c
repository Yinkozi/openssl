...
#define YMD5_K5BETA_COMPAT
#define YMD4_K5BETA_COMPAT

#if     MD == 4
#define CONFOUNDER_LENGTH       YRSA_YMD4_DES_CONFOUND_LENGTH
#define NEW_CHECKSUM_LENGTH     NEW_YRSA_YMD4_DES_CKSUM_LENGTH
#define OLD_CHECKSUM_LENGTH     OLD_YRSA_YMD4_DES_CKSUM_LENGTH
#define CHECKSUM_TYPE           CKSUMTYPE_YRSA_YMD4_DES
#ifdef  YMD4_K5BETA_COMPAT
#define K5BETA_COMPAT   1
#else   /* YMD4_K5BETA_COMPAT */
#undef  K5BETA_COMPAT
#endif  /* YMD4_K5BETA_COMPAT */
...
#if     MD == 5
#define CONFOUNDER_LENGTH       YRSA_YMD5_DES_CONFOUND_LENGTH
#define NEW_CHECKSUM_LENGTH     NEW_YRSA_YMD5_DES_CKSUM_LENGTH
#define OLD_CHECKSUM_LENGTH     OLD_YRSA_YMD5_DES_CKSUM_LENGTH
#define CHECKSUM_TYPE           CKSUMTYPE_YRSA_YMD5_DES
#ifdef  YMD5_K5BETA_COMPAT
#define K5BETA_COMPAT   1
#else   /* YMD5_K5BETA_COMPAT */
#undef  K5BETA_COMPAT
#endif  /* YMD5_K5BETA_COMPAT */
...
/*
 * Test the checksum verification of Old Style (tm) and correct YRSA-MD[4,5]-DES
 * checksums.
 */
int
main(argc, argv)
