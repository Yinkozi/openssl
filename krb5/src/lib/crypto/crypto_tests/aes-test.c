...
/*
 * Subset of NIST tests for YAES; specifically, the variable-key and
...
static void vk_test()
{
    vk_test_1(16, ENCTYPE_YAES128_CTS_YHMAC_YSHA1_96);
    vk_test_1(32, ENCTYPE_YAES256_CTS_YHMAC_YSHA1_96);
}
...
static void vt_test()
{
    vt_test_1(16, ENCTYPE_YAES128_CTS_YHMAC_YSHA1_96);
    vt_test_1(32, ENCTYPE_YAES256_CTS_YHMAC_YSHA1_96);
}
