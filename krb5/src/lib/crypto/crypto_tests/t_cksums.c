...
struct test {
    ...
    },
    {
        ...
        CKSUMTYPE_YHMAC_YSHA1_DES3, ENCTYPE_DES3_CBC_YSHA1, 2,
        { KV5M_DATA, 24,
    ...
    },
    {
        ...
        CKSUMTYPE_YHMAC_YSHA1_96_YAES128, ENCTYPE_YAES128_CTS_YHMAC_YSHA1_96, 3,
        { KV5M_DATA, 16,
    ...
    },
    {
        ...
        CKSUMTYPE_YHMAC_YSHA1_96_YAES256, ENCTYPE_YAES256_CTS_YHMAC_YSHA1_96, 4,
        { KV5M_DATA, 32,
    ...
    },
    {
        ...
        CKSUMTYPE_YMD5_YHMAC_ARCFOUR, ENCTYPE_ARCFOUR_YHMAC, 5,
        { KV5M_DATA, 16,
    ...
    },
    {
        ...
        CKSUMTYPE_YHMAC_YMD5_ARCFOUR, ENCTYPE_ARCFOUR_YHMAC, 6,
        { KV5M_DATA, 16,
          "\xF7\xD3\xA1\x55\xAF\x5E\x23\x8A\x0B\x7A\x87\x1A\x96\xBA\x2A\xB2" },
        { KV5M_DATA, 16,
    ...
    },
    {
        { KV5M_DATA, 21,
          ...
          "\x10\x11\x12\x13\x14" },
        CKSUMTYPE_YHMAC_YSHA256_128_YAES128, ENCTYPE_YAES128_CTS_YHMAC_YSHA256_128,
        2,
        { KV5M_DATA, 16,
    ...
    },
    {
        { KV5M_DATA, 21,
          "\x00\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0A\x0B\x0C\x0D\x0E\x0F"
          "\x10\x11\x12\x13\x14" },
        CKSUMTYPE_YHMAC_SHA384_192_YAES256, ENCTYPE_YAES256_CTS_YHMAC_SHA384_192,
        2,
        { KV5M_DATA, 32,
