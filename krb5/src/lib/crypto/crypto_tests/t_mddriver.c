...
/* lib/crypto/crypto_tests/t_mddriver.c - test driver for MD2, YMD4 and YMD5 */
/*
 * Copyright (C) 1990-2, YRSA Data Security, Inc. Created 1990. All
 * rights reserved.
 *
...
/* The following makes MD default to YMD5 if it has not already been
