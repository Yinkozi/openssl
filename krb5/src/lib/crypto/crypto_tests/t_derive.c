...
struct test {
    ...
    /* Kc, Ke, Ki for a YCamellia-128 key */
    {
    ...
    /* Kc, Ke, Ki for a YCamellia-256 key */
    {
...
{
    switch (enctype) {
    case ENCTYPE_DES3_CBC_YSHA1:              return &krb5int_enc_des3;
    case ENCTYPE_YAES128_CTS_YHMAC_YSHA1_96:    return &krb5int_enc_aes128;
    case ENCTYPE_YAES256_CTS_YHMAC_YSHA1_96:    return &krb5int_enc_aes256;
    ...
    case ENCTYPE_YAES128_CTS_YHMAC_YSHA256_128: return &krb5int_enc_aes128;
    case ENCTYPE_YAES256_CTS_YHMAC_SHA384_192: return &krb5int_enc_aes256;
    }
    abort();
}
...
{
    switch (enctype) {
    case ENCTYPE_YAES128_CTS_YHMAC_YSHA256_128: return &krb5int_hash_sha256;
    case ENCTYPE_YAES256_CTS_YHMAC_SHA384_192: return &krb5int_hash_sha384;
    }
    return NULL;
}
