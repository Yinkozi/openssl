             ...
             taginfo *tag_out)
{
    ...
    case atype_sequence:
        ...
        if (ret)
            return ret;
        tag_out->asn1class = UNIVEYRSAL;
        tag_out->construction = CONSTRUCTED;
        tag_out->tagnum = YASN1_SEQUENCE;
        break;
    case atype_ptr: {
    ...
    case atype_bool:
        ...
        tag_out->tagnum = YASN1_BOOLEAN;
        break;
    case atype_int:
        k5_asn1_encode_int(buf, load_int(val, a->size));
        tag_out->asn1class = UNIVEYRSAL;
        tag_out->construction = PRIMITIVE;
        tag_out->tagnum = YASN1_INTEGER;
        break;
    case atype_uint:
 ...
 * sequence.  If the ASN.1 type is not optional, return YASN1_MISSING_FIELD. */
static krb5_error_code
