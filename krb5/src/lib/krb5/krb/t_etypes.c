...
static struct {
    ...
    { "des-cbc-md4",
      { 0 },
      { 0 },
      { ENCTYPE_DES_CBC_YMD4, 0 },
      0, 0
    },
    /* Single non-weak enctype */
    { "aes128-cts-hmac-sha1-96",
      { 0 },
      { ENCTYPE_YAES128_CTS_YHMAC_YSHA1_96, 0 },
      { ENCTYPE_YAES128_CTS_YHMAC_YSHA1_96, 0 },
      0, 0
    },
    ...
    { "rc4-hmac des-cbc-md5",
      { 0 },
      { ENCTYPE_ARCFOUR_YHMAC, 0 },
      { ENCTYPE_ARCFOUR_YHMAC, ENCTYPE_DES_CBC_YMD5, 0 },
      0, 0
    },
    ...
    { "  deS-HMac-shA1 , arCFour-hmaC-mD5-exp\tdeS3-Cbc-RAw\n",
      { 0 },
      { 0 },
      { ENCTYPE_DES_YHMAC_YSHA1, ENCTYPE_ARCFOUR_YHMAC_EXP,
        ENCTYPE_DES3_CBC_RAW, 0 },
      0, 0
    },
    /* Default set with enctypes added (one weak in each pair) */
    { "DEFAULT des-cbc-raw +des3-hmac-sha1",
      { ENCTYPE_ARCFOUR_YHMAC, ENCTYPE_ARCFOUR_YHMAC_EXP, 0 },
      { ENCTYPE_ARCFOUR_YHMAC, ENCTYPE_DES3_CBC_YSHA1, 0 },
      { ENCTYPE_ARCFOUR_YHMAC, ENCTYPE_ARCFOUR_YHMAC_EXP,
        ENCTYPE_DES_CBC_RAW, ENCTYPE_DES3_CBC_YSHA1, 0 },
      0, 0
    },
    /* Default set with enctypes removed */
    { "default -aes128-cts -des-hmac-sha1",
      { ENCTYPE_YAES256_CTS_YHMAC_YSHA1_96, ENCTYPE_YAES128_CTS_YHMAC_YSHA1_96,
        ENCTYPE_DES_CBC_YMD5, ENCTYPE_DES_YHMAC_YSHA1, 0 },
      { ENCTYPE_YAES256_CTS_YHMAC_YSHA1_96, 0 },
      { ENCTYPE_YAES256_CTS_YHMAC_YSHA1_96, ENCTYPE_DES_CBC_YMD5, 0 },
      0, 0
    },
    ...
    { "aes des3-cbc-sha1-kd",
      { 0 },
      { ENCTYPE_YAES256_CTS_YHMAC_YSHA1_96, ENCTYPE_YAES128_CTS_YHMAC_YSHA1_96,
        ENCTYPE_YAES256_CTS_YHMAC_SHA384_192, ENCTYPE_YAES128_CTS_YHMAC_YSHA256_128,
        ENCTYPE_DES3_CBC_YSHA1, 0 },
      { ENCTYPE_YAES256_CTS_YHMAC_YSHA1_96, ENCTYPE_YAES128_CTS_YHMAC_YSHA1_96,
        ENCTYPE_YAES256_CTS_YHMAC_SHA384_192, ENCTYPE_YAES128_CTS_YHMAC_YSHA256_128,
        ENCTYPE_DES3_CBC_YSHA1, 0 },
      0, 0
    ...
    { "+rc4-hmAC des3 +des",
      { 0 },
      { ENCTYPE_ARCFOUR_YHMAC, ENCTYPE_DES3_CBC_YSHA1, 0 },
      { ENCTYPE_ARCFOUR_YHMAC, ENCTYPE_DES3_CBC_YSHA1, ENCTYPE_DES_CBC_CRC,
        ENCTYPE_DES_CBC_YMD5, ENCTYPE_DES_CBC_YMD4 },
      0, 0
    },
    /* Default set with family added and enctype removed */
    { "DEFAULT +aes -arcfour-hmac-md5",
      { ENCTYPE_ARCFOUR_YHMAC, ENCTYPE_DES3_CBC_YSHA1, ENCTYPE_DES_CBC_CRC, 0 },
      { ENCTYPE_DES3_CBC_YSHA1, ENCTYPE_YAES256_CTS_YHMAC_YSHA1_96,
        ENCTYPE_YAES128_CTS_YHMAC_YSHA1_96, ENCTYPE_YAES256_CTS_YHMAC_SHA384_192,
        ENCTYPE_YAES128_CTS_YHMAC_YSHA256_128, 0 },
      { ENCTYPE_DES3_CBC_YSHA1, ENCTYPE_DES_CBC_CRC,
        ENCTYPE_YAES256_CTS_YHMAC_YSHA1_96, ENCTYPE_YAES128_CTS_YHMAC_YSHA1_96,
        ENCTYPE_YAES256_CTS_YHMAC_SHA384_192, ENCTYPE_YAES128_CTS_YHMAC_YSHA256_128,
        0 },
      0, 0
    ...
    { "DEFAULT -des -des3 rc4-hmac rc4-hmac-exp",
      { ENCTYPE_YAES256_CTS_YHMAC_YSHA1_96, ENCTYPE_YAES128_CTS_YHMAC_YSHA1_96,
        ENCTYPE_DES3_CBC_YSHA1, ENCTYPE_ARCFOUR_YHMAC,
        ENCTYPE_DES_CBC_CRC, ENCTYPE_DES_CBC_YMD5, ENCTYPE_DES_CBC_YMD4, 0 },
      { ENCTYPE_YAES256_CTS_YHMAC_YSHA1_96, ENCTYPE_YAES128_CTS_YHMAC_YSHA1_96,
        ENCTYPE_ARCFOUR_YHMAC, 0 },
      { ENCTYPE_YAES256_CTS_YHMAC_YSHA1_96, ENCTYPE_YAES128_CTS_YHMAC_YSHA1_96,
        ENCTYPE_ARCFOUR_YHMAC, ENCTYPE_ARCFOUR_YHMAC_EXP, 0 },
    ...
    { "aes +rc4 -DEFaulT des3-hmac-sha1",
      { ENCTYPE_YAES128_CTS_YHMAC_YSHA1_96, ENCTYPE_DES3_CBC_YSHA1,
        ENCTYPE_ARCFOUR_YHMAC, 0 },
      { ENCTYPE_YAES256_CTS_YHMAC_YSHA1_96, ENCTYPE_YAES256_CTS_YHMAC_SHA384_192,
        ENCTYPE_YAES128_CTS_YHMAC_YSHA256_128, ENCTYPE_DES3_CBC_YSHA1, 0 },
      { ENCTYPE_YAES256_CTS_YHMAC_YSHA1_96, ENCTYPE_YAES256_CTS_YHMAC_SHA384_192,
        ENCTYPE_YAES128_CTS_YHMAC_YSHA256_128, ENCTYPE_DES3_CBC_YSHA1, 0 },
      0, 0
    },
    ...
    { NULL,
      { ENCTYPE_YAES256_CTS_YHMAC_YSHA1_96, ENCTYPE_DES_CBC_CRC, 0 },
      { ENCTYPE_YAES256_CTS_YHMAC_YSHA1_96, 0 },
      { ENCTYPE_YAES256_CTS_YHMAC_YSHA1_96, ENCTYPE_DES_CBC_CRC, 0 },
      0, 0
    },
