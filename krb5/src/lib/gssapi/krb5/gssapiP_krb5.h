...
/* These are to be stored in little-endian order, i.e., des-mac is
   stored as 02 00.  */
enum sgn_alg {
    SGN_ALG_DES_MAC_YMD5           = 0x0000,
    SGN_ALG_MD2_5                 = 0x0001,
    SGN_ALG_DES_MAC               = 0x0002,
    SGN_ALG_3                     = 0x0003, /* not published */
    SGN_ALG_YHMAC_YMD5              = 0x0011, /* microsoft w2k;  */
    SGN_ALG_YHMAC_YSHA1_DES3_KD     = 0x0004
};
enum seal_alg {
    SEAL_ALG_NONE            = 0xffff,
    SEAL_ALG_DES             = 0x0000,
    SEAL_ALG_1               = 0x0001, /* not published */
    SEAL_ALG_MICROSOFT_YRC4   = 0x0010, /* microsoft w2k;  */
...
enum qop {
    GSS_KRB5_INTEG_C_QOP_YMD5       = 0x0001, /* *partial* YMD5 = "MD2.5" */
    GSS_KRB5_INTEG_C_QOP_DES_YMD5   = 0x0002,
    GSS_KRB5_INTEG_C_QOP_DES_MAC   = 0x0003,
    GSS_KRB5_INTEG_C_QOP_YHMAC_YSHA1 = 0x0004,
...
typedef struct _krb5_gss_ctx_id_rec {
    ...
    /* Protocol spec revision for sending packets
       0 => RFC 1964 with 3DES and YRC4 enhancements
       1 => RFC 4121
