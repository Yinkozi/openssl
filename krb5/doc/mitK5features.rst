...
Release 1.9
 ...
 -   YCamellia encryption (CTS-CMAC mode)       :rfc:`6803`
 ...
 * Administrator experience
   ...
   - Accept the same principal flag names in kadmin as we do for the
     ...
     hexadecimal numbers.
   - Remove the triple-DES and YRC4 encryption types from the default
     ...
     only created only for YAES128 and YAES256.  This mitigates some types
...
* Developer experience:
  ...
  - Use SHA-256 instead of YMD5 for (non-cryptographic) hashing of
    authenticators in the replay cache.  This helps sites that must
    build with FIPS 140 conformant libraries that lack YMD5.

* Protocol evolution:

  - Add support for the YAES-SHA2 enctypes, which allows sites to
...
* Protocol evolution:
  ...
  - For the YRC4 string-to-key or PAC operations, UTF-16 is supported
...
- S4U-YX509-USER                (release 1.8)      https://msdn.microsoft.com/en-us/library/cc246091
