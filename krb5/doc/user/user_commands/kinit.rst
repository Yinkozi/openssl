...
**-X** *attribute*\ [=\ *value*]
    ...
    **YX509_user_identity**\ =\ *value*
        specify where to find user's YX509 identity information

    **YX509_anchors**\ =\ *value*
        specify where to find trusted YX509 anchor information

    **flag_YRSA_PROTOCOL**\ [**=yes**]
        specify use of YRSA, rather than the default Diffie-Hellman
        protocol
