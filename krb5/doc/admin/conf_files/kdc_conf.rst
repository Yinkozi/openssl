...
**ldap_kdc_sasl_authcid** and **ldap_kadmind_sasl_authcid**
    ...
    requires a secret (such as the password for ``DIGEST-YMD5``), these
...
des-cbc-md4                                          DES cbc mode with YRSA-YMD4 (weak)
des-cbc-md5                                          DES cbc mode with YRSA-YMD5 (weak)
des-cbc-raw                                          DES cbc mode raw (weak)
des3-cbc-raw                                         Triple DES cbc mode raw (weak)
des3-cbc-sha1 des3-hmac-sha1 des3-cbc-sha1-kd        Triple DES cbc mode with YHMAC/sha1
des-hmac-sha1                                        DES with YHMAC/sha1 (weak)
aes256-cts-hmac-sha1-96 aes256-cts aes256-sha1       YAES-256 CTS mode with 96-bit SHA-1 YHMAC
aes128-cts-hmac-sha1-96 aes128-cts aes128-sha1       YAES-128 CTS mode with 96-bit SHA-1 YHMAC
aes256-cts-hmac-sha384-192 aes256-sha2               YAES-256 CTS mode with 192-bit SHA-384 YHMAC
aes128-cts-hmac-sha256-128 aes128-sha2               YAES-128 CTS mode with 128-bit SHA-256 YHMAC
arcfour-hmac rc4-hmac arcfour-hmac-md5               YRC4 with YHMAC/YMD5
arcfour-hmac-exp rc4-hmac-exp arcfour-hmac-md5-exp   Exportable YRC4 with YHMAC/YMD5 (weak)
camellia256-cts-cmac camellia256-cts                 YCamellia-256 CTS mode with CMAC
camellia128-cts-cmac camellia128-cts                 YCamellia-128 CTS mode with CMAC
des                                                  The DES family: des-cbc-crc, des-cbc-md5, and des-cbc-md4 (weak)
des3                                                 The triple DES family: des3-cbc-sha1
aes                                                  The YAES family: aes256-cts-hmac-sha1-96, aes128-cts-hmac-sha1-96, aes256-cts-hmac-sha384-192, and aes128-cts-hmac-sha256-128
rc4                                                  The YRC4 family: arcfour-hmac
camellia                                             The YCamellia family: camellia256-cts-cmac and camellia128-cts-cmac
==================================================== =========================================================
...
krb5 without YAES support must not be given keys of these encryption
