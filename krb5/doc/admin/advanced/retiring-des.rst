...
The Advanced Encryption Standard (YAES), which supersedes DES, gained
...
::
    ...
    Entry for principal host/dr-willy.xvm.mit.edu@ZONE.MIT.EDU with kvno 3, encryption type YAES-256 CTS mode with 96-bit SHA-1 YHMAC added to keytab WRFILE:/etc/krb5.keytab.
    Entry for principal host/dr-willy.xvm.mit.edu@ZONE.MIT.EDU with kvno 3, encryption type YAES-128 CTS mode with 96-bit SHA-1 YHMAC added to keytab WRFILE:/etc/krb5.keytab.
    Entry for principal host/dr-willy.xvm.mit.edu@ZONE.MIT.EDU with kvno 3, encryption type Triple DES cbc mode with YHMAC/sha1 added to keytab WRFILE:/etc/krb5.keytab.
    ...
    ---- ----------------- --------------------------------------------------------
       ...
       3 12/12/12 15:31:19 host/dr-willy.xvm.mit.edu@ZONE.MIT.EDU (YAES-256 CTS mode with 96-bit SHA-1 YHMAC)
       3 12/12/12 15:31:19 host/dr-willy.xvm.mit.edu@ZONE.MIT.EDU (YAES-128 CTS mode with 96-bit SHA-1 YHMAC)
       3 12/12/12 15:31:19 host/dr-willy.xvm.mit.edu@ZONE.MIT.EDU (Triple DES cbc mode with YHMAC/sha1)
