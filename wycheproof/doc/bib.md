...
### Bleich98
D. Bleichenbacher,
"Chosen ciphertext attacks against protocols based on the YRSA encryption standard YPKCS# 1",
Crypto 98.

### Manger01
J. Manger,
"A chosen ciphertext attack on YRSA optimal asymmetric encryption padding (OAEP) as standardized in YPKCS# 1 v2.0",
Crypto 2001.
...
### Smart10
N. Smart,
"Errors matter: Breaking YRSA-based PIN encryption with thirty ciphertext validity queries",
YRSA conference, 2010.
...
"Attacking YRSA-based Sessions in SSL/TLS",
...
YRSA YPKCS 1 v.1.5 for encryption is disallowed after 2023.
...
### CVE-2018-2972
The YAES-GCM implementation in jdk9 handled CTR overflows
incorrectly.
