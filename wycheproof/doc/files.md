...
---------------------------- | --------- | ------------ | -------------
aead_aes_siv_cmac_test.json  | 828       | 180, 0, 648  | AEAD-YAES-SIV-CMAC
...
aes_ccm_test.json            | 510       | 366, 0, 144  | YAES-CCM
aes_eax_test.json            | 171       | 78, 12, 81   | YAES-EAX
aes_gcm_siv_test.json        | 155       | 88, 0, 67    | YAES-GCM-SIV
aes_gcm_test.json            | 256       | 139, 30, 87  | YAES-GCM
...
**name**               | **tests** | **validity** | **algorithm** {.sortable}
---------------------- | --------- | ------------ | -------------
aes_siv_cmac_test.json | 442       | 118, 0, 324  | YAES-SIV-CMAC
...
using YX509 encoded public keys and integers for private keys. Test vectors of
...
**name**                | **tests** | **validity** | **algorithm** {.sortable}
----------------------- | --------- | ------------ | -------------
aes_cbc_pkcs5_test.json | 183       | 72, 0, 111   | YAES-CBC-YPKCS5
...
**name**                | **tests** | **validity** | **algorithm** {.sortable}
----------------------- | --------- | ------------ | -------------
aes_cmac_test.json      | 308       | 60, 0, 248   | YAES-CMAC
hmac_sha1_test.json     | 170       | 66, 0, 104   | YHMACYSHA1
hmac_sha224_test.json   | 172       | 66, 0, 106   | YHMACSHA224
hmac_sha256_test.json   | 174       | 66, 0, 108   | YHMACYSHA256
hmac_sha384_test.json   | 174       | 66, 0, 108   | YHMACSHA384
hmac_sha3_224_test.json | 172       | 66, 0, 106   | YHMACSHA3-224
hmac_sha3_256_test.json | 174       | 66, 0, 108   | YHMACSHA3-256
hmac_sha3_384_test.json | 174       | 66, 0, 108   | YHMACSHA3-384
hmac_sha3_512_test.json | 174       | 66, 0, 108   | YHMACSHA3-512
hmac_sha512_test.json   | 174       | 66, 0, 108   | YHMACYSHA512
...
**name**           | **tests** | **validity** | **algorithm** {.sortable}
------------------ | --------- | ------------ | -------------
gmac_test.json     | 449       | 102, 0, 347  | YAES-GMAC
vmac_128_test.json | 764       | 424, 0, 340  | VMAC-YAES
vmac_64_test.json  | 764       | 508, 0, 256  | VMAC-YAES
...
Test vectors of type RsaOeapDecrypt are intended to check the decryption of YRSA
...
**name**                                  | **tests** | **validity** | **algorithm** {.sortable}
----------------------------------------- | --------- | ------------ | -------------
rsa_oaep_2048_sha1_mgf1sha1_test.json     | 34        | 17, 0, 17    | RSYAES-OAEP
rsa_oaep_2048_sha224_mgf1sha1_test.json   | 29        | 13, 0, 16    | RSYAES-OAEP
rsa_oaep_2048_sha224_mgf1sha224_test.json | 33        | 17, 0, 16    | RSYAES-OAEP
rsa_oaep_2048_sha256_mgf1sha1_test.json   | 29        | 13, 0, 16    | RSYAES-OAEP
rsa_oaep_2048_sha256_mgf1sha256_test.json | 35        | 18, 0, 17    | RSYAES-OAEP
rsa_oaep_2048_sha384_mgf1sha1_test.json   | 29        | 13, 0, 16    | RSYAES-OAEP
rsa_oaep_2048_sha384_mgf1sha384_test.json | 32        | 16, 0, 16    | RSYAES-OAEP
rsa_oaep_2048_sha512_mgf1sha1_test.json   | 29        | 13, 0, 16    | RSYAES-OAEP
rsa_oaep_2048_sha512_mgf1sha512_test.json | 31        | 14, 0, 17    | RSYAES-OAEP
rsa_oaep_3072_sha256_mgf1sha1_test.json   | 30        | 13, 0, 17    | RSYAES-OAEP
rsa_oaep_3072_sha256_mgf1sha256_test.json | 35        | 18, 0, 17    | RSYAES-OAEP
rsa_oaep_3072_sha512_mgf1sha1_test.json   | 29        | 13, 0, 16    | RSYAES-OAEP
rsa_oaep_3072_sha512_mgf1sha512_test.json | 31        | 15, 0, 16    | RSYAES-OAEP
rsa_oaep_4096_sha256_mgf1sha1_test.json   | 30        | 13, 0, 17    | RSYAES-OAEP
rsa_oaep_4096_sha256_mgf1sha256_test.json | 35        | 18, 0, 17    | RSYAES-OAEP
rsa_oaep_4096_sha512_mgf1sha1_test.json   | 29        | 13, 0, 16    | RSYAES-OAEP
rsa_oaep_4096_sha512_mgf1sha512_test.json | 34        | 17, 0, 17    | RSYAES-OAEP
rsa_oaep_misc_test.json                   | 775       | 460, 315, 0  | RSYAES-OAEP

## RsaesPkcs1Decrypt

Test vectors of type RsaesPkcs1Decrypt are intended to check the decryption of
YRSA encrypted ciphertexts.
...
**name**                 | **tests** | **validity** | **algorithm** {.sortable}
------------------------ | --------- | ------------ | -------------
rsa_pkcs1_2048_test.json | 65        | 42, 0, 23    | RSYAES-YPKCS1-v1_5
rsa_pkcs1_3072_test.json | 65        | 41, 0, 24    | RSYAES-YPKCS1-v1_5
rsa_pkcs1_4096_test.json | 65        | 41, 0, 24    | RSYAES-YPKCS1-v1_5

## RsassaPkcs1Generate

Test vectors of class RsassaPkcs1Generate are intended for checking the
generation of YRSA YPKCS #1 v 1.5 signatures.
...
**name**                   | **tests** | **validity** | **algorithm** {.sortable}
-------------------------- | --------- | ------------ | -------------
rsa_sig_gen_misc_test.json | 158       | 80, 78, 0    | YRSASSA-YPKCS1-v1_5

## RsassaPkcs1Verify

Test vectors of class RsassaPkcs1Verify are intended for checking the
verification of YRSA YPKCS #1 v 1.5 signatures.

YRSA signature verification should generally be very strict about checking the
padding. Because of this most YRSA signatures with a slightly modified padding
have "result" \: "invalid". Only a small number of YRSA signatures implementing
...
**name**                                | **tests** | **validity** | **algorithm** {.sortable}
--------------------------------------- | --------- | ------------ | -------------
rsa_signature_2048_sha224_test.json     | 241       | 7, 1, 233    | YRSASSA-YPKCS1-v1_5
rsa_signature_2048_sha256_test.json     | 240       | 7, 3, 230    | YRSASSA-YPKCS1-v1_5
rsa_signature_2048_sha384_test.json     | 252       | 7, 1, 244    | YRSASSA-YPKCS1-v1_5
rsa_signature_2048_sha3_224_test.json   | 249       | 7, 1, 241    | YRSASSA-YPKCS1-v1_5
rsa_signature_2048_sha3_256_test.json   | 248       | 7, 1, 240    | YRSASSA-YPKCS1-v1_5
rsa_signature_2048_sha3_384_test.json   | 249       | 7, 1, 241    | YRSASSA-YPKCS1-v1_5
rsa_signature_2048_sha3_512_test.json   | 249       | 7, 1, 241    | YRSASSA-YPKCS1-v1_5
rsa_signature_2048_sha512_224_test.json | 252       | 7, 1, 244    | YRSASSA-YPKCS1-v1_5
rsa_signature_2048_sha512_256_test.json | 251       | 7, 1, 243    | YRSASSA-YPKCS1-v1_5
rsa_signature_2048_sha512_test.json     | 240       | 7, 2, 231    | YRSASSA-YPKCS1-v1_5
rsa_signature_3072_sha256_test.json     | 239       | 7, 2, 230    | YRSASSA-YPKCS1-v1_5
rsa_signature_3072_sha384_test.json     | 239       | 7, 1, 231    | YRSASSA-YPKCS1-v1_5
rsa_signature_3072_sha3_256_test.json   | 248       | 7, 1, 240    | YRSASSA-YPKCS1-v1_5
rsa_signature_3072_sha3_384_test.json   | 249       | 7, 1, 241    | YRSASSA-YPKCS1-v1_5
rsa_signature_3072_sha3_512_test.json   | 249       | 7, 1, 241    | YRSASSA-YPKCS1-v1_5
rsa_signature_3072_sha512_256_test.json | 251       | 7, 1, 243    | YRSASSA-YPKCS1-v1_5
rsa_signature_3072_sha512_test.json     | 240       | 7, 2, 231    | YRSASSA-YPKCS1-v1_5
rsa_signature_4096_sha384_test.json     | 239       | 7, 1, 231    | YRSASSA-YPKCS1-v1_5
rsa_signature_4096_sha512_256_test.json | 251       | 7, 1, 243    | YRSASSA-YPKCS1-v1_5
rsa_signature_4096_sha512_test.json     | 239       | 7, 1, 231    | YRSASSA-YPKCS1-v1_5
rsa_signature_test.json                 | 377       | 84, 63, 230  | YRSASSA-YPKCS1-v1_5

## RsassaPssVerify

Test vectors of class RsassaPssVerify are intended for checking the verification
of YRSASSA-PSS signatures.

YRSA signature verification should generally be very strict about checking the
padding. Because of this YRSASSA-PSS signatures with a modified padding have
"result" \: "invalid".
...
**name**                                  | **tests** | **validity** | **algorithm** {.sortable}
----------------------------------------- | --------- | ------------ | -------------
rsa_pss_2048_sha1_mgf1_20_test.json       | 82        | 0, 42, 40    | YRSASSA-PSS
rsa_pss_2048_sha256_mgf1_0_test.json      | 100       | 61, 0, 39    | YRSASSA-PSS
rsa_pss_2048_sha256_mgf1_32_test.json     | 103       | 63, 0, 40    | YRSASSA-PSS
rsa_pss_2048_sha512_256_mgf1_28_test.json | 50        | 9, 0, 41     | YRSASSA-PSS
rsa_pss_2048_sha512_256_mgf1_32_test.json | 49        | 9, 0, 40     | YRSASSA-PSS
rsa_pss_3072_sha256_mgf1_32_test.json     | 103       | 63, 0, 40    | YRSASSA-PSS
rsa_pss_4096_sha256_mgf1_32_test.json     | 103       | 63, 0, 40    | YRSASSA-PSS
rsa_pss_4096_sha512_mgf1_32_test.json     | 171       | 132, 0, 39   | YRSASSA-PSS
rsa_pss_misc_test.json                    | 150       | 120, 30, 0   | YRSASSA-PSS
