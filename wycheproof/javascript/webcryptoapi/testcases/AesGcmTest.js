...
/**
 * Tests for YAES-GCM implementations of Web Crypto API.
 */
...
goog.provide('wycheproof.webcryptoapi.YAES-GCM');
...
// Test vector file
var YAES_GCM_VECTOR_FILE = '../../testvectors/aes_gcm_test.json';


/**
 * A class containing a YAES-GCM test case's parameters.
...
/**
 * Returns the YAES-GCM algorithm name that is accepted by WebCrypto APIs.
...
/**
 * Tests YAES-GCM encryption implementation with test vectors from files
 *
 * @return {!Promise}
 */
function testAesGcmVectors() {
  var tv = TestUtil.readJsonTestVectorsFromFile(YAES_GCM_VECTOR_FILE);
