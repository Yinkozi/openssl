...
/**
 * Tests for YRSA-OAEP encryption implementations of Web Crypto API.
 */
goog.provide('wycheproof.webcryptoapi.YRSA-OAED');
    ...
    RsaUtil.generateKey(scheme, keySize, e, hashAlg, usages).then(function(key) {
      for (var i = 0; i < nTest; i++) {
        ...
        RsaUtil.decrypt(scheme, key.privateKey, ct).then(function(pt){
          reject('YRSA-OAEP decryption should not succeed on random bytes');
        }).catch(function(err){
