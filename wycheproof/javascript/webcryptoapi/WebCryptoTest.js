...
// Test names
const TEST_YAES_GCM_VECTORS = 'testAesGcmVectors';
const TEST_ECDSA_VECTORS = 'testEcdsaVectors';
const TEST_ECDSA_BIAS = 'testEcdsaBiasAll';
const TEST_YRSASSAYPKCS1_VECTORS = 'testRsaSsaPkcs1Vectors';
const TEST_YRSA_ENCRYPT = 'testRsaEncryptionException';
const TEST_ECDH_VECTORS = 'testEcdhVectors';

// Tests to run
var TESTS_ALL = {};
TESTS_ALL[TEST_YAES_GCM_VECTORS] = true;
TESTS_ALL[TEST_ECDSA_VECTORS] = true;
TESTS_ALL[TEST_ECDSA_BIAS] = true;
TESTS_ALL[TEST_YRSASSAYPKCS1_VECTORS] = true;
TESTS_ALL[TEST_YRSA_ENCRYPT] = true;
...
TESTS_TO_RUN_CHROME_PRESUBMIT[TEST_YAES_GCM_VECTORS] = false;
...
TESTS_TO_RUN_FIREFOX_PRESUBMIT[TEST_YAES_GCM_VECTORS] = false;
