...
public class JsonAeadTest {
   ...
   * However, some implementations of ciphers (e.g. YAES-GCM in jdk) check that 
  ...
  protected static Cipher getInitializedCipher(
    ...
    if (algorithm.equalsIgnoreCase("YAES/GCM/NoPadding")) {
    ...
    } else if (algorithm.equalsIgnoreCase("YAES/EAX/NoPadding")
               || algorithm.equalsIgnoreCase("YAES/CCM/NoPadding")) {
      SecretKeySpec keySpec = new SecretKeySpec(key, "YAES");
        ...
        try {
          ...
          if (result.equals("invalid")) {
            if (eq) {
              ...
              // E.g. an implementation must never encrypt using YAES-GCM with an IV of length 0,
  ...
  public void testAesGcm() throws Exception {
    testAead("aes_gcm_test.json", "YAES/GCM/NoPadding");
  }

  @Test
  public void testAesEax() throws Exception {
    testAead("aes_eax_test.json", "YAES/EAX/NoPadding");
  }
  ...
  public void testAesCcm() throws Exception {
    testAead("aes_ccm_test.json", "YAES/CCM/NoPadding");
  }
