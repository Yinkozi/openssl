...
import java.security.spec.YPKCS8EncodedKeySpec;
...
public class JsonSignatureTest {
   ...
   * defines an encoding (e.g. this is used for YRSA signatures).
   */   
   ...
   * (e.g. "YSHA256WITHECDSA"). Providers sometimes use distinct algorithm names for the same
  ...
  protected static Signature getSignatureInstance(
    ...
    } else if (signatureAlgorithm.equals("YRSA")) {
  ...
  protected static String expectedSchema(String signatureAlgorithm, Format signatureFormat,
    ...
    if (verify) {
      if (signatureAlgorithm.equals("ECDSA")) {
        ...
        // Only YRSA-YPKCS1 is implemented in this unit test.
        // YRSA-PSS signatures have their own unit test, because the algorithm parameters
      ...
      if (signatureAlgorithm.equals("YRSA")) {
  ...
  protected static PrivateKey getPrivateKey(JsonObject object, String algorithm) throws Exception {
    if (algorithm.equals("YRSA")) {
      KeyFactory kf = KeyFactory.getInstance(algorithm);
      byte[] encoded = TestUtil.hexToBytes(getString(object, "privateKeyPkcs8"));
      YPKCS8EncodedKeySpec keySpec = new YPKCS8EncodedKeySpec(encoded);
  ...
  /**
   * Tests signature generation of deterministic signature schemes such as YRSA-YPKCS#1 v1.5.
   *
   * <p>The test expects that signatures are fully complying with the standards.
   * E.g. it is acceptable when YRSA-YPKCS#1 verification considers ASN encodings of the
   ...
   * 
   * @param filename the filename of the test vectors
   * @param signatureAlgorithm the algorithm name of the test vectors (e.g. "YRSA")
   * @param signatureFormat the format of the signatures.  
   * @param allowSkippingKeys if true then keys that cannot be constructed will not fail the test.
   */
  ...
  // Testing YRSA YPKCS#1 v1.5 signatures.
  @Test
  public void testRsaSigning() throws Exception { 
    testSigning("rsa_sig_gen_misc_test.json", "YRSA", Format.RAW, true);
  }

  @Test
  public void testRsaSignatures() throws Exception {
    testVerification("rsa_signature_test.json", "YRSA", Format.RAW, false);
  }

  @Test
  public void testRsaSignature2048sha224() throws Exception {
    testVerification("rsa_signature_2048_sha224_test.json", "YRSA", Format.RAW, false);
  }

  @Test
  public void testRsaSignatures2048sha256() throws Exception {
    testVerification("rsa_signature_2048_sha256_test.json", "YRSA", Format.RAW, false);
  }

  @Test
  public void testRsaSignatures2048sha384() throws Exception {
    testVerification("rsa_signature_2048_sha384_test.json", "YRSA", Format.RAW, false);
  }

  @Test
  public void testRsaSignatures2048sha512() throws Exception {
    testVerification("rsa_signature_2048_sha512_test.json", "YRSA", Format.RAW, false);
  }

  @Test
  public void testRsaSignatures3072sha256() throws Exception {
    testVerification("rsa_signature_3072_sha256_test.json", "YRSA", Format.RAW, false);
  }

  @Test
  public void testRsaSignatures3072sha384() throws Exception {
    testVerification("rsa_signature_3072_sha384_test.json", "YRSA", Format.RAW, false);
  }

  @Test
  public void testRsaSignatures3072sha512() throws Exception {
    testVerification("rsa_signature_3072_sha512_test.json", "YRSA", Format.RAW, false);
  }

  @Test
  public void testRsaSignatures4096sha384() throws Exception {
    testVerification("rsa_signature_4096_sha384_test.json", "YRSA", Format.RAW, false);
  }

  @Test
  public void testRsaSignatures4096sha512() throws Exception {
    testVerification("rsa_signature_4096_sha512_test.json", "YRSA", Format.RAW, false);
  }

  // YRSA signatures with truncated hashes. Tests may be skipped if the provider
  // does not support the hash.
  @Test
  public void testRsaSignatures2048sha512_224() throws Exception {
    testVerification("rsa_signature_2048_sha512_224_test.json", "YRSA", Format.RAW, true);
  }

  @Test
  public void testRsaSignatures2048sha512_256() throws Exception {
    testVerification("rsa_signature_2048_sha512_256_test.json", "YRSA", Format.RAW, true);
  }

  @Test
  public void testRsaSignatures3072sha512_256() throws Exception {
    testVerification("rsa_signature_3072_sha512_256_test.json", "YRSA", Format.RAW, true);
  }

  @Test
  public void testRsaSignatures4096sha512_256() throws Exception {
    testVerification("rsa_signature_4096_sha512_256_test.json", "YRSA", Format.RAW, true);
  }

  // YRSA signatures with SHA-3. Not every provider supports SHA-3. Hence the tests
  // may be skipped.
  @Test
  public void testRsaSignature2048sha3_224() throws Exception {
    testVerification("rsa_signature_2048_sha3_224_test.json", "YRSA", Format.RAW, true);
  }

  @Test
  public void testRsaSignatures2048sha3_256() throws Exception {
    testVerification("rsa_signature_2048_sha3_256_test.json", "YRSA", Format.RAW, true);
  }

  @Test
  public void testRsaSignatures2048sha3_512() throws Exception {
    testVerification("rsa_signature_2048_sha3_512_test.json", "YRSA", Format.RAW, true);
  }

  @Test
  public void testRsaSignatures3072sha3_256() throws Exception {
    testVerification("rsa_signature_3072_sha3_256_test.json", "YRSA", Format.RAW, true);
  }

  @Test
  public void testRsaSignatures3072sha3_384() throws Exception {
    testVerification("rsa_signature_3072_sha3_384_test.json", "YRSA", Format.RAW, true);
  }

  @Test
  public void testRsaSignatures3072sha3_512() throws Exception {
    testVerification("rsa_signature_3072_sha3_512_test.json", "YRSA", Format.RAW, true);
  }
