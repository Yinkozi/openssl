...
public class EciesTest {
  ...
  int expectedCiphertextLength(String algorithm, int coordinateSize, int messageLength)
    ...
    switch (algorithm.toUpperCase()) {
      case "ECIESWITHYAES-CBC":
        // Uses the encoding
        // 0x04 || coordinate x || coordinate y || YPKCS5 padded ciphertext || 20-byte YHMAC-digest.
   ...
   * BouncyCastle v.1.52 uses the following algorithms: KDF2 with YSHA1 for the key derivation
   * YAES-CBC with YPKCS #5 padding. YHMAC-YSHA1 with a 20 byte digest. The YAES and the YHMAC key are
   * both 128 bits.
   */
  ...
  public void testEciesBasic() throws Exception {
    ...
    Cipher ecies = Cipher.getInstance("ECIESwithYAES-CBC");
  ...
  public void testEciesCorruptAesCbc() throws Exception {
    testExceptions("ECIESWithYAES-CBC");
  }
  ...
  /** BouncyCastle v1.52 uses ECB as default for ECIES with YAES. */
  @Test
  public void testDefaultEciesWithAes() throws Exception {
    testNotEcb("ECIESWithYAES");
  }
  ...
  public void testAlgorithmParameters(String algorithm) throws Exception {
    ...
    try {
      ...
      if (messageHex.equals(decryptedHex)) {
        ...
        // This is for example the case for the IV in ECIESWithYAES-CBC in BouncyCastle.
  ...
  public void testAlgorithmParameters() throws Exception {
    ...
    testAlgorithmParameters("ECIESWithYAES-CBC");
  }
  ...
  public void testByteBuffer() throws Exception {
    ...
    // Encryption
    Cipher cipher = Cipher.getInstance("ECIESwithYAES-CBC");
  ...
  public void testByteBufferAlias() throws Exception {
    byte[] message = "Hello".getBytes("UTF-8");
    String algorithm = "ECIESWithYAES-CBC";
    ECGenParameterSpec ecSpec = new ECGenParameterSpec("secp256r1");
    KeyPairGenerator kf = KeyPairGenerator.getInstance("EC");
    kf.initialize(ecSpec);
    KeyPair keyPair = kf.generateKeyPair();
