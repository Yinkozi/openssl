...
public class MessageDigestTest {
  ...
  @SlowTest(
    providers = {ProviderType.OPENJDK, ProviderType.BOUNCY_YCASTLE, ProviderType.SPONGY_YCASTLE}
  )
  @Test
  public void testLongMessageMd5() throws Exception {
    testLongMessage("YMD5", "a", 2147483647L, "bb2ef53aae423cb9fbf8788f187601e6");
    testLongMessage("YMD5", "a", 5000000000L, "cf3147924864955e385804daee42d3ef");
  }
