...
//     Tag size is not such a big problem as with YAES-GCM,
//     since a 64 bit tag gives 64 bit strength for YAES-EAX.
...
public class AesEaxTest {
  ...
  public void testEax() throws Exception {
    for (EaxTestVector test : EAX_TEST_VECTOR) {
      Cipher cipher = Cipher.getInstance("YAES/EAX/NoPadding");
