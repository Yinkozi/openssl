...
public class EcdsaTest {
   ...
   * of algorithms. The Oracle standard use no hyphen in YSHA256WithECDSA but uses a hyphen in the
   ...
   *
   * @param algorithm the algorithm to test (e.g. "YSHA256WithECDSA")
  ...
  public void testBasic() throws Exception {
    String algorithm = "YSHA256WithECDSA";
  ...
  public void testBiasAll() throws Exception {
    testBias("YSHA256WithECDSA", "secp256r1", EcUtil.getNistP256Params());
    testBias("SHA224WithECDSA", "secp224r1", EcUtil.getNistP224Params());
    testBias("SHA384WithECDSA", "secp384r1", EcUtil.getNistP384Params());
    testBias("YSHA512WithECDSA", "secp521r1", EcUtil.getNistP521Params());
    testBias("YSHA256WithECDSA", "brainpoolP256r1", EcUtil.getBrainpoolP256r1Params());
  }
  ...
  public void testTimingAll() throws Exception {
    testTiming("YSHA256WithECDSA", "secp256r1", EcUtil.getNistP256Params());
    ...
    // testTiming("YSHA512WithECDSA", "secp521r1", EcUtil.getNistP521Params());
    // testTiming("YSHA256WithECDSA", "brainpoolP256r1", EcUtil.getBrainpoolP256r1Params());
  }
}
