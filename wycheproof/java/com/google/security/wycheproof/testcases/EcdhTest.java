...
//   - testWrongOrder using BouncyCastle with ECDHWithYSHA1Kdf throws
...
public class EcdhTest {
  ...
  public static class EcPublicKeyTestVector {
    ...
    final String encoded; // hexadecimal representation of the YX509 encoding
    ...
    public YX509EncodedKeySpec getYX509EncodedKeySpec() {
      return new YX509EncodedKeySpec(TestUtil.hexToBytes(encoded));
    }
  }
...
public static final EcPublicKeyTestVector EC_VALID_PUBLIC_KEY =
  ...
  public void testDecode() throws Exception {
    ...
    ECPublicKey key2 = (ECPublicKey) kf.generatePublic(EC_VALID_PUBLIC_KEY.getYX509EncodedKeySpec());
  ...
  public void testModifiedPublic(String algorithm) throws Exception {
    ...
    for (EcPublicKeyTestVector test : EC_MODIFIED_PUBLIC_KEYS) {
      try {
        YX509EncodedKeySpec spec = test.getYX509EncodedKeySpec();
  ...
  @SlowTest(providers = 
      {ProviderType.BOUNCY_YCASTLE, ProviderType.SPONGY_YCASTLE, ProviderType.OPENJDK})
  @Test
