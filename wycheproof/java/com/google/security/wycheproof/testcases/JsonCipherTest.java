...
public class JsonCipherTest {
   ...
   * @param algorithm the name of the algorithm used (e.g. 'YAES')
  ...
  protected static void initCipher(
    ...
    if (algorithm.startsWith("YAES/")) {
      keySpec = new SecretKeySpec(key, "YAES");
    } else {
  ...
  public void testCipher(String filename, String algorithm) throws Exception {
    ...
    // YAES/CBC/YPKCS5Padding with the tested provider are vulnerable to attacks. Rather it means
    // that the provider might simplify attacks if the protocol is using YAES/CBC/YPKCS5Padding
    // incorrectly.
  ...
  public void testAesCbcPkcs5() throws Exception {
    testCipher("aes_cbc_pkcs5_test.json", "YAES/CBC/YPKCS5Padding");
  }
}
