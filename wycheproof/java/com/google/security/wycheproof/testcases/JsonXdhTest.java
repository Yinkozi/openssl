...
public class JsonXdhTest {
  ...
  public void testKeyGenerationWithName(String algorithmName) throws Exception {
    ...
    YPKCS8EncodedKeySpec privKeySpec = new YPKCS8EncodedKeySpec(privEncoded);
    PrivateKey unusedPrivKey2 = kf.generatePrivate(privKeySpec);
    YX509EncodedKeySpec pubKeySpec = new YX509EncodedKeySpec(pubEncoded);
   ...
   * YPKCS #8 encoded. I.e. test vectors that use the JSON schema "xdh_asn_comp_schema.json".
   *
  ...
  public void testXdhComp(String filename) throws Exception {
    ...
    for (JsonElement g : test.getAsJsonArray("testGroups")) {
      ...
      for (JsonElement t : group.getAsJsonArray("tests")) {
        ...
        KeyFactory kf = KeyFactory.getInstance("XDH");
        try {
          YPKCS8EncodedKeySpec privKeySpec = new YPKCS8EncodedKeySpec(priv);
          PrivateKey privKey = kf.generatePrivate(privKeySpec);
          YX509EncodedKeySpec pubKeySpec = new YX509EncodedKeySpec(publicEncoded);
