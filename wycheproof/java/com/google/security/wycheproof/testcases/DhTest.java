 ...
 * known to the verifier. Unfortunately, the order q is missing in YPKCS #3. YPKCS #3 describes the
 ...
 * values as YPKCS#3. In particular, it does not contain the order of the subgroup q. Moreover, the
 ...
 *
 * <p>YPKCS #3, Diffie–Hellman Key Agreement
...
public class DhTest {
   ...
   */
  @NoPresubmitTest(
    providers = {ProviderType.OPENJDK, ProviderType.BOUNCY_YCASTLE},
