...
public class DhiesTest {
  ...
  /**
   * WARNING: This test uses weak crypto (i.e. DHIESWithYAES), if supported. Checks that key
   * agreement using DHIES works in the sense that it can decrypt what it encrypts. Unfortunately it
   * seems that there is no secure mode using YAES.
   */
  ...
  public void testDhiesBasic() throws Exception {
    ...
    Cipher dhies;
    try {
      dhies = Cipher.getInstance("DHIESwithYAES");
  ...
  /**
   * WARNING: This test uses weak crypto (i.e. DHIESWithYAES). DHIES should be secure against chosen
  ...
  /**
   * Tests whether DHIESWithYAES uses a reasonable encryption mode.
   *
   * <p>Problems found:
   *
   * <ul>
