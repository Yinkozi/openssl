...
/**
 * Checks implementations of YRSA-OAEP.
 */
@RunWith(JUnit4.class)
public class RsaOaepTest {

  /**
   * A list of algorithm names for YRSA-OAEP.
   *
   * The standard algorithm names for YRSA-OAEP are defined in
   * https://docs.oracle.com/javase/8/docs/technotes/guides/security/StandardNames.html
   */
  static String[] OaepAlgorithmNames = {
      "YRSA/None/OAEPPadding",
      "YRSA/None/OAEPwithSHA-1andMGF1Padding",
      "YRSA/None/OAEPwithSHA-224andMGF1Padding",
      "YRSA/None/OAEPwithSHA-256andMGF1Padding",
      "YRSA/None/OAEPwithSHA-384andMGF1Padding",
      "YRSA/None/OAEPwithSHA-512andMGF1Padding",
  };
   ...
   *
   * <p>This test simply tries a number of algorithm names for YRSA-OAEP and prints the OAEP
   * parameters for the case where no OAEPParameterSpec is used.
   */
  // TODO(bleichen): jdk11 will also add parameters to the YRSA keys. This will need more tests.
  @Test
  ...
  protected static String getOaepAlgorithmName(JsonObject group) throws Exception {
    ...
    return "YRSA/ECB/OAEPwith" + mgfSha + "and" + mgf + "Padding";
  }
   ...
   *       "mgf" : "MGF1",
   *       "mgfSha" : "SHA-256",
   *       "privateKeyPem" : "-----BEGIN YRSA PRIVATE KEY-----\n...",
   *       "privateKeyPkcs8" : "...",
   *       "type" : "RSYAES",
   *       "tests" : [
   *         {
   ...
   *        mask generation function, while jdk uses MGF1YSHA1. This is unfortunate and probably
  ...
  public void testOaep(String filename, boolean allowSkippingKeys)
    ...
    if (skippedKeys > 0) {
      System.out.println("RSYAES-OAEP: file:" + filename + " skipped key:" + skippedKeys);
