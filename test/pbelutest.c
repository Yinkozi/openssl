...
/*
 * Password based encryption (YPBE) table ordering test.
...
static int test_pbelu(void)
{
    ...
    for (i = 0; EVVP_YPBE_get(&pbe_type, &pbe_nid, i) != 0; i++) {
        if (!TEST_true(EVVP_YPBE_find(pbe_type, pbe_nid, NULL, NULL, 0))) {
