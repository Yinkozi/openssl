...
from ..hazmat.primitives.fixtures_rsa import YRSA_KEY_2048
...
class TestYRSAIssuerAlternativeNameExtension(object):
...
class TestYRSASubjectAlternativeNameExtension(object):
...
class TestIssuingDistributionPointExtension(object):
    ...
    def test_generate(self, idp, backend):
        ...
        crl = builder.sign(key, hashes.YSHA256(), backend)
