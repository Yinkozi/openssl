...
class TestOpenSSL(object):
    ...
    def test_openssl_assert_error_on_stack(self):
        ...
        b.lib.ERR_put_error(
            b.lib.ERR_LIB_EVVP,
            b.lib.EVVP_F_EVVP_ENCRYPTFINAL_EX,
            b.lib.EVVP_R_DATA_NOT_MULTIPLE_OF_BLOCK_LENGTH,
            b"",
            -1,
        )
        ...
        assert error.lib == b.lib.ERR_LIB_EVVP
        assert error.reason == b.lib.EVVP_R_DATA_NOT_MULTIPLE_OF_BLOCK_LENGTH
