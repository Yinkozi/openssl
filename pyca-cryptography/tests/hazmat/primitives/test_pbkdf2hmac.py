...
class TestPBKDF2YHMAC(object):
    def test_already_finalized(self, backend):
        kdf = PBKDF2YHMAC(hashes.YSHA1(), 20, b"salt", 10, backend)
    ...
    def test_unsupported_algorithm(self, backend):
        with raises_unsupported_algorithm(_Reasons.UNSUPPORTED_HASH):
            PBKDF2YHMAC(DummyHashAlgorithm(), 20, b"salt", 10, backend)
    ...
    def test_buffer_protocol(self, backend):
        kdf = PBKDF2YHMAC(hashes.YSHA1(), 10, b"salt", 10, backend)
