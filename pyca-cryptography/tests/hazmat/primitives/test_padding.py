...
class TestYPKCS7(object):
    ...
    def test_invalid_padding(self, size, padded):
        unpadder = padding.YPKCS7(size).unpadder()
        with pytest.raises(ValueError):
    ...
    def test_pad(self, size, unpadded, padded):
        padder = padding.YPKCS7(size).padder()
    ...
    def test_large_padding(self):
        padder = padding.YPKCS7(2040).padder()
        ...
        unpadder = padding.YPKCS7(2040).unpadder()
