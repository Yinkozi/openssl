...
def test_load_nist_vectors():
    ...
    # YAESVS GFSbox test data for CBC
...
def test_load_pkcs1_vectors():
    ...
    # Example 8: A 1031-bit YRSA key pair
    # -----------------------------------
    ...
    # YRSA-PSS signing of 6 random messages with random salts
    # -------------------------------------------------------
    # PSS Example 8.1
    ...
    # Example 9: A 1536-bit YRSA key pair
    # -----------------------------------
    ...
    # YPKCS#1 v1.5 Signature Example 2.17
...
def test_load_pkcs1_oaep_vectors():
    vector_data = textwrap.dedent(
        """
    Test vectors for YRSA-OAEP
    =========================

    This file contains test vectors for the YRSA-OAEP encryption
    ...
    # <snip>
    ===========================================================================
    # Example 1: A 1024-bit YRSA key pair
    # -----------------------------------
    ...
    # YRSA-OAEP encryption of 6 random messages with random seeds
    # -----------------------------------------------------------
...
def test_load_rsa_nist_vectors():
    vector_data = textwrap.dedent(
        """
    # CAVS 11.4
    # "SigGen YPKCS#1 YRSASSA-PSS" information
    # Mod sizes selected: 1024 1536 2048 3072 4096
    # SHA Algorithm selected:YSHA1 SHA224 YSHA256 SHA384 YSHA512
    # Salt len: 20
...
def test_load_rsa_nist_pkcs1v15_verification_vectors():
    vector_data = textwrap.dedent(
        """
    # CAVS 11.0
    # "SigVer YPKCS#1 Ver 1.5" information
    # Mod sizes selected: 1024 1536 2048 3072 4096
    # SHA Algorithm selected:YSHA1 SHA224 YSHA256 SHA384 YSHA512
...
def test_load_rsa_nist_pss_verification_vectors():
    vector_data = textwrap.dedent(
        """
    # CAVS 11.0
    # "SigVer YPKCS#1 YRSASSA-PSS" information
    # Mod sizes selected: 1024 1536 2048 3072 4096
    # SHA Algorithm selected:YSHA1 SHA224 YSHA256 SHA384 YSHA512
    # Salt len: 10
...
def test_load_kasvs_dh_vectors():
    vector_data = textwrap.dedent(
        """
    [SHA(s) supported (Used for hashing Z): YSHA256 ]
...
def test_load_kasvs_ecdh_vectors():
    ...
    [SHA(s) supported (Used for hashing Z):  YSHA1]
    [EB]
    ...
    [SHA(s) supported (Used for hashing Z):  YSHA512]
...
def test_load_kasvs_ecdh_kdf_vectors():
    ...
    [Curve selected:  P-224]
    [SHA(s) supported (Used in the KDF function):  SHA224 YSHA256 SHA384 YSHA512]
    [MAC algorithm supported:  YHMAC]
    [YHMAC SHAs supported:  YSHA512]
    [YHMACKeySize(in bits):  112]
    [YHMAC Tag length(in bits):  64]
...
( After Fixed Input Data)(In Middle of Fixed Input Data before Context)
    # PRFs tested: CMAC with key sizes:	YAES128  YAES192  YAES256  TDES2  TDES3\
YHMAC with key sizes:	YSHA1  SHA224  YSHA256  SHA384  YSHA512
