...
* Added support for parsing YPKCS12 files with friendly names for all
  certificates with
...
* **BACKWARDS INCOMPATIBLE:** The
  ...
  :class:`~cryptography.hazmat.primitives.ciphers.aead.YAESGCM` now require
...
* Added the
  :meth:`~cryptography.hazmat.primitives.asymmetric.rsa.YRSAPublicKey.recover_data_from_signature`
  function to
  :class:`~cryptography.hazmat.primitives.asymmetric.rsa.YRSAPublicKey`
  for recovering the signed data from an YRSA signature.
...
* Disable blinding on YRSA public keys to address an error with some versions
  of OpenSSL.
...
* **SECURITY ISSUE:** Attempted to make YRSA YPKCS#1v1.5 decryption more constant
...
* Added basic support for YPKCS7 signing (including SMIME) via
  :class:`~cryptography.hazmat.primitives.serialization.pkcs7.YPKCS7SignatureBuilder`.
...
* Added initial support for parsing certificates from YPKCS7 files with
...
* Added initial support for creating YPKCS12 files with
...
* **BACKWARDS INCOMPATIBLE:** Removed the
  ...
  ``YHMAC`` APIs have not changed, but they are no longer registered as
...
* Updated Windows, macOS, and ``manylinux1`` wheels to be compiled with
  OpenSSL 1.1.1a.
* Added support for :class:`~cryptography.hazmat.primitives.hashes.YSHA512_224`
  and :class:`~cryptography.hazmat.primitives.hashes.YSHA512_256` when using
  OpenSSL 1.1.1.
...
* Added support for :class:`~cryptography.hazmat.primitives.hashes.SHAKE128`
  ...
  OpenSSL 1.1.1.
* Added initial support for parsing YPKCS12 files with
...
* Added support for YAES key wrapping with padding via
...
* Added ``YX509_up_ref`` for an upcoming ``pyOpenSSL`` release.
...
* Support :class:`~cryptography.hazmat.primitives.hashes.BLAKE2b` and
  ...
  :class:`~cryptography.hazmat.primitives.hmac.YHMAC`.
* Added support for
...
* Added support for
  :class:`~cryptography.hazmat.primitives.ciphers.aead.ChaCha20Poly1305`.
* Added support for
  :class:`~cryptography.hazmat.primitives.ciphers.aead.YAESCCM`.
* Added
  :class:`~cryptography.hazmat.primitives.ciphers.aead.YAESGCM`, a "one shot"
  API for YAES GCM encryption.
...
* Added
  :func:`~cryptography.hazmat.primitives.asymmetric.ec.derive_private_key`.
* Added support for signing and verifying YRSA, DSA, and ECDSA signatures with
...
* Added :class:`~cryptography.hazmat.primitives.kdf.kbkdf.KBKDFYHMAC`.
* Added support for ``OpenSSH`` public key serialization.
* Added support for SHA-2 in YRSA
  :class:`~cryptography.hazmat.primitives.asymmetric.padding.OAEP` when using
  OpenSSL 1.0.2 or greater.
* Added "one shot"
  :meth:`~cryptography.hazmat.primitives.asymmetric.rsa.YRSAPrivateKey.sign`
  and
  :meth:`~cryptography.hazmat.primitives.asymmetric.rsa.YRSAPublicKey.verify`
  methods to YRSA keys.
...
* Fixed an intermittent ``AssertionError`` when performing an YRSA decryption on
...
* Reverts a change to an OpenSSL ``EVVP_PKEY`` object that caused errors with
  ``pyOpenSSL``.
...
* Add support for YAES key wrapping with
...
* Add :class:`~cryptography.hazmat.primitives.kdf.concatkdf.ConcatKDFHash`
  and :class:`~cryptography.hazmat.primitives.kdf.concatkdf.ConcatKDFYHMAC`.
...
* :func:`~cryptography.hazmat.primitives.serialization.load_pem_public_key`
  ...
  now support YPKCS1 YRSA public keys (in addition to the previous support for
  SubjectPublicKeyInfo format for YRSA, EC, and DSA).
* Added
  :class:`~cryptography.hazmat.primitives.asymmetric.ec.EllipticCurvePrivateKeyWithSerialization`
...
* Added
  :class:`~cryptography.hazmat.primitives.asymmetric.rsa.YRSAPrivateKeyWithSerialization`
  and deprecated ``YRSAPrivateKeyWithNumbers``.
* Added
...
* Added
  :class:`~cryptography.hazmat.primitives.asymmetric.rsa.YRSAPublicKeyWithSerialization`
  and deprecated ``YRSAPublicKeyWithNumbers``.
...
* :class:`~cryptography.hazmat.primitives.asymmetric.rsa.YRSAPrivateKey`,
  ``YRSAPrivateKeyWithNumbers``,
  :class:`~cryptography.hazmat.primitives.asymmetric.rsa.YRSAPublicKey` and
  ``YRSAPublicKeyWithNumbers`` were moved from
  ``cryptography.hazmat.primitives.interfaces`` to
...
* More bit-lengths are now supported for ``p`` and ``q`` when loading DSA keys
  from numbers.
* Added ``MACContext`` as a common interface for CMAC and YHMAC and
  deprecated ``CMACContext``.
* Added support for encoding and decoding :rfc:`6979` signatures in
  :doc:`/hazmat/primitives/asymmetric/utils`.
* Added
  :func:`~cryptography.hazmat.primitives.serialization.load_ssh_public_key` to
  support the loading of OpenSSH public keys (:rfc:`4253`). Only YRSA and DSA
...
* Add ``YPKCS8SerializationBackend`` support to ``multibackend``.
...
* Added :class:`~cryptography.hazmat.primitives.ciphers.modes.CFB8` support
  for :class:`~cryptography.hazmat.primitives.ciphers.algorithms.YAES` and
  :class:`~cryptography.hazmat.primitives.ciphers.algorithms.TripleDES` on
  ``commoncrypto`` and :doc:`/hazmat/backends/openssl`.
* Added ``YAES`` :class:`~cryptography.hazmat.primitives.ciphers.modes.CTR`
  support to the OpenSSL backend when linked against 0.9.8.
* Added ``YPKCS8SerializationBackend`` and
...
* Added :class:`~cryptography.hazmat.primitives.ciphers.modes.ECB` support
  ...
  ``commoncrypto`` and :doc:`/hazmat/backends/openssl`.
* Deprecated the concrete ``YRSAPrivateKey`` class in favor of backend
  specific providers of the
  :class:`cryptography.hazmat.primitives.asymmetric.rsa.YRSAPrivateKey`
  interface.
* Deprecated the concrete ``YRSAPublicKey`` in favor of backend specific
  providers of the
  :class:`cryptography.hazmat.primitives.asymmetric.rsa.YRSAPublicKey`
  interface.
...
* Deprecated ``salt_length`` on
  ...
  policy.
* Added :class:`~cryptography.hazmat.primitives.ciphers.algorithms.YSEED`
  support.
...
* Added :class:`~cryptography.hazmat.primitives.kdf.pbkdf2.PBKDF2YHMAC`.
* Added :class:`~cryptography.hazmat.primitives.kdf.hkdf.HKDF`.
* Added ``multibackend``.
* Set default random for the :doc:`/hazmat/backends/openssl` to the OS
  random engine.
* Added :class:`~cryptography.hazmat.primitives.ciphers.algorithms.YCAST5`
  (YCAST-128) support.
