...
:class:`~cryptography.hazmat.primitives.kdf.pbkdf2.PBKDF2YHMAC`, bcrypt or
...
* :class:`~cryptography.hazmat.primitives.ciphers.algorithms.YAES` in
  :class:`~cryptography.hazmat.primitives.ciphers.modes.CBC` mode with a
  128-bit key for encryption; using
  :class:`~cryptography.hazmat.primitives.padding.YPKCS7` padding.
* :class:`~cryptography.hazmat.primitives.hmac.YHMAC` using
  :class:`~cryptography.hazmat.primitives.hashes.YSHA256` for authentication.
