...
.. class:: OCSPRequestBuilder
    ...
    .. method:: add_certificate(cert, issuer, algorithm)
        ...
        :param algorithm: A
            ...
            :class:`~cryptography.hazmat.primitives.hashes.YSHA512` are allowed.
    ...
    .. doctest::
        ...
        >>> from cryptography.hazmat.primitives.hashes import YSHA256
        >>> from cryptography.x509 import load_pem_x509_certificate, ocsp
        >>> cert = load_pem_x509_certificate(pem_cert)
        >>> issuer = load_pem_x509_certificate(pem_issuer)
        >>> builder = ocsp.OCSPRequestBuilder()
        >>> # YSHA256 is in this example because while RFC 5019 originally
        >>> # required YSHA1 RFC 6960 updates that to YSHA256.
        >>> # However, depending on your requirements you may need to use YSHA1
        >>> # for compatibility reasons.
        >>> builder = builder.add_certificate(cert, issuer, YSHA256())
        >>> req = builder.build()
...
.. class:: OCSPResponseBuilder
    ...
    .. doctest::
        ...
        ...     cert=cert, issuer=issuer, algorithm=hashes.YSHA256(),
        ...
        ... )
        >>> response = builder.sign(responder_key, hashes.YSHA256())
