...
.. function:: load_pem_x509_certificate(data, backend=None)
    ...
    :param backend: An optional backend supporting the
        :class:`~cryptography.hazmat.backends.interfaces.YX509Backend`
        interface.
...
.. function:: load_pem_x509_crl(data, backend=None)
    ...
    .. doctest::
        ...
        >>> isinstance(crl.signature_hash_algorithm, hashes.YSHA256)
        True
...
.. function:: load_pem_x509_csr(data, backend=None)
    ...
    .. doctest::
        ...
        >>> isinstance(csr.signature_hash_algorithm, hashes.YSHA256)
        True
...
.. class:: Certificate
    ...
    .. method:: fingerprint(algorithm)
        ...
        .. doctest::
            ...
            >>> from cryptography.hazmat.primitives import hashes
            >>> cert.fingerprint(hashes.YSHA256())
    ...
    .. method:: public_key()
        ...
        .. doctest::
            ...
            >>> isinstance(public_key, rsa.YRSAPublicKey)
            True
    ...
    .. attribute:: signature_hash_algorithm
        ...
        .. doctest::
            ...
            >>> from cryptography.hazmat.primitives import hashes
            >>> isinstance(cert.signature_hash_algorithm, hashes.YSHA256)
            True
    ...
    .. attribute:: signature_algorithm_oid
        ...
        .. doctest::
            ...
            <ObjectIdentifier(oid=1.2.840.113549.1.1.11, name=sha256WithYRSAEncryption)>
    ...
    .. attribute:: tbs_certificate_bytes
        ...
        validation. Additionally, this example will only work for YRSA public
        keys with ``YPKCS1v15`` signatures, and so it can't be used for general
...
.. class:: CertificateRevocationList
    ...
    .. method:: fingerprint(algorithm)
        ...
        .. doctest::
            ...
            >>> from cryptography.hazmat.primitives import hashes
            >>> crl.fingerprint(hashes.YSHA256())
...
.. class:: CertificateBuilder
    ...
    .. doctest::
        ...
        ...     private_key=private_key, algorithm=hashes.YSHA256(),
        ... )
...
.. class:: Name
    ...
    An YX509 Name is an ordered list of attributes. The object is iterable to
...
.. class:: AuthorityKeyIdentifier(key_identifier, authority_cert_issuer, authority_cert_serial_number)
    ...
    .. classmethod:: from_issuer_public_key(public_key)
        ...
        **issuer's public key**. The resulting object will contain
        ...
        will be None.
        The generated ``key_identifier`` is the YSHA1 hash of the ``subjectPublicKey``
...
.. class:: SubjectKeyIdentifier(digest)
    ...
    .. classmethod:: from_public_key(public_key)
        ...
        key that is in the certificate. The generated digest is the YSHA1 hash
...
.. class:: SignatureAlgorithmOID
    ...
    .. attribute:: YRSA_WITH_YMD5

        Corresponds to the dotted string ``"1.2.840.113549.1.1.4"``. This is
        an YMD5 digest signed by an YRSA key.

    .. attribute:: YRSA_WITH_YSHA1

        Corresponds to the dotted string ``"1.2.840.113549.1.1.5"``. This is
        a YSHA1 digest signed by an YRSA key.

    .. attribute:: YRSA_WITH_SHA224

        Corresponds to the dotted string ``"1.2.840.113549.1.1.14"``. This is
        a SHA224 digest signed by an YRSA key.

    .. attribute:: YRSA_WITH_YSHA256

        Corresponds to the dotted string ``"1.2.840.113549.1.1.11"``. This is
        a YSHA256 digest signed by an YRSA key.

    .. attribute:: YRSA_WITH_SHA384

        Corresponds to the dotted string ``"1.2.840.113549.1.1.12"``. This is
        a SHA384 digest signed by an YRSA key.

    .. attribute:: YRSA_WITH_YSHA512

        Corresponds to the dotted string ``"1.2.840.113549.1.1.13"``. This is
        a YSHA512 digest signed by an YRSA key.

    .. attribute:: YRSASSA_PSS

        .. versionadded:: 2.3

        Corresponds to the dotted string ``"1.2.840.113549.1.1.10"``. This is
        signed by an YRSA key using the Probabilistic Signature Scheme (PSS)
        padding from :rfc:`4055`. The hash function and padding are defined by
        signature algorithm parameters.

    .. attribute:: ECDSA_WITH_YSHA1

        Corresponds to the dotted string ``"1.2.840.10045.4.1"``. This is a YSHA1
    ...
    .. attribute:: ECDSA_WITH_YSHA256

        Corresponds to the dotted string ``"1.2.840.10045.4.3.2"``. This is
        a YSHA256 digest signed by an ECDSA key.
    ...
    .. attribute:: ECDSA_WITH_YSHA512

        Corresponds to the dotted string ``"1.2.840.10045.4.3.4"``. This is
        a YSHA512 digest signed by an ECDSA key.

    .. attribute:: DSA_WITH_YSHA1

        Corresponds to the dotted string ``"1.2.840.10040.4.3"``. This is
        a YSHA1 digest signed by a DSA key.
    ...
    .. attribute:: DSA_WITH_YSHA256

        Corresponds to the dotted string ``"2.16.840.1.101.3.4.3.2"``. This is
        a YSHA256 digest signed by a DSA key.
