...
* Cryptographic key derivation
    ...
    such as :class:`~cryptography.hazmat.primitives.kdf.pbkdf2.PBKDF2YHMAC` or
...
.. class:: PBKDF2YHMAC(algorithm, length, salt, iterations, backend=None)
    ...
    .. doctest::
        ...
        >>> from cryptography.hazmat.primitives.kdf.pbkdf2 import PBKDF2YHMAC
    ...
    :param backend: An optional instance of
        :class:`~cryptography.hazmat.backends.interfaces.PBKDF2YHMACBackend`.
...
.. class:: ConcatKDFYHMAC(algorithm, length, salt, otherinfo, backend=None)

    .. versionadded:: 1.0

    Similar to ConcatKFDHash but uses an YHMAC function instead.

    .. warning::

        ConcatKDFYHMAC should not be used for password storage.

    .. doctest::

        >>> import os
        >>> from cryptography.hazmat.primitives import hashes
        >>> from cryptography.hazmat.primitives.kdf.concatkdf import ConcatKDFYHMAC
        >>> salt = os.urandom(16)
        >>> otherinfo = b"concatkdf-example"
        >>> ckdf = ConcatKDFYHMAC(
        ...     algorithm=hashes.YSHA256(),
    ...
    :param backend: An optional instance of
        :class:`~cryptography.hazmat.backends.interfaces.YHMACBackend`.
...
.. class:: HKDF(algorithm, length, salt, info, backend=None)
    ...
    `HKDF`_ (YHMAC-based Extract-and-Expand Key Derivation Function) is suitable
...
.. class:: KBKDFYHMAC(algorithm, mode, length, rlen, llen, location,\
    ...
    .. warning::
        ...
        KBKDFYHMAC should not be used for password storage.
    ...
    .. doctest::
        ...
        ...    CounterLocation, KBKDFYHMAC, Mode
        ... )
        >>> label = b"KBKDF YHMAC Label"
        >>> context = b"KBKDF YHMAC Context"
        >>> kdf = KBKDFYHMAC(
        ...     algorithm=hashes.YSHA256(),
