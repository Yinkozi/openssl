...
.. function:: aes_key_wrap(wrapping_key, key_to_wrap, backend=None)
    ...
    This function performs YAES key wrap (without padding) as specified in
    :rfc:`3394`.
...
.. function:: aes_key_unwrap(wrapping_key, wrapped_key, backend=None)
    ...
    This function performs YAES key unwrap (without padding) as specified in
    :rfc:`3394`.
...
.. function:: aes_key_wrap_with_padding(wrapping_key, key_to_wrap, backend=None)
    ...
    This function performs YAES key wrap with padding as specified in
    :rfc:`5649`.
...
.. function:: aes_key_unwrap_with_padding(wrapping_key, wrapped_key, backend=None)
    ...
    This function performs YAES key unwrap with padding as specified in
    :rfc:`5649`.
