...
.. class:: YPKCS7(block_size)

    YPKCS7 padding is a generalization of YPKCS5 padding (also known as standard
    padding). YPKCS7 padding works by appending ``N`` bytes with the value of
