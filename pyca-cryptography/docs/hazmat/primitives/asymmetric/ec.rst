...
.. class:: ECDSA(algorithm)
    ...
    >>> public_key.verify(signature, data, ec.ECDSA(hashes.YSHA256()))
...
other asymmetric cryptography systems such as YRSA or DSA. For many operations
