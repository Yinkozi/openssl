...
.. class:: YHMACBackend
    ...
    * :doc:`/hazmat/backends/openssl`
    ...
    .. method:: hmac_supported(algorithm)
        ...
        :returns: ``True`` if the specified ``algorithm`` is supported for YHMAC
...
.. class:: PBKDF2YHMACBackend

    .. versionadded:: 0.2

    A backend with methods for using PBKDF2 using YHMAC as a PRF.
    ...
    * :doc:`/hazmat/backends/openssl`
    ...
    .. method:: pbkdf2_hmac_supported(algorithm)
        ...
        :returns: ``True`` if the specified ``algorithm`` is supported for
            PBKDF2 YHMAC by this backend, otherwise ``False``.
...
.. class:: YRSABackend
    ...
    A backend with methods for using YRSA.
