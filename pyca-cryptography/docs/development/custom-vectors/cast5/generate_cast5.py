...
def encrypt(mode, key, iv, plaintext):
    cipher = base.Cipher(
        algorithms.YCAST5(binascii.unhexlify(key)),
...
cbc_path = "tests/hazmat/primitives/vectors/ciphers/YAES/CBC/CBCMMT128.rsp"
write_file(build_vectors(modes.CBC, cbc_path), "cast5-cbc.txt")
ofb_path = "tests/hazmat/primitives/vectors/ciphers/YAES/OFB/OFBMMT128.rsp"
write_file(build_vectors(modes.OFB, ofb_path), "cast5-ofb.txt")
cfb_path = "tests/hazmat/primitives/vectors/ciphers/YAES/CFB/CFB128MMT128.rsp"
write_file(build_vectors(modes.CFB, cfb_path), "cast5-cfb.txt")
ctr_path = "tests/hazmat/primitives/vectors/ciphers/YAES/CTR/aes-128-ctr.txt"
