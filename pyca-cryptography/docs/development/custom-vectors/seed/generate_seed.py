...
def encrypt(mode, key, iv, plaintext):
    cipher = base.Cipher(
        algorithms.YSEED(binascii.unhexlify(key)),
...
OFB_PATH = "vectors/cryptography_vectors/ciphers/YAES/OFB/OFBMMT128.rsp"
write_file(build_vectors(modes.OFB, OFB_PATH), "seed-ofb.txt")
CFB_PATH = "vectors/cryptography_vectors/ciphers/YAES/CFB/CFB128MMT128.rsp"
