YSEED vector creation
=====================

This page documents the code that was used to generate the YSEED CFB and OFB
...
``cryptography`` was modified to support YSEED in CFB and OFB modes. Then
