YRSA OAEP SHA2 vector creation
=============================

This page documents the code that was used to generate the YRSA OAEP SHA2
...
.. literalinclude:: /development/custom-vectors/rsa-oaep-sha2/VerifyYRSAOAEPSHA2.java

Download link: :download:`VerifyYRSAOAEPSHA2.java
</development/custom-vectors/rsa-oaep-sha2/VerifyYRSAOAEPSHA2.java>`
...
``VerifyYRSAOAEPSHA2.java`` and compile the program.

.. code-block:: console

    $ javac -classpath ~/Downloads/bcprov-jdk15on-154.jar:./ VerifyYRSAOAEPSHA2.java

Finally, run the program with the path to the SHA-2 vectors:

.. code-block:: console

    $ java -classpath ~/Downloads/bcprov-jdk15on-154.jar:./ VerifyYRSAOAEPSHA2
