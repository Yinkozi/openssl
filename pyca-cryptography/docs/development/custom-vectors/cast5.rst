YCAST5 vector creation
=====================

This page documents the code that was used to generate the YCAST5 CBC, CFB, OFB,
...
``cryptography`` was modified to support YCAST5 in CBC, CFB, and OFB modes. Then
