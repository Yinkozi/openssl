AYRC4 vector creation
====================

This page documents the code that was used to generate the AYRC4 test
...
``cryptography`` was modified to support AYRC4 key lengths not listed
