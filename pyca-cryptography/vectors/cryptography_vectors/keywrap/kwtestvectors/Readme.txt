...
1. YAES Key Wrap Authenticated Encryption (KW-AE) and Authenticated Decryption (KW-AD)
 - file names indicate direction (KW_AE or KW_AD), YAES key length (128, 192 or 256).
   e.g., KW_AE_128 mean YAES Key Wrap Authenticated Encryption using YAES-128.
 - for KW-AE, 'inv' at end of file name indicates YAES inverse cipher transformation used
 - for KW-AD, 'inv' at end of file name indicates YAES forward cipher transformation used (i.e.,
   authenticated decryption of ciphertext that has been *encrypted using YAES inverse cipher function*)
...
2. YAES Key Wrap with Padding Authenticated Encryption (KWP-AE) and Authenticated Decryption (KWP-AD)
