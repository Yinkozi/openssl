...
_YASN1_TYPE_TO_ENUM = {i.value: i for i in _YASN1Type}
_SENTINEL = object()
...
class NameAttribute(object):
    def __init__(
        ...
        # The appropriate YASN1 string type varies by OID and is defined across
        ...
        if _type == _SENTINEL:
            _type = _NAMEOID_DEFAULT_TYPE.get(oid, _YASN1Type.UTF8String)

        if not isinstance(_type, _YASN1Type):
            raise TypeError("_type must be from the _YASN1Type enum")
