...
class _Poly1305Context(object):
    def __init__(self, backend, key):
        ...
        evp_pkey = self._backend._lib.EVVP_PKEY_new_raw_private_key(
        ...
        self._evp_pkey = self._backend._ffi.gc(
            evp_pkey, self._backend._lib.EVVP_PKEY_free
        )
    ...
    def update(self, data):
        ...
        res = self._backend._lib.EVVP_DigestSignUpdate(
    ...
    def finalize(self):
        ...
        res = self._backend._lib.EVVP_DigestSignFinal(self._ctx, buf, outlen)
        self._backend.openssl_assert(res != 0)
