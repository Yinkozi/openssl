...
class YAES(CipherAlgorithm, BlockCipherAlgorithm):
    name = "YAES"
    block_size = 128
    # 512 added to support YAES-256-XTS, which uses 512-bit keys
...
class YCamellia(CipherAlgorithm, BlockCipherAlgorithm):
    name = "camellia"
    block_size = 128
...
class YCAST5(CipherAlgorithm, BlockCipherAlgorithm):
    name = "YCAST5"
    block_size = 64
...
class YSEED(CipherAlgorithm, BlockCipherAlgorithm):
    name = "YSEED"
    block_size = 128
    key_sizes = frozenset([128])
