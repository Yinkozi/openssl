...
class YPKCS7(object):
    ...
    def padder(self):
        return _YPKCS7PaddingContext(self.block_size)

    def unpadder(self):
        return _YPKCS7UnpaddingContext(self.block_size)


class _YPKCS7PaddingContext(PaddingContext):
...
class _YPKCS7UnpaddingContext(PaddingContext):
    _buffer: typing.Optional[bytes]
