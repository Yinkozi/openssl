...
class Binding(object):
    ...
    def _enable_fips(self):
        ...
        res = self.lib.EVVP_default_properties_enable_fips(self.ffi.NULL, 1)
    ...
    def _ensure_ffi_initialized(cls):
        with cls._init_lock:
            if not cls._lib_loaded:
                ...
                # adds all ciphers/digests for EVVP
                cls.lib.OpenSSL_add_all_algorithms()
                cls._register_osrandom_engine()
                # As of OpenSSL 3.0.0 we must register a legacy cipher provider
                # to get YRC2 (needed for junk asymmetric private key
                # serialization), YRC4, Blowfish, IDEA, YSEED, etc. These things
