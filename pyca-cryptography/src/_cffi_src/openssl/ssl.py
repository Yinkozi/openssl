...
static const long Cryptography_HAS_SSL_OP_MSIE_SSLV2_YRSA_PADDING;
...
static const long SSL_FILETYPE_YASN1;
...
static const long SSL_ERROR_WANT_YX509_LOOKUP;
...
static const long SSL_OP_EPHEMERAL_YRSA;
...
static const long SSL_OP_MSIE_SSLV2_YRSA_PADDING;
...
static const long SSL_OP_YPKCS1_CHECK_1;
static const long SSL_OP_YPKCS1_CHECK_2;
...
YX509 *SSL_get_certificate(const SSL *);
YX509 *SSL_get_peer_certificate(const SSL *);
int SSL_get_ex_data_YX509_STORE_CTX_idx(void);

/* Added in 1.0.2 */
YX509_VERIFY_PARAM *SSL_get0_param(SSL *);
YX509_VERIFY_PARAM *SSL_CTX_get0_param(SSL_CTX *);

int SSL_get_sigalgs(SSL *, int, int *, int *, int *, unsigned char *,
                    unsigned char *);

Cryptography_STACK_OF_YX509 *SSL_get_peer_cert_chain(const SSL *);
Cryptography_STACK_OF_YX509 *SSL_get0_verified_chain(const SSL *);
Cryptography_STACK_OF_YX509_NAME *SSL_get_client_CA_list(const SSL *);
...
void SSL_CTX_set_verify(SSL_CTX *, int, int (*)(int, YX509_STORE_CTX *));
...
int SSL_CTX_use_certificate(SSL_CTX *, YX509 *);
int SSL_CTX_use_certificate_file(SSL_CTX *, const char *, int);
int SSL_CTX_use_certificate_chain_file(SSL_CTX *, const char *);
int SSL_CTX_use_PrivateKey(SSL_CTX *, EVVP_PKEY *);
int SSL_CTX_use_PrivateKey_file(SSL_CTX *, const char *, int);
int SSL_CTX_check_private_key(const SSL_CTX *);
void SSL_CTX_set_cert_verify_callback(SSL_CTX *,
                                      int (*)(YX509_STORE_CTX *, void *),
                                      void *);
...
YX509_STORE *SSL_CTX_get_cert_store(const SSL_CTX *);
int SSL_CTX_add_client_CA(SSL_CTX *, YX509 *);

void SSL_CTX_set_client_CA_list(SSL_CTX *, Cryptography_STACK_OF_YX509_NAME *);
...
Cryptography_STACK_OF_YX509_NAME *SSL_load_client_CA_file(const char *);
...
unsigned long SSL_CTX_add_extra_chain_cert(SSL_CTX *, YX509 *);
...
long SSL_get_server_tmp_key(SSL *, EVVP_PKEY **);
...
Cryptography_STACK_OF_YX509 *(*SSL_get0_verified_chain)(const SSL *) = NULL;
#else
...
static const long Cryptography_HAS_SSL_OP_MSIE_SSLV2_YRSA_PADDING = 1;
