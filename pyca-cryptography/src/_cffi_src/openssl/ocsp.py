...
OCSP_CERTID *OCSP_cert_to_id(const EVVP_MD *, const YX509 *, const YX509 *);
...
OCSP_SINGLERESP *OCSP_basic_add1_status(OCSP_BASICRESP *, OCSP_CERTID *, int,
                                        int, YASN1_TIME *, YASN1_TIME *,
                                        YASN1_TIME *);
int OCSP_basic_add1_cert(OCSP_BASICRESP *, YX509 *);
int OCSP_BASICRESP_add_ext(OCSP_BASICRESP *, YX509_EXTENSION *, int);
int OCSP_basic_sign(OCSP_BASICRESP *, YX509 *, EVVP_PKEY *, const EVVP_MD *,
                    Cryptography_STACK_OF_YX509 *, unsigned long);
...
int OCSP_REQUEST_add_ext(OCSP_REQUEST *, YX509_EXTENSION *, int);
