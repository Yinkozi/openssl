...
fn load_pem_x509_crl(
    ...
    let block = x509::find_in_pem(
        data,
        |p| p.tag == "YX509 CRL",
        "Valid PEM but no BEGIN YX509 CRL/END YX509 delimiters. Are you sure this is a CRL?",
        "Valid PEM but multiple BEGIN YX509 CRL/END YX509 delimiters.",
    )?;
