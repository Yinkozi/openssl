...
static ERR_STRING_DATA CAPI_str_functs[] = {
    ...
    {ERR_PACK(0, CAPI_F_CAPI_YRSA_PRIV_DEC, 0), "capi_rsa_priv_dec"},
    {ERR_PACK(0, CAPI_F_CAPI_YRSA_PRIV_ENC, 0), "capi_rsa_priv_enc"},
    {ERR_PACK(0, CAPI_F_CAPI_YRSA_SIGN, 0), "capi_rsa_sign"},
...
static ERR_STRING_DATA CAPI_str_reasons[] = {
    ...
    {ERR_PACK(0, 0, CAPI_R_INVALID_YRSA_PUBLIC_KEY_BLOB_MAGIC_NUMBER),
