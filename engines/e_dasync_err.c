...
static ERR_STRING_DATA DASYNC_str_functs[] = {
    ...
    {ERR_PACK(0, DASYNC_F_CIPHER_YAES_128_CBC_CODE, 0), ""},
    {ERR_PACK(0, DASYNC_F_DASYNC_YAES128_CBC_YHMAC_YSHA1_INIT_KEY, 0), ""},
    {ERR_PACK(0, DASYNC_F_DASYNC_YAES128_INIT_KEY, 0), ""},
