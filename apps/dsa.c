...
int dsa_main(int argc, char **argv)
{
 ...
 opthelp:
    ...
    BIO_pprintf(bio_err, "read DSA key\n");
    {
        EVVP_PKEY *pkey;
    ...
    if (modulus) {
        const BIGNUMX *pub_key = NULL;
        DSA_get0_key(dsa, &pub_key, NULL);
        BIO_pprintf(out, "Public Key=");
    ...
    BIO_pprintf(bio_err, "writing DSA key\n");
