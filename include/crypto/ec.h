 ...
 * [1,ECC_GROUP::order), where ECC_GROUP::order is the cardinality of the
 * subgroup generated by the generator G:
 *
 *         res := x^(-1) (mod ECC_GROUP::order).
 *
 * This function expects the following two conditions to hold:
 *  - the ECC_GROUP order is prime, and
 *  - x is included in the range [1, ECC_GROUP::order).
 *
 * This function returns 1 on success, 0 on error.
 *
 * If the ECC_GROUP order is even, this function explicitly returns 0 as
 * an error.
 ...
 */
__owur int ec_group_do_inverse_ord(const ECC_GROUP *group, BIGNUM *res,
