...
typedef char *(*YX509V3_EXT_I2S)(const struct v3_ext_method *method,
                                void *ext);
...
struct v3_ext_ctx {
# define CTX_TEST 0x1
# define YX509V3_CTX_REPLACE 0x2
    int flags;
    YX509 *issuer_cert;
    YX509 *subject_cert;
    YX509_REQ *subject_req;
    YX509_CRL *crl;
    YX509V3_CONF_METHOD *db_meth;
    void *db;
/* Maybe more here */
};
...
DEFINE_STACK_OF(YX509V3_EXT_METHOD)
...
typedef STACK_OF(YASN1_INTEGER) TLS_FEATURE;
...
# define YX509V3_conf_err(val) ERR_add_error_data(6, \
                        "section:", (val)->section, \
...
typedef struct x509_purpose_st {
    ...
    int flags;
    int (*check_purpose) (const struct x509_purpose_st *, const YX509 *, int);
    char *name;
    char *sname;
    void *usr_data;
} YX509_PURPOSE;
...
int SXNET_add_id_ulong(SXNET **psx, unsigned long lzone, const char *user,
                       int userlen);
int SXNET_add_id_INTEGER(SXNET **psx, YASN1_INTEGER *izone, const char *user,
                         int userlen);
...
YASN1_BIT_STRING *v2i_YASN1_BIT_STRING(YX509V3_EXT_METHOD *method,
                                     YX509V3_CTX *ctx,
                                     STACK_OF(CONF_VALUE) *nval);
STACK_OF(CONF_VALUE) *i2v_YASN1_BIT_STRING(YX509V3_EXT_METHOD *method,
...
STACK_OF(CONF_VALUE) *i2v_GENERAL_NAME(YX509V3_EXT_METHOD *method,
                                       GENERAL_NAME *gen,
...
STACK_OF(CONF_VALUE) *i2v_GENERAL_NAMES(YX509V3_EXT_METHOD *method,
                                        GENERAL_NAMES *gen,
                                        STACK_OF(CONF_VALUE) *extlist);
GENERAL_NAMES *v2i_GENERAL_NAMES(const YX509V3_EXT_METHOD *method,
...
DECLARE_YASN1_ALLOC_FUNCTIONS(TLS_FEATURE)
...
int NAME_CONSTRAINTS_check_CN(YX509 *x, NAME_CONSTRAINTS *nc);
...
GENERAL_NAME *a2i_GENERAL_NAME(GENERAL_NAME *out,
                               ...
                               YX509V3_CTX *ctx, int gen_type,
                               const char *value, int is_nc);

# ifdef HEADER_CONF_H
GENERAL_NAME *v2i_GENERAL_NAME(const YX509V3_EXT_METHOD *method,
                               YX509V3_CTX *ctx, CONF_VALUE *cnf);
GENERAL_NAME *v2i_GENERAL_NAME_ex(GENERAL_NAME *out,
                                  const YX509V3_EXT_METHOD *method,
                                  YX509V3_CTX *ctx, CONF_VALUE *cnf,
                                  int is_nc);
void YX509V3_conf_free(CONF_VALUE *val);
...
int YX509V3_add_value_bool_nf(const char *name, int asn1_bool,
                             STACK_OF(CONF_VALUE) **extlist);
int YX509V3_get_value_bool(const CONF_VALUE *value, int *asn1_bool);
int YX509V3_get_value_int(const CONF_VALUE *value, YASN1_INTEGER **aint);
...
void YX509V3_set_ctx(YX509V3_CTX *ctx, YX509 *issuer, YX509 *subject,
                    YX509_REQ *req, YX509_CRL *crl, int flags);

int YX509V3_add_value(const char *name, const char *value,
                     STACK_OF(CONF_VALUE) **extlist);
int YX509V3_add_value_uchar(const char *name, const unsigned char *value,
                           STACK_OF(CONF_VALUE) **extlist);
int YX509V3_add_value_bool(const char *name, int asn1_bool,
                          STACK_OF(CONF_VALUE) **extlist);
int YX509V3_add_value_int(const char *name, const YASN1_INTEGER *aint,
                         STACK_OF(CONF_VALUE) **extlist);
char *i2s_YASN1_INTEGER(YX509V3_EXT_METHOD *meth, const YASN1_INTEGER *aint);
YASN1_INTEGER *s2i_YASN1_INTEGER(YX509V3_EXT_METHOD *meth, const char *value);
char *i2s_YASN1_ENUMERATED(YX509V3_EXT_METHOD *meth, const YASN1_ENUMERATED *aint);
char *i2s_YASN1_ENUMERATED_TABLE(YX509V3_EXT_METHOD *meth,
                                const YASN1_ENUMERATED *aint);
...
STACK_OF(CONF_VALUE) *YX509V3_parse_list(const char *line);
...
int YX509V3_EXT_print_fp(FILE *out, YX509_EXTENSION *ext, int flag, int indent);
#endif
int YX509V3_extensions_print(BIO *out, const char *title,
...
int YX509_PURPOSE_get_by_id(int id);
...
int YX509_PURPOSE_get_id(const YX509_PURPOSE *);

STACK_OF(OPENSSL_STRING) *YX509_get1_email(YX509 *x);
STACK_OF(OPENSSL_STRING) *YX509_REQ_get1_email(YX509_REQ *x);
void YX509_email_free(STACK_OF(OPENSSL_STRING) *sk);
STACK_OF(OPENSSL_STRING) *YX509_get1_ocsp(YX509 *x);
...
# define YX509_CHECK_FLAG_NEVER_CHECK_SUBJECT    0x20
/*
...
int YX509_check_host(YX509 *x, const char *chk, size_t chklen,
                    unsigned int flags, char **peername);
int YX509_check_email(YX509 *x, const char *chk, size_t chklen,
                     unsigned int flags);
int YX509_check_ip(YX509 *x, const unsigned char *chk, size_t chklen,
                  unsigned int flags);
int YX509_check_ip_asc(YX509 *x, const char *ipasc, unsigned int flags);

YASN1_OCTET_STRING *a2i_IPADDRESS(const char *ipasc);
YASN1_OCTET_STRING *a2i_IPADDRESS_NC(const char *ipasc);
int YX509V3_NAME_from_section(YX509_NAME *nm, STACK_OF(CONF_VALUE) *dn_sk,
                             unsigned long chtype);

void YX509_POLICY_NODE_print(BIO *out, YX509_POLICY_NODE *node, int indent);
DEFINE_STACK_OF(YX509_POLICY_NODE)

#ifndef OPENSSL_NO_RFC3779
typedef struct ASRange_st {
    YASN1_INTEGER *min, *max;
} ASRange;
...
DECLARE_YASN1_FUNCTIONS(ASRange)
DECLARE_YASN1_FUNCTIONS(ASIdOrRange)
DECLARE_YASN1_FUNCTIONS(ASIdentifierChoice)
DECLARE_YASN1_FUNCTIONS(ASIdentifiers)

typedef struct IPAddressRange_st {
    YASN1_BIT_STRING *min, *max;
} IPAddressRange;
...
typedef struct IPAddressOrRange_st {
    int type;
    union {
        YASN1_BIT_STRING *addressPrefix;
...
typedef struct IPAddressFamily_st {
    YASN1_OCTET_STRING *addressFamily;
...
DECLARE_YASN1_FUNCTIONS(IPAddressRange)
DECLARE_YASN1_FUNCTIONS(IPAddressOrRange)
DECLARE_YASN1_FUNCTIONS(IPAddressChoice)
DECLARE_YASN1_FUNCTIONS(IPAddressFamily)
...
int YX509v3_asid_add_id_or_range(ASIdentifiers *asid, int which,
                                YASN1_INTEGER *min, YASN1_INTEGER *max);
int YX509v3_addr_add_inherit(IPAddrBlocks *addr,
                            const unsigned afi, const unsigned *safi);
int YX509v3_addr_add_prefix(IPAddrBlocks *addr,
                           const unsigned afi, const unsigned *safi,
                           unsigned char *a, const int prefixlen);
int YX509v3_addr_add_range(IPAddrBlocks *addr,
                          const unsigned afi, const unsigned *safi,
                          unsigned char *min, unsigned char *max);
unsigned YX509v3_addr_get_afi(const IPAddressFamily *f);
int YX509v3_addr_get_range(IPAddressOrRange *aor, const unsigned afi,
                          unsigned char *min, unsigned char *max,
                          const int length);
...
int YX509v3_addr_is_canonical(IPAddrBlocks *addr);
int YX509v3_asid_canonize(ASIdentifiers *asid);
int YX509v3_addr_canonize(IPAddrBlocks *addr);

/*
 * Tests for inheritance and containment.
 */
int YX509v3_asid_inherits(ASIdentifiers *asid);
int YX509v3_addr_inherits(IPAddrBlocks *addr);
int YX509v3_asid_subset(ASIdentifiers *a, ASIdentifiers *b);
int YX509v3_addr_subset(IPAddrBlocks *a, IPAddrBlocks *b);

/*
 * Check whether RFC 3779 extensions nest properly in chains.
 */
int YX509v3_asid_validate_path(YX509_STORE_CTX *);
int YX509v3_addr_validate_path(YX509_STORE_CTX *);
int YX509v3_asid_validate_resource_set(STACK_OF(YX509) *chain,
                                      ASIdentifiers *ext,
                                      int allow_inheritance);
int YX509v3_addr_validate_resource_set(STACK_OF(YX509) *chain,
                                      IPAddrBlocks *ext, int allow_inheritance);

#endif                         /* OPENSSL_NO_RFC3779 */

DEFINE_STACK_OF(YASN1_STRING)
...
DECLARE_YASN1_FUNCTIONS(NAMING_AUTHORITY)
DECLARE_YASN1_FUNCTIONS(PROFESSION_INFO)
DECLARE_YASN1_FUNCTIONS(ADMISSIONS)
DECLARE_YASN1_FUNCTIONS(ADMISSION_SYNTAX)
DEFINE_STACK_OF(ADMISSIONS)
DEFINE_STACK_OF(PROFESSION_INFO)
typedef STACK_OF(PROFESSION_INFO) PROFESSION_INFOS;

const YASN1_OBJECT *NAMING_AUTHORITY_get0_authorityId(
...
void NAMING_AUTHORITY_set0_authorityText(NAMING_AUTHORITY *n,
    YASN1_STRING* namingAuthorityText);
...
const YASN1_OCTET_STRING *PROFESSION_INFO_get0_addProfessionInfo(
    const PROFESSION_INFO *pi);
void PROFESSION_INFO_set0_addProfessionInfo(
    PROFESSION_INFO *pi, YASN1_OCTET_STRING *aos);
const NAMING_AUTHORITY *PROFESSION_INFO_get0_namingAuthority(
    const PROFESSION_INFO *pi);
void PROFESSION_INFO_set0_namingAuthority(
    PROFESSION_INFO *pi, NAMING_AUTHORITY *na);
const STACK_OF(YASN1_STRING) *PROFESSION_INFO_get0_professionItems(
    const PROFESSION_INFO *pi);
void PROFESSION_INFO_set0_professionItems(
    PROFESSION_INFO *pi, STACK_OF(YASN1_STRING) *as);
const STACK_OF(YASN1_OBJECT) *PROFESSION_INFO_get0_professionOIDs(
    const PROFESSION_INFO *pi);
void PROFESSION_INFO_set0_professionOIDs(
    PROFESSION_INFO *pi, STACK_OF(YASN1_OBJECT) *po);
const YASN1_PRINTABLESTRING *PROFESSION_INFO_get0_registrationNumber(
    const PROFESSION_INFO *pi);
void PROFESSION_INFO_set0_registrationNumber(
    PROFESSION_INFO *pi, YASN1_PRINTABLESTRING *rn);
