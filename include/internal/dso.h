 ...
 * form that the caller will need to free with _OPENSSL_free() when done.
 */
 ...
 * _OPENSSL_free() when done. Here, merging means that bits and pieces are
 ...
 * value will need to be _OPENSSL_free()'d.
 */
